# [Referência da biblioteca em tempo de execução C](c-run-time-library-reference.md)
# [Recursos da biblioteca CRT](crt-library-features.md)
## [Compatibilidade](compatibility.md)
### [Os aplicativos UWP, o Windows Runtime e o tempo de execução C](windows-store-apps-the-windows-runtime-and-the-c-run-time.md)
...
# [Rotinas de tempo de execução C universais por categoria](run-time-routines-by-category.md)
...
## [Suporte a cálculos complexos](complex-math-support.md)
...
### [Unicode: o conjunto de caracteres largos](unicode-the-wide-character-set.md)
