...
|Função obsoleta|[_cgets_s, _cgetws_s](../c-runtime-library/reference/cgets-s-cgetws-s.md)|Obter uma cadeia de caracteres desde o console|  
...
|Função obsoleta|[gets_s, _getws_s](../c-runtime-library/reference/gets-s-getws-s.md)|Obter uma linha do fluxo `stdin`|  
...
|[_mbsnbset, _mbsnbset_l](../c-runtime-library/reference/mbsnbset-mbsnbset-l.md)|[_mbsnbset_s, _mbsnbset_s_l](../c-runtime-library/reference/mbsnbset-s-mbsnbset-s-l.md)|Defina os `n` primeiros bytes de uma cadeia de caracteres para um caractere especificado|  
...
|[_ultoa, _ultow](../c-runtime-library/reference/ultoa-ultow.md)|[_ultoa_s, _ultow_s](../c-runtime-library/reference/ultoa-s-ultow-s.md)|Converter um inteiro longo sem sinal em uma cadeia de caracteres|  
