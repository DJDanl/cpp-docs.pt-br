...
|Estruturas `div_t`, `ldiv_t` e `lldiv_t`|Armazenam os valores retornados por [div](reference/div.md), [ldiv](./reference/div.md) e [lldiv](./reference/div.md), respectivamente.|STDLIB.H|
