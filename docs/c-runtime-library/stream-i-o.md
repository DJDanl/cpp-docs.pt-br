...
|[_fcloseall](../c-runtime-library/reference/fclose-fcloseall.md)|Feche todos os fluxos abertos, exceto `stdin`, `stdout` e `stderr`|  
...
|[_fputchar, _fputwchar](../c-runtime-library/reference/fputc-fputwc.md)|Gravar um caractere em `stdout` (versões de função de `putchar` e `putwchar`)|  
...
|[_getw](../c-runtime-library/reference/getw.md)|Ler binário `int` no fluxo|  
