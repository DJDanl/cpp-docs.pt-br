---
title: "Fun&#231;&#245;es e globais de CRT interno | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
Biblioteca C runtime \(CRT\) contém funções e variáveis globais que são usadas somente para oferecer suporte à interface de biblioteca pública. Algumas delas são expostas em cabeçalhos públicos como detalhes de implementação. Embora essas funções e variáveis globais são acessíveis por meio de exportações públicas, eles não se destinam para uso pelo seu código. É recomendável que você altere qualquer código que usa essas funções e variáveis para usar equivalentes da biblioteca pública em vez disso. Essas funções podem ser alteradas a cada versão. Eles estão listados aqui para ajudá\-lo a identificá\-los. Links são fornecidos quando existe documentação adicional, mas em geral, esses detalhes de implementação não estão documentados.  
  
## Valor Macros e globais de CRT interno  
 Essas variáveis globais e as definições de macro são usadas para implementar o CRT.  
  
|Nome|  
|----------|  
|\_\_badioinfo|  
|[acmdln](../c-runtime-library/acmdln-tcmdln-wcmdln.md)|  
|\_commode|  
|\_crtAssertBusy|  
|\_crtBreakAlloc|  
|\_\_initenv|  
...
|[wcmdln](../c-runtime-library/acmdln-tcmdln-wcmdln.md)|  
|\_\_winitenv|  
  
## Funções internas do CRT e Macros de função  
 Essas funções e macros de função são usadas para implementar o CRT e C\+\+ Standard Library \(STL\).  
...
|\_except1|  
|[\_execute\_onexit\_table](../c-runtime-library/execute-onexit-table-initialize-onexit-table-register-onexit-function.md)|  
|\_fdclass|  
|\_fdpcomp|  
|\_fdsign|  
|\_fdtest|  
...
|[\_initialize\_onexit\_table](../c-runtime-library/execute-onexit-table-initialize-onexit-table-register-onexit-function.md)|  
...
|\_\_pxcptinfoptrs|  
|\_realloc\_base|  
|[\_register\_onexit\_function](../c-runtime-library/execute-onexit-table-initialize-onexit-table-register-onexit-function.md)|  
