...
Como C++ permite sobrecargas, é possível chamar sobrecargas de **catanh** que usam e retornam **fcomplex** e **_Lcomplex** valores. Em um programa do C **catanh** sempre usa e retorna um **_Dcomplex** valor.
