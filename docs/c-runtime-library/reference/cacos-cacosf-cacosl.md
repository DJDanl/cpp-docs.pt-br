...
Porque C++ permite sobrecargas, é possível chamar sobrecargas de **cacos** que usam e retornam **fcomplex** e **_Lcomplex** valores. Em um programa do C **cacos** sempre usa e retorna um **_Dcomplex** valor.
