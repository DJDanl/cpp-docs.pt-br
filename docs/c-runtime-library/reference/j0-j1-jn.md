...
Essas funções POSIX foram preteridas. Em vez disso, use [_j0, _j1, _jn](../../c-runtime-library/reference/bessel-functions-j0-j1-jn-y0-y1-yn.md) compatível com ISO C++.