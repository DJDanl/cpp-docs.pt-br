...
Como o C++ permite sobrecarga, você pode chamar sobrecargas de **lround** ou **llround** que levar e retornar **float** e **longo** **duplo** valores. Em um programa C, **lround** e **llround** sempre levar e retornar um **duplo**.
