...
ms.openlocfilehash: 447505f53729e21e2dbf55a69568c06e59165365
...
> [!IMPORTANT]
>  `_mbschr` e `_mbschr_l` não podem ser usados em aplicativos executados no Windows Runtime. Para obter mais informações, consulte [Funções de CRT sem suporte com /ZW](http://msdn.microsoft.com/library/windows/apps/jj606124.aspx).  
