...
ms.openlocfilehash: cb13a25d6d8557b2326a896ea3492b86dfd29d57
ms.contentlocale: pt-br
ms.lasthandoff: 02/25/2017

---
# <a name="spawnve"></a>spawnve
Essa função POSIX foi preterida. Em vez disso, use [_spawnve](../../c-runtime-library/reference/spawnve-wspawnve.md) compatível com ISO C++.  
