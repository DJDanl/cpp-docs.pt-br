...
Como o C++ permite sobrecarga, você pode chamar sobrecargas de **ldexp** que usam **`float`** ou **`long double`** digitam. Em um programa C, **ldexp** sempre pega um **`double`** e um **`int`** e retorna um **`double`** .
