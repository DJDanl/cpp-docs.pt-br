...
Como o C++ permite sobrecarga, você pode chamar sobrecargas de **conj** que levar e retornar **_Fcomplex** e **_Lcomplex** valores. Em um programa C, **conj** sempre usa e retorna um **_Dcomplex** valor.
