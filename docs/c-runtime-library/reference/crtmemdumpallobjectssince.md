...
## <a name="example"></a>Exemplo  
 Para obter uma amostra de como usar `_CrtMemDumpAllObjectsSince`, consulte [crt_dbg2](https://github.com/Microsoft/VCSamples/tree/master/VC2010Samples/crt/crt_dbg2).  
