...
A função **freopen** fecha o arquivo atualmente associado ao *fluxo* e reatribui o *fluxo* ao arquivo especificado pelo *caminho*. **_wfreopen** é uma versão de caractere largo do **_freopen**; os argumentos *path* e *Mode* para **_wfreopen** são cadeias de caracteres largos. **_wfreopen** e **_freopen** se comportam de outra forma.
