...
description: Referência de API para _getch_nolock e _getwch_nolock; que obtém um caractere do console sem eco e sem bloquear o thread.
ms.date: 4/2/2020
api_name:
- _getwch_nolock
- _getch_nolock
