...
Porque C++ permite sobrecargas, é possível chamar sobrecargas de **ccos** que usam e retornam **fcomplex** e **_Lcomplex** valores. Em um programa do C **ccos** sempre usa e retorna um **_Dcomplex** valor.
