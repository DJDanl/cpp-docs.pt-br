...
Como C++ o permite sobrecarga, você pode chamar sobrecargas de **CCOs** que usam e retornam valores **_Fcomplex** e **_Lcomplex** . Em um programa C, **CCOs** sempre pega e retorna um valor **_Dcomplex** .
