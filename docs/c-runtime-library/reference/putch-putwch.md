...
Retorna *c* se houver êxito. Se **putch** falhar, ele retorna **EOF**; se **putwch** falhar, ele retorna **WEOF**.

## <a name="remarks"></a>Comentários

Essas funções escreva o caractere *c* diretamente, sem buffer, para o console. No Windows NT, **_putwch** grava caracteres Unicode usando a configuração de localidade do console atual.
