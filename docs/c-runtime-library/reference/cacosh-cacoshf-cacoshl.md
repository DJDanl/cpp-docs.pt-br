...
Como C++ o permite sobrecarga, você pode chamar sobrecargas de **cacosh** que usam e retornam valores **_Fcomplex** e **_Lcomplex** . Em um programa C, **cacosh** sempre pega e retorna um valor **_Dcomplex** .
