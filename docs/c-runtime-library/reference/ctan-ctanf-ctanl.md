...
## <a name="remarks"></a>Comentários  
 Como C++ permite sobrecargas, é possível chamar sobrecargas de `ctan` que tomam e retornam valores de `_Fcomplex` e `_Lcomplex`. Em um programa do C, `ctan` sempre usa e retorna um valor `_Dcomplex`.  
