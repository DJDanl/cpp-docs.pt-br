...
A função **_sopen_s** abre o arquivo especificado por *filename* e prepara o arquivo para leitura ou gravação compartilhada, conforme definido por *oflag* e *shflag*. **_wsopen_s** é uma versão de caractere largo do **_sopen_s**; o argumento *filename* para **_wsopen_s** é uma cadeia de caracteres largos. **_wsopen_s** e **_sopen_s** se comportam de outra forma.
...
Se **_sopen_s** for chamado com **_O_WRONLY** |  **_O_APPEND** (modo de acréscimo) e **_O_WTEXT**, **_O_U16TEXT**ou **_O_U8TEXT**, primeiro ele tentará abrir o arquivo para leitura e gravação, ler a bom e, em seguida, reabri-la somente para gravação. Se uma falha impedir de abrir o arquivo para leitura e gravação, ele será aberto somente para gravação e usará o valor padrão na configuração do modo Unicode.
