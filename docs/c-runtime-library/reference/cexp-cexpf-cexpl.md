...
Como C++ permite sobrecargas, é possível chamar sobrecargas de **cexp** que usam e retornam **fcomplex** e **_Lcomplex** valores. Em um programa do C **cexp** sempre usa e retorna um **_Dcomplex** valor.
