...
Como C++ o permite sobrecarga, você pode chamar sobrecargas de **cexp** que usam e retornam valores **_Fcomplex** e **_Lcomplex** . Em um programa C, **cexp** sempre pega e retorna um valor **_Dcomplex** .
