...
Para extrair o tipo e o subtipo retornados por **_CrtReportBlockType**, use as macros **_BLOCK_TYPE** e **_BLOCK_SUBTYPE** (ambas definidas em CRTDBG. h) no valor de retorno.
