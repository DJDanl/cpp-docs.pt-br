...
Converte um inteiro em uma cadeia de caracteres. Essas são as versões do [_itoa, _itow funciona](itoa-itow.md) com aprimoramentos de segurança, conforme descrito em [recursos de segurança no CRT](../../c-runtime-library/security-features-in-the-crt.md).
...
[_itoa, _itow funções](itoa-itow.md)<br/>
