...
ms.openlocfilehash: c2d1e22ec24db8bbd944b5d556ce5d499996f8ba
ms.lasthandoff: 02/25/2017

---
# <a name="execvp"></a>execvp
Essa função POSIX foi preterida. Em vez disso, use [_execvp](../../c-runtime-library/reference/execvp-wexecvp.md) compatível com ISO C++.  
