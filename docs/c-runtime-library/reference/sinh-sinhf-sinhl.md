...
As funções **sinh** retornam o seno hiperbólico de *x*. Por padrão, se o resultado for muito grande, **o sinh** define **errno** para **ERANGE** e retorna ±**HUGE_VAL**.
...
Como c++ permite sobrecarga, você pode chamar sobrecargas de **sinh** que tomam e retornam **flutuam** **ou** **longos** valores duplos. Em um programa C, **o sinh** sempre pega e retorna **em dobro.**
