...
|Formato incorreto (consulte a seção de comentários para o formato correto)|any|**EINVAL**|cadeia de caracteres vazia|
...
**_mktemp_s** pode criar no máximo 26 nomes de arquivo exclusivos para qualquer combinação determinada de valores *base* e *nametemplate* . Portanto, FNZ12345 é o último nome de arquivo exclusivo **_mktemp_s** pode criar para os valores *base* e *nametemplate* usados neste exemplo.
