...
> [!IMPORTANT]
>  `_mbsnextc` e `_mbsnextc_l` não podem ser usados em aplicativos executados no Windows Runtime. Para obter mais informações, consulte [Funções de CRT sem suporte com /ZW](http://msdn.microsoft.com/library/windows/apps/jj606124.aspx).  
...
## <a name="return-value"></a>Valor de retorno  
 Cada uma dessas funções retorna o valor inteiro do próximo caractere na `str`*.*  
