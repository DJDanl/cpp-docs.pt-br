...
ms.openlocfilehash: b35a3fe6f01740a89d01069f2382a6c4d21d5d6e
ms.lasthandoff: 02/25/2017

---
# <a name="getch"></a>getch
Essa função POSIX foi preterida. Em vez disso, use [_getch](../../c-runtime-library/reference/getch-getwch.md), que é compatível com ISO C++.  
