...
As **_strtol_l** funções **_wcstol_l** e são específicas da Microsoft, e não fazem parte da biblioteca C padrão. Para obter mais informações sobre compatibilidade, consulte [Compatibilidade](../compatibility.md).
