...
Como o C++ permite sobrecarga, você pode chamar sobrecargas de **FMA** que usam e retornam **`float`** **`long double`** tipos. Em um programa C, o **FMA** sempre usa e retorna um **`double`** .
