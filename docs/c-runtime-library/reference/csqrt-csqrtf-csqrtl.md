...
Como o C++ permite sobrecarga, você pode chamar sobrecargas de **csqrt** que levar e retornar **_Fcomplex** e **_Lcomplex** valores. Em um programa C, **csqrt** sempre usa e retorna um **_Dcomplex** valor.
