...
## <a name="remarks"></a>Comentários  
 A função `_CrtGetDumpClient` recupera a função de gancho atual para despejar objetos armazenados nos blocos de memória `_CLIENT_BLOCK` para o processo de despejo de memória de depuração em tempo de execução C.  
