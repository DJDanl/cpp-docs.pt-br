...
ms.openlocfilehash: e0e9acf4051d06f5da12d2167607cc2c854158f4
ms.lasthandoff: 02/25/2017

---
# <a name="spawnlpe"></a>spawnlpe
Essa função POSIX foi preterida. Em vez disso, use [_spawnlpe](../../c-runtime-library/reference/spawnlpe-wspawnlpe.md) compatível com ISO C++.  
