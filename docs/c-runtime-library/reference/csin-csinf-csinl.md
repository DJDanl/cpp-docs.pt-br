...
Como C++ o permite sobrecarga, você pode chamar sobrecargas de **csin** que usam e retornam valores **_Fcomplex** e **_Lcomplex** . Em um programa C, **csin** sempre pega e retorna um valor **_Dcomplex** .
