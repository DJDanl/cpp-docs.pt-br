...
ms.locfileid: "77420254"
---
# <a name="c6273"></a>C6273

> aviso C6273-não inteiro passado como parâmetro \<número > quando o inteiro é necessário na chamada de \<função >: se um valor de ponteiro estiver sendo passado,% p deverá ser usado
