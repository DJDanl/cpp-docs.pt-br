...
Consulte [diretivas de pragma e a `__Pragma` palavra-chave](../preprocessor/pragma-directives-and-the-pragma-keyword.md) para obter uma descrição dos pragmas do compilador C da Microsoft.
