...
Nenhum caractere de espaço em branco pode separar os dígitos de uma constante de inteiro. Esses exemplos mostram algumas constantes decimais, octais e hexadecimais válidas.
