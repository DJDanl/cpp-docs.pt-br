...
helpviewer_keywords: 
  - "tipos agregados [C++]"
  - "agregações [C++], inicializando"
  - "tipos [C], inicializando"
  - "palavra-chave union [C]"
  - "palavra-chave union [C], declarações"
 ...
 *initializer\-list*  **,**  *initializer*  
 ...
 O inicializador de uma estrutura é uma expressão do mesmo tipo, ou uma lista de inicializadores para os membros incluídos entre chaves \(**{ }**\).  Os membros sem nome de campo de bits não são inicializados.  
  
 Quando uma união é inicializada, *initializer\-list* deve ser uma expressão constante.  O valor da expressão constante é atribuído ao primeiro membro de união.  
 ...
 **Específico da Microsoft**  
 ...
 O tamanho máximo para uma matriz é definido por **size\_t**.  Definido no arquivo de cabeçalho STDDEF.H, **size\_t** é um `unsigned int` com o intervalo de 0x00000000 a 0x7CFFFFFF.  
