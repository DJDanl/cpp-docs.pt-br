...
helpviewer_keywords: 
  ...
  - "atributo dllexport [C++], limitações e regras"
  - "Atributo dllimport [C++], limitações e regras"
...
-   Inicializar um ponteiro de função estática com o endereço de uma função declarada com **dllimport** define o ponteiro para o endereço de importação da DLL \(um stub de código que transfere o controle da função\) em vez do endereço da função.  Essa atribuição não gera uma mensagem de erro:  
