...
helpviewer_keywords: 
  ...
  - "operadores [C], igualdade"
  - "operadores [C], relacional"
...
|`!=`|Primeiro operando não é igual ao segundo operando|  
 ...
 Os primeiros quatro operadores na lista acima têm alta prioridade quanto aos operadores de igualdade \(`==` e `!=`\).  Consulte as informações de precedência na tabela [Precedência e associatividade dos operadores de C](../Topic/Precedence%20and%20Order%20of%20Evaluation.md).  
...
## Consulte também  
 [Operadores relacionais: \<, \>, \<\=, and \>\=](../cpp/relational-operators-equal-and-equal.md)   
