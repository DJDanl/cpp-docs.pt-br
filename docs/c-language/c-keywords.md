...
“Palavras\-chave” são palavras que têm um significado especial para o compilador C.  Nas fases 7 e 8 da conversão, um identificador não pode ter a mesma ortografia e caixa \(maiúscula\/minúscula\) que a palavra\-chave C. \(Consulte uma descrição de [fases de conversão](../preprocessor/phases-of-translation.md) na *Referência de pré\-processador*; para obter informações sobre os identificadores, consulte [Identificadores](../c-language/c-identifiers.md).\) A linguagem C usa as seguintes palavras\-chave:  
...
|**do**|**if**|**static**|`while`|  
 ...
 Você não pode redefinir palavras\-chave.  No entanto, você pode especificar o texto a ser substituído por palavras\-chave antes da compilação usando [políticas de pré\-processador](../preprocessor/preprocessor-directives.md) C.  
