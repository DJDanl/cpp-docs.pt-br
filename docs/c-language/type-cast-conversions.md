...
dev_langs: 
  ...
  - "C"
helpviewer_keywords: 
  - "conversões [C++], conversão de tipo"
  - "conversão de tipo de dados [C++], conversões de conversão de tipo"
  - "conversões explícitas de tipo"
  - "conversões de tipo"
  - "conversões de tipo [C++], sobre conversão de conversão de tipo"
  - "conversões de conversão de tipo [C++]"
 ...
 **Específico da Microsoft**  
 ...
 Uma conversão de tipo pode ser uma expressão l\-value, desde que o tamanho do identificador não se altere.  Para obter informações sobre expressões l\-value, consulte [Expressões L\-Value e R\-Value](../Topic/L-Value%20and%20R-Value%20Expressions.md).  
