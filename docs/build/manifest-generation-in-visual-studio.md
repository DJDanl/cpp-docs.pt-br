...
2.  Depois de intermediários manifesto e vinculação estiverem concluídas, a ferramenta de manifesto será executada para mesclar um manifesto final e salvá-lo como um arquivo externo.  
  
3.  O projeto do sistema de compilação e detecta se o manifesto gerado pela ferramenta de manifesto contém informações diferentes de manifesto já inserida no binário.  
...
## <a name="see-also"></a>Consulte também  
 [Como: inserir um manifesto em um aplicativo C/C++](../build/how-to-embed-a-manifest-inside-a-c-cpp-application.md)   
 [Sobre Assemblies particulares](/windows/desktop/SbsCs/about-private-assemblies-)   
 [Ferramenta de manifesto](/windows/desktop/SbsCs/mt-exe)   
