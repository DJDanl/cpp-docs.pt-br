...
Execute **vcpkg integrate install** para configurar o Visual Studio Code no Linux/MacOS com o local de inscrição de vcpkg e habilitar o IntelliSense em arquivos de origem.
