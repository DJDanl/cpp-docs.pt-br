...
Os comandos **Executar** ou **F5** primeiro compilam o projeto se as alterações foram feitas desde o build anterior. As alterações no *CMakeSettings.jsno* fazem com que o cache CMake seja regenerado.
