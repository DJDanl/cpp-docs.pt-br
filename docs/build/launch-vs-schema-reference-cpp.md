...
|`projectTarget`|cadeia de caracteres|Especifica o destino opcional invocado ao criar `project`. Este `projectTarget` já deve existir e corresponder ao nome no menu suspenso de **destino de depuração** .|
...
|`pipeEnv`|Objeto do|Variáveis de ambiente passadas para o programa de pipe.|
