...
|[/DELAY](../../build/reference/delay-delay-load-import-settings.md)|Controla o carregamento atrasado de DLLs.|
...
|[/ENTRY](../../build/reference/entry-entry-point-symbol.md)|Define o endereço inicial.|
...
|[/IGNORE](../../build/reference/ignore-ignore-specific-warnings.md)|Suprime a saída de avisos do vinculador especificado.|
...
|[/MACHINE](../../build/reference/machine-specify-target-platform.md)|Especifica a plataforma de destino.|
|[/MANIFEST](../../build/reference/manifest-create-side-by-side-assembly-manifest.md)|Cria um arquivo de manifesto lado a lado e, como opção, o insere no binário.|
...
|[/ORDER](../../build/reference/order-put-functions-in-order.md)|Coloca COMDATs na imagem em uma ordem predeterminada.|
...
|[/PROFILE](../../build/reference/profile-performance-tools-profiler.md)|Produz um arquivo de saída que pode ser usado com o criador de perfil de Ferramentas de desempenho.|
