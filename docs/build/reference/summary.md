...
## <a name="remarks"></a>Comentários  
 Esta opção exibe um mínimo de informações sobre seções, incluindo o tamanho total. Essa opção é o padrão se nenhuma outra opção é especificada.  
