...
O **/MP** opção é incompatível com alguns recursos de linguagem e opções do compilador. Se você usar uma opção de compilador incompatível com o **/MP** opção, o compilador emite o aviso **D9030** e ignora o **/MP** opção. Se você usar um recurso de idioma incompatível, o compilador emite o erro [C2813](../../error-messages/compiler-errors-2/compiler-error-c2813.md) , em seguida, termina ou continua dependendo do opção de nível de aviso de compilador atual.
...
|[/Gm](../../build/reference/gm-enable-minimal-rebuild.md)|Habilita uma recriação incremental.|
...
- Se o número de projetos e arquivos por projeto é equilibrado, use dois MSBuild e **/MP**. Definir inicialmente o **/maxcpucount** opção para o número de projetos para criar e o **/MP** opção para o número de processadores no computador. Medir o desempenho e, em seguida, ajustar as configurações para produzir os melhores resultados. Repita esse ciclo até ficar satisfeito com o tempo de compilação total.
