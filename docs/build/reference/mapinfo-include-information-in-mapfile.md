...
A opção /MAPINFO informa o vinculador a incluir as informações especificadas em um arquivo de mapa, que é criado se você especificar o [/Map](map-generate-mapfile.md) opção.  Exportações instrui o vinculador a incluir funções exportadas.
