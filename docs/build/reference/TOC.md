...
##### [-Ox (otimização completa)](ox-full-optimization.md)
...
#### [-Z7, -Zi, -ZI (formato das informações de depuração)](z7-zi-zi-debug-information-format.md)
...
### [Ferramentas para otimização guiada por perfil manual](tools-for-manual-profile-guided-optimization.md)
