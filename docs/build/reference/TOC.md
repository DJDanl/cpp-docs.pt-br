...
### [Duas opções para pré-compilar código](two-choices-for-precompiling-code.md)
...
#### [Arquivos PCH no processo de build](pch-files-in-the-build-process.md)
...
# [Erros do compilador C2001 a C2499](../../error-messages/compiler-errors-1/TOC.md)
