...
É possível usar a opção do compilador **\/Zc** para especificar o comportamento do compilador padrão ou específico da Microsoft.  Aqui estão as opções do compilador **\/Zc**:  
