...
Para obter informações sobre como acessar o **ferramenta de gerador de dados XML** página de propriedades, consulte [propriedades de compilador e de build definida C++ no Visual Studio](../working-with-project-properties.md).
