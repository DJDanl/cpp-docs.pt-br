---
title: -Validar-charset (validar quanto caracteres compatíveis) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp
...
3.  Na **opções avançadas**, adicione o **/validate-charset** opção e especifique a codificação preferencial.  
