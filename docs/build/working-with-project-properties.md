...
![Padrões de&#43; &#43; projeto do Visual C](media/visual-c---project-defaults.png "Padrões C++ do projeto Visual")
...
![Páginas de&#43; &#43; Propriedades do Visual C mostrando a configuração ativa](media/visual-c---property-pages-showing-active-configuration.png "Páginas C++ de propriedades visuais mostrando a configuração ativa")
...
![Páginas de&#43; &#43; Propriedades do Visual C mostrando a configuração da versão](media/visual-c---property-pages-showing-release-config.png "Páginas C++ de propriedades visuais mostrando a configuração de versão")
...
A ilustração a seguir mostra as páginas de propriedades de um C++ projeto do Visual Studio. No painel esquerdo, a *regra* de **diretórios vc + +** está selecionada e o painel direito lista as propriedades que estão associadas a essa regra. Os valores de `$(...)` são chamados de *macros*. Uma *macro* é uma constante em tempo de compilação que pode se referir a um valor definido pelo Visual Studio ou pelo sistema do MSBuild, ou a um valor definido pelo usuário. Usando macros em vez de valores embutidos em código, como caminhos de diretório, você pode compartilhar com mais facilidade as configurações de propriedade entre computadores e entre versões do Visual Studio, e pode garantir melhor que as configurações do projeto participem corretamente na [herança de propriedade](project-property-inheritance.md).
...
![Menu&#95;suspenso&#95;do editor de propriedades](media/property_editor_dropdown.png "Property_Editor_Dropdown")
