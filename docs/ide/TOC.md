...
##### [Configurações do aplicativo, Assistente Personalizado](application-settings-custom-wizard.md)
...
##### [Examinando a mecânica de um assistente](examining-the-mechanics-of-a-wizard.md)
...
###### [Arquivo Templates.inf](templates-inf-file.md)
...
#### [Tratando erros em assistentes](handling-errors-in-wizards.md)
##### [Tratamento de erro em arquivos HTML do assistente](error-handling-in-wizard-html-files.md)
