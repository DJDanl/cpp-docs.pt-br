...
|---------------|------------------------|--------------------------------|-----------------|  
|*Projname*.hhp|*Projname*\hlp|Arquivos da Ajuda HTML|O arquivo de projeto de Ajuda. Ele contém os dados necessários para compilar os arquivos de Ajuda em um arquivo HXS ou um arquivo. chm.|  
|*Projname*.hhk|*Projname*\hlp|Arquivos da Ajuda HTML|Contém um índice dos tópicos da Ajuda.|  
|*Projname*.hhc|*Projname*\hlp|Arquivos da Ajuda HTML|O conteúdo da Ajuda do projeto.|  
...
|Afxcore.htm|*Projname*\hlp|Tópicos de ajuda HTML|Contém tópicos da Ajuda padrão para comandos do MFC padrão e objetos da tela. Adicione seus próprios tópicos de ajuda para este arquivo.|  
|Afxprint.htm|*Projname*\hlp|Tópicos de ajuda HTML|Contém tópicos da Ajuda para os comandos de impressão.|  
