...
Recupera o código especificado para  [InitInstance](../Topic/CWinApp::InitInstance.md).  
...
## Valor de retorno  
 Uma seqüência de caracteres que contém o código para inicializar a instância do assistente.  
  
## Comentários  
 Chame essa função de membro para recuperar o código apropriado para inicializar a instância do assistente.  Os números de linha são os seguintes:  
  
|Número da linha|Código de CWinAppEx|  
|---------------------|-------------------------|  
...
|29|`}`|  
 ...
 Para cada uma das linhas retornadas, `GetCodeForInitInstance` adiciona uma guia à esquerda \(`\t`\) e um par de caracteres "CR\-LF" \(retorno de carro \- avanço de linha\) à direita \(`\r\n`\).  
