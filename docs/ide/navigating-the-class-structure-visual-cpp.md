...
ms.locfileid: "33330227"
---
# <a name="navigating-the-class-structure-visual-c"></a>Navegando na estrutura da classe (Visual C++)
Navegue por uma estrutura de classe do projeto, incluindo funções, herança e interfaces, usando [Modo de Exibição de Classe](http://msdn.microsoft.com/en-us/8d7430a9-3e33-454c-a9e1-a85e3d2db925) ou o [Pesquisador de Objetos](http://msdn.microsoft.com/en-us/f89acfc5-1152-413d-9f56-3dc16e3f0470).  
