---
title: 'Como: converter um Loop OpenMP que usa o tratamento de exceções para usar o tempo de execução de simultaneidade | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-concrt
