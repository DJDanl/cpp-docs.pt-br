...
|Nome|Descrição|  
|----------|-----------------|  
|[Cancelar](#cancel)|Move um agente do `agent_created` ou `agent_runnable` estados de `agent_canceled` estado.|  
...
|[Aguarde](#wait)|Aguarda até que um agente concluir a tarefa.|  
