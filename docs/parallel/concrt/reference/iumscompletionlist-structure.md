...
|Nome|Descrição|  
|----------|-----------------|  
|[Getunblocknotifications](#getunblocknotifications)|Recupera uma cadeia de `IUMSUnblockNotification` interfaces que representa os contextos de execução cujo segmento associado proxies têm desbloqueado desde a última vez que esse método foi chamado.|  
