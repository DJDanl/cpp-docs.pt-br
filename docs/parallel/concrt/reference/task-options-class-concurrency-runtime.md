...
##  <a name="get_cancellation_token">task_options:: get_cancellation_token (tempo de execução de simultaneidade) do método</a>  
...
##  <a name="get_continuation_context">task_options:: get_continuation_context (tempo de execução de simultaneidade) do método</a>  
...
##  <a name="get_scheduler">task_options:: get_scheduler (tempo de execução de simultaneidade) do método</a>  
 Retorna o agendador  
...
##  <a name="has_cancellation_token">task_options:: has_cancellation_token (tempo de execução de simultaneidade) do método</a>  
...
##  <a name="has_scheduler">task_options:: has_scheduler (tempo de execução de simultaneidade) do método</a>  
...
##  <a name="set_cancellation_token">task_options:: set_cancellation_token (tempo de execução de simultaneidade) do método</a>  
...
##  <a name="set_continuation_context">task_options:: set_continuation_context (tempo de execução de simultaneidade) do método</a>  
...
##  <a name="ctor">task_options:: task_options (tempo de execução de simultaneidade) do construtor</a>  
