...
Valor indicando que uma espera nunca deve ser cronometrada.
...
Uma categoria GUID descrevendo eventos ETW disparados pelo Concurrency Runtime que estão diretamente relacionados com grupos de agendamento.
