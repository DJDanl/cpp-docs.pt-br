...
|Nome|Descrição|  
|----------|-----------------|  
|[Construtor task_group](#ctor)|Sobrecarregado. Constrói um novo `task_group` objeto.|  
...
|[Método Wait](#wait)|Aguarda até que todo o trabalho no `task_group` objeto foi concluída ou cancelado.|  
