---
title: "Refer&#234;ncia (Tempo de Execu&#231;&#227;o de Simultaneidade) | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
helpviewer_keywords: 
  ...
  - "HANDLE typedef"
  - "HRESULT typedef"
  - "LPSECURITY_ATTRIBUTES (typedefs)"
...
Esta seção contém informações de referência do tempo de execução de simultaneidade.  
  
> [!NOTE]
>  O padrão de linguagem C\+\+ permite o uso de identificadores que começam com um caractere de sublinhado \(`_`\) para implementações como bibliotecas.  Não use esses nomes em seu código.  O comportamento de elementos de código cujos nomes sigam esta convenção não é garantida e está sujeito a alterações nas versões futuras.  Pelos motivos, como elementos do código são omitidos da documentação de tempo de execução de simultaneidade.  
  
## Nesta seção  
 [Namespace Concurrency](../../../parallel/concrt/reference/concurrency-namespace.md)  
 O namespace `concurrency` fornece classes e funções que permitem acesso ao Runtime de simultaneidade, uma estrutura de programação simultânea para C\+\+.  Para obter mais informações, consulte [Tempo de Execução de Simultaneidade](../../../parallel/concrt/concurrency-runtime.md).  
