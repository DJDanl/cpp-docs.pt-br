...
|Nome|Descrição|  
|----------|-----------------|  
|[Método scheduler_interface:: Schedule](#schedule)||  
...
##  <a name="a-nameschedulea--schedulerinterfaceschedule-method"></a><a name="schedule"></a>Método scheduler_interface:: Schedule  
