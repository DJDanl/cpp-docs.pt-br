...
|Nome|Descrição|  
|----------|-----------------|  
|[aceitar](#accept)|Aceita uma mensagem que foi fornecida por esse `source_block` objeto, transferir a propriedade para o chamador.|  
|[acquire_ref](#acquire_ref)|Adquire uma contagem de referência neste `source_block` objeto, para impedir a exclusão.|  
|[consumir](#consume)|Consome uma mensagem anteriormente oferecida por este `source_block` de objeto e reservada com êxito pelo destino, transferir a propriedade para o chamador.|  
