...
#### Parâmetros  
 ...
 `_Allocator_type`  
 O tipo que representa o objeto armazenado do alocador que encapsula os detalhes sobre a alocação e a desalocação de memória para o vetor simultâneo.  Esse argumento é opcional e o valor padrão é `std::allocator<std::pair<``_Key_type`, `_Element_type``>>`.  
...
|Nome|Descrição|  
|----------|---------------|  
|[Construtor concurrent\_unordered\_multimap::concurrent\_unordered\_multimap](../Topic/concurrent_unordered_multimap::concurrent_unordered_multimap%20Constructor.md)|Sobrecarregado.  Constrói um multimapa simultâneo não ordenado.|  
  
### Métodos Públicos  
  
|Nome|Descrição|  
|----------|---------------|  
|[Método concurrent\_unordered\_multimap::hash\_function](../Topic/concurrent_unordered_multimap::hash_function%20Method.md)|Retorna o objeto armazenado da função hash.|  
|[Método concurrent\_unordered\_multimap::insert](../Topic/concurrent_unordered_multimap::insert%20Method.md)|Sobrecarregado.  Adiciona elementos ao objeto `concurrent_unordered_multimap`.|  
|[Método concurrent\_unordered\_multimap::key\_eq](../Topic/concurrent_unordered_multimap::key_eq%20Method.md)|Retorna o objeto armazenado da função de comparação de igualdade.|  
|[Método concurrent\_unordered\_multimap::swap](../Topic/concurrent_unordered_multimap::swap%20Method.md)|Alterna o conteúdo de dois objetos de `concurrent_unordered_multimap` .  Este método não é seguro em simultaneidade.|  
|[Método concurrent\_unordered\_multimap::unsafe\_erase](../Topic/concurrent_unordered_multimap::unsafe_erase%20Method.md)|Sobrecarregado.  Remove os elementos de `concurrent_unordered_multimap` em posições especificadas.  Este método não é seguro em simultaneidade.|  
  
### Operadores Públicos  
  
|Nome|Descrição|  
|----------|---------------|  
|[Operador concurrent\_unordered\_multimap::operator\=](../Topic/concurrent_unordered_multimap::operator=%20Operator.md)|Sobrecarregado.  Atribui o conteúdo de outro objeto `concurrent_unordered_multimap` nesse.  Este método não é seguro em simultaneidade.|  
  
## Comentários  
 Para obter informações detalhadas sobre a classe `concurrent_unordered_multimap`, consulte [Contêineres e objetos em paralelo](../../../parallel/concrt/parallel-containers-and-objects.md).  
