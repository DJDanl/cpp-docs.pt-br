...
|[Exemplos de aplicativo Windows Runtime](/samples/browse/?languages=cpp&expanded=windows&products=windows-uwp)|Contém exemplos de código para download e aplicativos de demonstração para Windows Runtime.|
