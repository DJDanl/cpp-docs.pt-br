...
O exemplo básico a seguir mostra como usar `parallel_sort` para classificar um `vector` dos **`int`** valores. Por padrão, o `parallel_sort` usa os valores [std:: less](../../standard-library/less-struct.md) para comparar.
