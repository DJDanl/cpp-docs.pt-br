...
## <a name="using-the-httprequest-class-in-a-includewin8appnamelongbuildincludeswin8appnamelongmdmd-app"></a>Usando a Classe HttpRequest em um Aplicativo do [!INCLUDE[win8_appname_long](../../build/includes/win8_appname_long_md.md)]  
 Esta seção demonstra como usar o `HttpRequest` classe em um [!INCLUDE[win8_appname_long](../../build/includes/win8_appname_long_md.md)] aplicativo. O aplicativo fornece uma caixa de entrada que define um recurso de URL, e comandos do botão que executam operações GET e POST e um botão de comando que cancela a operação atual.  
...
8.  Nas propriedades do projeto, em **vinculador**, **entrada**, especifique `shcore.lib` e `msxml6.lib`.  
 ...
 ![O aplicativo da Windows Store em execução](../../parallel/concrt/media/concrt_usingixhr2.png "concrt_usingixhr2")  
...
## <a name="see-also"></a>Consulte também  
 ...
 [Programação assíncrona em C++](http://msdn.microsoft.com/en-us/512700b7-7863-44cc-93a2-366938052f31)   
 [Criando operações assíncronas em C++ para aplicativos da Windows Store](../../parallel/concrt/creating-asynchronous-operations-in-cpp-for-windows-store-apps.md)   
