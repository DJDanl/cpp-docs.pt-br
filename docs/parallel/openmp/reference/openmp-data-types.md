---
title: Tipos de dados OpenMP | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
ms.openlocfilehash: 1e7dd6040d2b53f013dd5b3976b63b1d688a9670
ms.contentlocale: pt-br
ms.lasthandoff: 02/25/2017

---
# <a name="openmp-data-types"></a>OpenMP Tipos de dados
Fornece links para tipos de dados usados na API do OpenMP.  
