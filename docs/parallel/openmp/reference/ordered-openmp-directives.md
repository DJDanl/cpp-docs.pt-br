...
O **ordenados** diretiva deve estar dentro da extensão dinâmica de uma [para](../../../parallel/openmp/reference/for-openmp.md) ou **paralela para** construir com um **ordenados** cláusula.
