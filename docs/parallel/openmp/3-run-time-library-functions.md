...
O valor do parâmetro *num_threads* deve ser um inteiro positivo. Seu efeito depende se o ajuste dinâmico do número de threads está habilitado. Para um conjunto abrangente de regras sobre a interação entre o `omp_set_num_threads` função e o ajuste dinâmico de threads, consulte a seção 2.3.
...
### <a name="321-ompinitlock-and-ompinitnestlock-functions"></a>3.2.1 funções funções omp_init_lock e omp_init_nest_lock
...
### <a name="322-ompdestroylock-and-ompdestroynestlock-functions"></a>3.2.2 funções funções omp_destroy_lock e omp_destroy_nest_lock
...
### <a name="323-ompsetlock-and-ompsetnestlock-functions"></a>3.2.3 funções funções omp_set_lock e omp_set_nest_lock
...
### <a name="324-ompunsetlock-and-ompunsetnestlock-functions"></a>3.2.4 funções funções omp_unset_lock e omp_unset_nest_lock
...
### <a name="325-omptestlock-and-omptestnestlock-functions"></a>3.2.5 funções funções omp_test_lock e omp_test_nest_lock
