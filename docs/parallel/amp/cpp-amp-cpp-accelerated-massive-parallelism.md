...
|[Usando C++ AMP em aplicativos da Windows Store](../../parallel/amp/using-cpp-amp-in-windows-store-apps.md)|Descreve como usar C++ AMP em [!INCLUDE[win8_appname_long](../../build/includes/win8_appname_long_md.md)] aplicativos que usam tipos de tempo de execução do Windows.|  
