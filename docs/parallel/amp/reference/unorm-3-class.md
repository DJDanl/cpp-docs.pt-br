...
ms.locfileid: "77126182"
---
# <a name="unorm_3-class"></a>Classe unorm_3

Representa um pequeno vetor de três números normais sem sinal.
...
|{1&gt;Nome&lt;1}|Descrição|
|----------|-----------------|
|[Construtor de unorm_3](#ctor)|Sobrecarregado. O construtor padrão inicializa todos os elementos com 0.|
...
|{1&gt;Nome&lt;1}|Descrição|
|----------|-----------------|
|[Constante de tamanho](#unorm_3__size)||
