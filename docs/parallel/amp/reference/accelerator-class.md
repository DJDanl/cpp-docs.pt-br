...
|Nome|Descrição|  
|----------|-----------------|  
|[Método create_view](#create_view)|Cria e retorna um `accelerator_view` objeto esse acelerador.|  
|[Método get_all](#get_all)|Retorna um vetor de `accelerator` objetos que representam todos os Aceleradores disponíveis.|  
|[Método get_auto_selection_view](#get_auto_selection_view)|Retorna a seleção automática `accelerator_view`.|  
|[Método get_dedicated_memory](#get_dedicated_memory)|Retorna a memória dedicada para o `accelerator`, em quilobytes.|  
|[Método get_default_cpu_access_type](#get_default_cpu_access_type)|Retorna o padrão [access_type](concurrency-namespace-enums-amp.md#access_type) para buffers criados nesse acelerador.|  
|[Método get_default_view](#get_default_view)|Retorna o padrão `accelerator_view` objeto que está associado com o `accelerator`.|  
|[Método get_description](#get_description)|Retorna uma descrição resumida do `accelerator` dispositivo.|  
|[Método get_device_path](#get_device_path)|Retorna o caminho do dispositivo.|  
|[Método get_has_display](#get_has_display)|Determina se o `accelerator` está anexado a uma exibição.|  
|[Método get_is_debug](#get_is_debug)|Determina se o `accelerator` tem a camada de depuração habilitada para o relatório de erros abrangente.|  
|[Método get_is_emulated](#get_is_emulated)|Determina se o `accelerator` é emulada.|  
|[Método get_supports_cpu_shared_memory](#get_supports_cpu_shared_memory)|Determina se o `accelerator` oferece suporte a memória compartilhada|  
|[Método get_supports_double_precision](#get_supports_double_precision)|Determina se o `accelerator` está anexado a uma exibição.|  
|[Método get_supports_limited_double_precision](#get_supports_limited_double_precision)|Determina se o `accelerator` tem suporte limitado para matemática de precisão dupla.|  
|[Método get_version](#get_version)|Retorna a versão do `accelerator`.|  
|[Método set_default](#set_default)|Retorna o caminho do acelerador padrão.|  
|[Método set_default_cpu_access_type](#set_default_cpu_access_type)|Define a CPU padrão [access_type](concurrency-namespace-enums-amp.md#access_type)para matrizes e alocações de memória implícita feitas neste `accelerator`.|  
  
### <a name="public-operators"></a>Operadores públicos  
  
|Nome|Descrição|  
|----------|-----------------|  
|[operador! = operador](#operator_neq)|Compara isso `accelerator` objeto com outra e retorna `false` se eles forem iguais; caso contrário, retornará `true`.|  
|[operador Operator =](#operator_eq)|Copia o conteúdo especificado `accelerator` objeto a este.|  
|[operador Operator = =](#operator_eq_eq)|Compara isso `accelerator` objeto com outra e retorna `true` se eles forem iguais; caso contrário, retornará `false`.|  
  
### <a name="public-data-members"></a>Membros de Dados Públicos  
  
|Nome|Descrição|  
|----------|-----------------|  
|[Membro de dados cpu_accelerator](#cpu_accelerator)|Obtém uma cadeia de caracteres constante da CPU `accelerator`.|  
|[Membro de dados dedicated_memory](#dedicated_memory)|Obtém a memória dedicada para o `accelerator`, em quilobytes.|  
|[Membro de dados default_accelerator](#default_accelerator)|Obtém uma cadeia de caracteres constante para o padrão `accelerator`.|  
|[Membro de dados default_cpu_access_type](#default_cpu_access_type)|Obtém ou define a CPU padrão [access_type](concurrency-namespace-enums-amp.md#access_type)para matrizes e alocações de memória implícita feitas neste `accelerator`.|  
|[Membro de dados default_view](#default_view)|Obtém o padrão `accelerator_view` objeto que está associado com o `accelerator`.|  
|[Descrição do membro de dados](#description)|Obtém uma descrição resumida do `accelerator` dispositivo.|  
|[Membro de dados device_path](#device_path)|Obtém o caminho do dispositivo.|  
|[Membro de dados direct3d_ref](#direct3d_ref)|Obtém uma cadeia de caracteres constante para obter uma referência do Direct3D `accelerator`.|  
|[Membro de dados direct3d_warp](#direct3d_warp)|Obtém a cadeia de caracteres constante para um `accelerator` que você pode usar para executar o código C++ AMP em CPUs de vários núcleos que usam o Streaming SIMD Extensions (SSE) do objeto.|  
|[Membro de dados has_display](#has_display)|Obtém um valor booliano que indica se o `accelerator` está anexado a uma exibição.|  
|[Membro de dados is_debug](#is_debug)|Indica se o `accelerator` tem a camada de depuração habilitada para o relatório de erros abrangente.|  
|[Membro de dados is_emulated](#is_emulated)|Indica se o `accelerator` é emulada.|  
|[Membro de dados supports_cpu_shared_memory](#supports_cpu_shared_memory)|Indica se o `accelerator` oferece suporte a memória compartilhada.|  
|[Membro de dados supports_double_precision](#supports_double_precision)|Indica se o Acelerador oferece suporte a matemática de precisão dupla.|  
|[Membro de dados supports_limited_double_precision](#supports_limited_double_precision)|Indica se o acelerador tem suporte limitado para matemática de precisão dupla.|  
|[versão do membro de dados](#version)|Obtém a versão dos `accelerator`.|  
...
##  <a name="a-namedescriptiona-description"></a><a name="description"></a>Descrição 
...
##  <a name="a-nameversiona-version"></a><a name="version"></a>Versão 
