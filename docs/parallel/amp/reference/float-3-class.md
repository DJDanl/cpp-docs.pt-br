...
ms.locfileid: "77126676"
---
# <a name="float_3-class"></a>Classe float_3

Representa um pequeno vetor de três floats.
...
|{1&gt;Nome&lt;1}|Descrição|
|----------|-----------------|
|[Construtor de float_3](#ctor)|Sobrecarregado. O construtor padrão inicializa todos os elementos com 0.|
...
|{1&gt;Nome&lt;1}|Descrição|
|----------|-----------------|
|[Constante de tamanho](#float_3__size)||
