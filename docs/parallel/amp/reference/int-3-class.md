...
ms.locfileid: "77127810"
---
# <a name="int_3-class"></a>Classe int_3

Representa um pequeno vetor de três inteiros.
...
|{1&gt;Nome&lt;1}|Descrição|
|----------|-----------------|
|[Construtor de int_3](#ctor)|Sobrecarregado. O construtor padrão inicializa todos os elementos com 0.|
