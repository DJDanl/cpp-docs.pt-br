...
|double_2::Operator - operador||  
|double_2::Operator * operador =||  
|Operador de double_2::Operator / =||  
|double_2::Operator operador + +||  
|Operador + = double_2::Operator||  
|double_2::Operator = operador||  
|double_2::Operator-= operador||  
...
|Nome|Descrição|  
|----------|-----------------|  
|Membro de dados double_2::g||  
|Membro de dados double_2::GR||  
|Membro de dados double_2::r||  
|Membro de dados double_2::RG||  
|Membro de dados double_2::x||  
|Membro de dados double_2::xy||  
|Membro de dados double_2::y||  
|Membro de dados double_2::YX||  
...
##  <a name="a-namedouble2sizea-size"></a><a name="double_2__size"></a>tamanho 
