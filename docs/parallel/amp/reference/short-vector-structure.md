---
title: Estrutura short_vector | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
##  <a name="a-namectora--shortvectorshortvector-constructor"></a><a name="ctor"></a>short_vector:: short_vector construtor  
