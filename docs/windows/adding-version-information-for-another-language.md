---
title: "Adicionando informações de versão para outro idioma | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
1.  Abrir um recurso de informações de versão clicando duas vezes no [exibição recursos](../windows/resource-view-window.md).  
...
2.  Clique dentro da tabela de informações de versão e escolha **novo bloco de informações de versão** no menu de atalho.  
     ...
     Este comando adiciona um bloco de informações adicionais para o recurso de informações de versão atual e abre as propriedades correspondentes no [janela propriedades](/visualstudio/ide/reference/properties-window).  
  
3.  No **propriedades** janela, escolha o idioma apropriado e conjunto para o novo bloco de caracteres.  
