...
#### Parâmetros  
 ...
 `b`  
 Uma referência a outro objeto de ComPtrRef, ou um ponteiro para um tipo`void*`anônima \(\).  
...
## Valor de retorno  
 ...
 O quarto e o quinto operadores gerenciem `true` se o objeto for igual `a` objeto `b`; caso contrário, `false`.  
