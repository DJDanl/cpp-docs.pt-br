---
title: Excluindo um botão de barra de ferramentas (C++) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "44318042"
---
# <a name="deleting-a-toolbar-button-c"></a>Excluindo um botão de barra de ferramentas (C++)

### <a name="to-delete-a-toolbar-button"></a>Para excluir um botão de barra de ferramentas

1. Selecione o botão de barra de ferramentas e arraste-o da barra de ferramentas.
