...
- Para exibir o **cores** janela, o botão direito do mouse em um **Editor de imagens** painel e escolha **Mostrar janela de cores**, ou selecione **Mostrar janela de cores**sobre o [menu imagem](../windows/image-menu-image-editor-for-icons.md).
...
1. Sobre o **Editor de imagens** barra de ferramentas (ou use **imagem** > **ferramentas**), selecione o **preencher** ferramenta.
...
Para inverter cores na seleção atual, sobre o **imagem** menu, selecione **Inverter cores**.
