---
title: switch_is (C++ COM atributo)
ms.date: 10/02/2018
f1_keywords:
- vc-attr.switch_is
helpviewer_keywords:
...
O **switch_is** C++ atributo tem a mesma funcionalidade que o [switch_is](/windows/desktop/Midl/switch-is) atributo MIDL.
