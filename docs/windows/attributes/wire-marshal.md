---
title: wire_marshal (C++ COM atributo)
ms.date: 10/02/2018
f1_keywords:
...
O **wire_marshal** C++ atributo tem a mesma funcionalidade que o [wire_marshal](/windows/desktop/Midl/wire-marshal) atributo MIDL.
