---
title: uidefault (atributo de COM do C++) | Microsoft Docs
ms.custom: ''
ms.date: 10/02/2018
ms.technology:
- cpp-windows
...
O **uidefault** atributo C++ tem a mesma funcionalidade que o [uidefault](/windows/desktop/Midl/uidefault) atributo MIDL.
