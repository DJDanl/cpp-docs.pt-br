---
title: 'Como: ativar e usar um componente de tempo de execução do Windows usando a WRL | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
7.  Imprimir o nome de domínio para o console e retornar. Todos os `ComPtr` e há objetos RAII deixar o escopo e são liberados automaticamente.  
     ...
     O [WindowsGetStringRawBuffer](http://msdn.microsoft.com/library/windows/apps/br224636.aspx) função recupera o formulário de Unicode subjacente da cadeia de caracteres do URI.  
