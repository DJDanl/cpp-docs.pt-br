---
title: Movendo um botão de barra de ferramentas | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33876898"
---
# <a name="moving-a-toolbar-button"></a>Movendo um botão da barra de ferramentas
### <a name="to-move-a-toolbar-button"></a>Para mover um botão da barra de ferramentas  
  
1.  No **exibição da barra de ferramentas** painel, arraste o botão que você deseja mover para o novo local na barra de ferramentas.  
