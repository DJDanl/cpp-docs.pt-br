---
title: Copiando botões da barra de ferramentas (C++) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "44318663"
---
# <a name="copying-buttons-from-a-toolbar-c"></a>Copiando botões da barra de ferramentas (C++)
