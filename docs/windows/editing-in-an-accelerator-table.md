---
title: Editando em uma tabela de teclas aceleradoras | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2.  Selecione uma entrada na tabela e clique para ativar a edição no local.  
  
3.  Selecione a caixa de combinação suspensa ou digite em vigor para fazer alterações.  
