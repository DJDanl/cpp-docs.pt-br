...
2.  Selecione a cadeia de caracteres que você deseja editar e clique duas vezes o **ID**, **valor**, ou **legenda** coluna. Agora você pode:  
  
    -   Selecione um **ID** do **suspensa ID** lista ou digite uma ID diretamente no local.  
  
    -   Digite um número diferente do **valor** coluna.  
  
    -   Digite edições no **legenda** coluna.  
  
        > [!NOTE]
        >  Você também pode editar as propriedades da cadeia de caracteres no [janela propriedades](/visualstudio/ide/reference/properties-window).  
