---
title: Excluindo um controle | Microsoft Docs
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="deleting-a-control"></a>Excluindo um controle
### <a name="to-delete-a-control"></a>Para excluir um controle  
  
1.  Na caixa de diálogo, selecione o controle e pressione a **excluir** chave.  
