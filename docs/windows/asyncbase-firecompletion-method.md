---
title: 'Método: Firecompletion | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
## <a name="remarks"></a>Comentários  
 A primeira versão do FireCompletion() redefine a variável de delegado do progresso interno. A segunda versão invoca o manipulador de eventos de conclusão, se a operação assíncrona é concluída.  
