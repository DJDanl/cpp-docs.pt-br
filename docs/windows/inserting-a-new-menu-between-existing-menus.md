---
title: Inserindo um novo Menu entre Menus existentes (C++) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "50077563"
---
# <a name="inserting-a-new-menu-between-existing-menus-c"></a>Inserindo um novo Menu entre Menus existentes (C++)
