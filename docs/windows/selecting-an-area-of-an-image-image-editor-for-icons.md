...
> [!NOTE]
> Consulte a **seleção de retângulo** e as ferramentas de **seleção irregular** modeladas na [barra de ferramentas do editor de imagens](./image-editor-for-icons.md) ou exiba as dicas de ferramenta associadas a cada botão na barra de ferramentas do editor de **imagem** .

Você também pode criar um pincel personalizado a partir de uma seleção. Para obter mais informações, consulte [criando um pincel personalizado](./using-a-drawing-tool-image-editor-for-icons.md).
...
1. Use a barra de ferramentas do **Editor de imagem** ou vá para menu ferramentas de **imagem**  >  **Tools** e escolha a ferramenta de seleção desejada.
...
Para obter mais informações sobre como desenhar com uma seleção, consulte [criando um pincel personalizado](./using-a-drawing-tool-image-editor-for-icons.md).
...
- Para virar a imagem horizontalmente (imagem espelho), vá para o menu **imagem**  >  **virar horizontalmente**.

- Para virar a imagem verticalmente (virar de cabeça para baixo), vá para o menu **imagem**  >  **virar verticalmente**.

- Para girar a imagem 90 graus, vá para o menu **imagem**  >  **girar 90 graus**.
...
> [!NOTE]
> Se você tiver a opção de **grade de blocos** selecionada na [caixa de diálogo Configurações de grade](./image-editor-for-icons.md), redimensione os snaps para a próxima linha de grade de bloco. Se apenas a opção **grade de pixels** for selecionada (a configuração padrão), o redimensionamento será ajustado para o próximo pixel disponível.
...
1. Na janela **Propriedades** , altere qualquer uma ou todas as propriedades da imagem.
   ...
   |**Paleta**|Altera as propriedades de cor.<br/><br/>Clique duas vezes para selecionar uma cor e exibir a [caixa de diálogo Seletor de cores personalizado](./image-editor-for-icons.md). Defina a cor digitando os valores RGB ou HSL nas caixas de texto apropriadas.|
