---
title: Teclas de aceleração (C++ editor de imagem para ícones)
ms.date: 02/15/2019
helpviewer_keywords:
- accelerator keys
...
|Image.SmallerBrush|**Ctrl** +  **-** (menos)|Reduz o tamanho do pincel em um pixel em cada direção. Para expandir o tamanho do pincel novamente, consulte Image. LargerBrush nesta tabela.|
