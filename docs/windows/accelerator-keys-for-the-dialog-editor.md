...
|-------------|----------|-----------------|  
|Format.AlignBottoms|CTRL + SHIFT + SETA PARA BAIXO|Alinha as bordas inferior dos controles selecionados com o controle dominante|  
...
|Format.CenterHorizontal|CTRL + SHIFT + F9|Centros de controles horizontalmente dentro da caixa de diálogo|  
|Format.CenterVertical|CTRL + F9|Centros de controles verticalmente dentro da caixa de diálogo|  
|Format.CheckMnemonics|CTRL + M|Verificações de exclusividade de mnemônicos|  
|Format.SizeToContent|SHIFT + F7|Redimensiona o controle selecionado para ajustar o texto de legenda|  
|Format.SpaceAcross|ALT + SETA PARA ESQUERDA|Espaços uniformemente os controles selecionados horizontalmente|  
|Format.SpaceDown|ALT + SETA PARA BAIXO|Espaços uniformemente os controles selecionados verticalmente|  
|Format.TabOrder|CTRL + D|Define a ordem dos controles de caixa de diálogo|  
