---
title: "S&#237;mbolos de programa&#231;&#227;o do Windows MFC | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
helpviewer_keywords: 
  - "Símbolos MFC"
  - "símbolos, MFC"
  - "símbolos MFC de programação do Windows [C++]"
...
manager: "ghogen"
---
# S&#237;mbolos de programa&#231;&#227;o do Windows MFC
[!INCLUDE[vs2017banner](../assembler/inline/includes/vs2017banner.md)]

Esses símbolos também são parte dos arquivos de suporte do MFC, mas eles oferecem suporte a ações e funções de aplicativo padrão do Windows.  Esses símbolos são usados principalmente com menus.  Quando você estiver trabalhando com os menus no Editor de Menu, esses símbolos aparecerá na janela de propriedade associados com comandos de menu comuns.  Por exemplo, se seu aplicativo tiver um menu de arquivo com um comando Exit, esse comando será associado com o símbolo ID\_APP\_EXIT na  [janela Propriedades do](../Topic/Properties%20Window.md).  
...
|ID\_HELP \+ USANDO|ID\_INDICATOR\_CAPS|ID\_INDICATOR\_EXT|  
...
|IDCANCEL|IDD\_ABOUTBOX Ÿ100,23523|IDIGNORE|  
