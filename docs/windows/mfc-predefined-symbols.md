...
Os arquivos de cabeçalho incluem valores de ID de símbolo para valores comuns do MFC. Esses símbolos estão disponíveis somente quando você estiver trabalhando em um projeto MFC. Observe que o prefixo AFX_ é seguido pelos prefixos de nome de símbolo padrão.
...
|AFX_IDP_DAO_DFX_BIND|INICIALIZAÇÃO DE AFX_IDP_DAO_ENGINE_|
...
|AFX_IDS_CHECKLISTBOX_MIXED|DESMARQUE A OPÇÃO AFX_IDS_CHECKLISTBOX_|
