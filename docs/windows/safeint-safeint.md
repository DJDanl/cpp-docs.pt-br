...
### <a name="parameters"></a>Parâmetros  
 ...
 U  
 O tipo de dados armazenados na **SafeInt**. Isso pode ser o tipo de um valor booliano, caractere ou inteiro. Se for um tipo inteiro, pode ser assinado ou não assinado e ter entre 8 e 64 bits.  
