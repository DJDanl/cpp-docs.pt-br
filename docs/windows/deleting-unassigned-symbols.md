---
title: Excluindo símbolos não atribuídos | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
[Alterando símbolos não atribuídos](../windows/changing-unassigned-symbols.md)<br/>
