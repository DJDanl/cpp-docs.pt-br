...
ms.locfileid: "44315230"
---
# <a name="arrangement-of-controls-on-dialog-box-ces"></a>Organização dos controles na caixa de diálogo caixa es (C++)
...
- [Agrupando botões de opção em uma caixa de diálogo](../windows/grouping-radio-buttons-on-a-dialog-box.md)

- [Alinhando grupos de controles](../windows/aligning-groups-of-controls.md)

- [Equalizando o espaçamento entre controles](../windows/evening-the-spacing-between-controls.md)

- [Centralizando controles em uma caixa de diálogo](../windows/centering-controls-in-a-dialog-box.md)

- [Organizando botões de push ao longo da parte direita ou inferior de uma caixa de diálogo](../windows/arranging-push-buttons-along-the-right-or-bottom-of-a-dialog-box.md)
