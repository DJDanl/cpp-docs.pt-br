...
O **controle** atributo implica a [coclass](../windows/coclass.md) atributo. O **controle** atributo C++ tem a mesma funcionalidade que o [controle](/windows/desktop/Midl/control) atributo MIDL.
