...
## <a name="remarks"></a>Comentários  
 O **defaultcollelem** atributo C++ tem a mesma funcionalidade que o [defaultcollelem](http://msdn.microsoft.com/library/windows/desktop/aa366792) atributo MIDL.  
