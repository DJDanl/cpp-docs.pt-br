...
1.  Abrir o recurso de informações de versão clicando duas vezes em seu ícone no [exibição recursos](../windows/resource-view-window.md).  
...
2.  Clique o cabeçalho de bloco que deseja excluir e escolha **Excluir Bloco de informações de versão** no menu de atalho.  
