---
title: Excluindo uma entrada de uma tabela de aceleradores (C++) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "46397189"
---
# <a name="deleting-an-entry-from-an-accelerator-table-c"></a>Excluindo uma entrada de uma tabela de aceleradores (C++)
