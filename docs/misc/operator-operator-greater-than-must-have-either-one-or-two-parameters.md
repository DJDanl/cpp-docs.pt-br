...
-   Se você precisar sem parâmetros ou com mais de dois, você deve usar o [Instrução Function](../Topic/Function%20Statement%20\(Visual%20Basic\).md) para definir uma `Function` procedimento em vez de um operador.  
