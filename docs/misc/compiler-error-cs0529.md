...
Interface herdada 'interface1' gera um ciclo na hierarquia de interface de 'interface2'  
 ...
 A lista de herança para um [interface](../Topic/interface%20\(C%23%20Reference\).md) inclui uma referência direta ou indireta a mesmo. Uma interface não pode herdar de si mesma.  
