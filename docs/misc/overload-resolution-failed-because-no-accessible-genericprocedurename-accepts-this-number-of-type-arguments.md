...
1.  Certifique\-se de que a versão que você pretende chamar está acessível pelo código de chamada. Consulte [Níveis de acesso no Visual Basic](../Topic/Access%20Levels%20in%20Visual%20Basic.md).  
