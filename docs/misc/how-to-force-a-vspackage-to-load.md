...
## Programação robusta  
 Carregamento de força não deve ser usado para comunicação VSPackage.  Use [Usando e fornecer serviços](../Topic/Using%20and%20Providing%20Services.md) em vez disso.  
