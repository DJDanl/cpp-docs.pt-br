...
Um `ReadOnly` declaração de propriedade especifica os níveis de acesso em ambos os [Instrução Property](../Topic/Property%20Statement.md) e [Instrução Get](../Topic/Get%20Statement.md).  
