...
stackalloc não pode ser usada em uma variável ou bloco finally  
 ...
 O [stackalloc](../Topic/stackalloc%20\(C%23%20Reference\).md) palavra\-chave não pode ser usada em uma [catch](../Topic/try-catch%20\(C%23%20Reference\).md) ou [Finalmente](../Topic/try-catch-finally%20\(C%23%20Reference\).md) bloco. Para obter mais informações, consulte [Exceções e manipulação de exceções](../Topic/Exceptions%20and%20Exception%20Handling%20\(C%23%20Programming%20Guide\).md).  
