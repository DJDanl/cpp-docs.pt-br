...
2.  Use o [nada](../Topic/Nothing%20\(Visual%20Basic\).md) palavra\-chave para atribuições e comparações quando você usa variáveis de objeto. O exemplo a seguir demonstra isso.  
