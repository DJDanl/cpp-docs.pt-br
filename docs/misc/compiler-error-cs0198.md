...
Campos de somente leitura e estático 'nome do campo' não podem ser atribuídos a \(exceto em um construtor estático ou um inicializador de variável\)  
 ...
 Um [readonly](../Topic/readonly%20\(C%23%20Reference\).md) variável deve ter o mesmo [estático](../Topic/static%20\(C%23%20Reference\).md) uso do construtor no qual você deseja inicializar. Para obter mais informações, consulte [Construtores estáticos](../Topic/Static%20Constructors%20\(C%23%20Programming%20Guide\).md).  
