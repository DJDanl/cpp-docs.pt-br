...
## Comentários  
 Você pode atualizar o arquivo de banco de dados usando [!INCLUDE[vs_orcas_long](../atl/reference/includes/vs_orcas_long_md.md)] ou usando a API `System.Data.SqlServerCe.SqlCeEngine.Upgrade`.  
