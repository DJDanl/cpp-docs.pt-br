...
Nenhuma sobrecarga para 'method' corresponde ao delegate 'delegate'  
 ...
 Você pode resolver esse erro, ajustando o método ou delegar a assinatura. Para obter mais informações, consulte [Delegados](../Topic/Delegates%20\(C%23%20Programming%20Guide\).md).  
