...
Constante de ponto flutuante está fora do intervalo do tipo 'type'  
 ...
 Um valor foi atribuído a uma variável de ponto flutuante que é muito grande para as variáveis desse tipo de dados. Consulte [tabela de tipos integrais](../Topic/Integral%20Types%20Table%20\(C%23%20Reference\).md) para obter informações sobre o intervalo de valores permitidos em tipos de dados.  
