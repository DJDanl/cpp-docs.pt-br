...
O <xref:System.Runtime.InteropServices.DefaultCharSetAttribute?displayProperty=fullName> atributo permite que você especifique o conjunto para ser usado em marshaling cadeias de caracteres. Seu valor tem um membro do <xref:System.Runtime.InteropServices.CharSet?displayProperty=fullName> enumeração.  
 ...
 A versão atual do [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] não oferece suporte a esse atributo. O suporte é possível em versões futuras.  
  
 **ID do erro:** BC32510  
  
### Para corrigir este erro  
  
-   Usar cada [Instrução Declare](../Topic/Declare%20Statement.md) para especificar o conjunto de caracteres para o procedimento externo está declarando. O exemplo a seguir ilustra isso.  
...
## Consulte também  
 ...
 [Instrução Declare](../Topic/Declare%20Statement.md)