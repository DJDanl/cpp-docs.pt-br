...
A variável de grupo especificada em um `For Each` instrução não é um objeto de coleção ou matriz, e seu tipo não implementa o <xref:System.Collections.IEnumerable> interface. O tipo deve o suporte a [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] padrão de design de coleção ou implementar <xref:System.Collections.IEnumerable>.  
  
 **ID do erro:** BC32023  
  
### Para corrigir este erro  
  
-   Declarar a variável de grupo para ser de um tipo de classe que o oferece suporte a [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] design de coleção ou implementa <xref:System.Collections.IEnumerable>.  
  
## Consulte também  
 <xref:System.Collections.IEnumerable>   
 [Instrução For Each...Next](../Topic/For%20Each...Next%20Statement%20\(Visual%20Basic\).md)   
