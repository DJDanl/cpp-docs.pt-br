...
Um campo const requer um valor a ser fornecido  
 ...
 Você deve inicializar um [const](../Topic/const%20\(C%23%20Reference\).md) variável. Para obter mais informações, consulte [Constantes](../Topic/Constants%20\(C%23%20Programming%20Guide\).md).  
