...
'method' não pode especificar somente atributo Out em um parâmetro ref. Use tanto em e atributos ou nenhum deles.  
 ...
 Um método de interface tem um parâmetro que usa [ref](../Topic/ref%20\(C%23%20Reference\).md) com apenas o [Out](frlrfSystemRuntimeInteropServicesOutAttributeClassTopic) atributo. Um `ref` parâmetro usa o **Out** atributo também deve usar o [na](frlrfSystemRuntimeInteropServicesInAttributeClassTopic) atributo.  
