...
O [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] compilador chama o vinculador de Assembly \(Al.exe, também conhecido como Alink\) para gerar um assembly com um manifesto. O vinculador relatou um erro de criação de um arquivo ou escrever um recurso na memória para ele. Isso pode ser um problema de configuração.  
