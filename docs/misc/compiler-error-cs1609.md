...
Modificadores não podem ser colocados em declarações de acessador de evento  
 ...
 Modificadores só podem ser colocados em declarações de evento e não em declarações de acessador de evento. Para obter mais informações, consulte [Usando propriedades](../Topic/Using%20Properties%20\(C%23%20Programming%20Guide\).md).  
