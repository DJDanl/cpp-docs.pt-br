...
Um [Instrução Event](../Topic/Event%20Statement.md) usa um representante para especificar sua assinatura, mas o [Instrução Delegate](../Topic/Delegate%20Statement.md) está marcado como `<CLSCompliant(False)>` ou não está marcado.  
