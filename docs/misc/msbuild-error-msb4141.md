...
-   Especificar um valor válido para `MSBuildToolsPath` quando você define um conjunto de ferramentas personalizado no Registro ou no arquivo de configuração de [!INCLUDE[vstecmsbuild](../build/includes/vstecmsbuild_md.md)] .  
  
## Consulte também  
 [Configurações padrão e personalizadas do Toolset](../Topic/Standard%20and%20Custom%20Toolset%20Configurations.md)   
