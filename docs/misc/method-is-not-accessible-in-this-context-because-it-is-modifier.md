...
Você tentou acessar um método que não está acessível neste contexto porque ele foi declarado `Private`. Uma possível causa desse erro é que o [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] compilador importa todos os membros de uma classe e diferencia maiúsculas de minúsculas para nomes diferenciados apenas por maiúsculas e minúsculas entrem em conflito.  
