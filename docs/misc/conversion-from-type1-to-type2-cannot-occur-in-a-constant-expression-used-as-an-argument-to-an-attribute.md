...
Uma expressão usada para um argumento de atributo avalia para um tipo de dados diferente do parâmetro de atributo correspondente, e [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] não permite a conversão de tipos necessária para argumentos de atributo.  
...
## Consulte também  
 ...
 [Instrução Const](../Topic/Const%20Statement%20\(Visual%20Basic\).md)   
