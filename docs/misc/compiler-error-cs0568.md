...
Estruturas não podem conter construtores explícitos sem parâmetro  
 ...
 Cada [struct](../Topic/struct%20\(C%23%20Reference\).md) já tem um construtor padrão que inicializa o objeto como zero. Portanto, os construtores que você pode criar para um struct devem levar um ou mais parâmetros.  
