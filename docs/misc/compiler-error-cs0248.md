...
Não é possível criar uma matriz com um tamanho negativo  
 ...
 Um tamanho da matriz foi especificado com um número negativo. Para obter mais informações, consulte [Matrizes](../Topic/Arrays%20\(C%23%20Programming%20Guide\).md).  
