...
Um operador de conversão é declarado com um tipo de retorno de [Tipo de dados Object](../Topic/Object%20Data%20Type.md).  
  
 Em tempo de compilação, [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] considera uma conversão predefinida existir de qualquer tipo de referência para qualquer tipo na sua hierarquia de herança, ou seja, qualquer tipo do qual ele deriva ou que deriva dela.`Object` é o tipo de dados universal no [!INCLUDE[dnprdnshort](../Token/dnprdnshort_md.md)], portanto, todo tipo deriva de `Object`.  
