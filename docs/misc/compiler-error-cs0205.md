...
Não é possível chamar um membro abstract base: 'method'  
 ...
 Você não pode chamar um [abstrato](../Topic/abstract%20\(C%23%20Reference\).md) método porque ele não tem um corpo de método. Para obter mais informações, consulte [Classes e membros de classes abstract e sealed](../Topic/Abstract%20and%20Sealed%20Classes%20and%20Class%20Members%20\(C%23%20Programming%20Guide\).md).  
