...
O nome de um conflito de membro de tipo com o nome de um membro declarado implicitamente em todas as enumerações.  
 ...
 O [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] compilador cria membros implícitos correspondentes a certos elementos de programação que você declarar. Enumerações declaram implicitamente o membro `value__member`.  
...
## Consulte também  
 ...
 [Visão geral de enumerações](../Topic/Enumerations%20Overview%20\(Visual%20Basic\).md)   
