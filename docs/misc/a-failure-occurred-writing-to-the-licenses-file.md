...
Não foi possível gravar o arquivo transformado pelo sistema do projeto. Como parte da preparação de licenças, o sistema do projeto transformará arquivos do texto. licx em arquivos de licenças binário que sejam entendidos pelo [!INCLUDE[dnprdnshort](../Token/dnprdnshort_md.md)] o licenciamento do sistema.  
