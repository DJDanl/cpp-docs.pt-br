---
title: "CS1593 de erro do compilador | Microsoft Docs"
ms.custom: ""
ms.date: "11/17/2016"
...
manager: "wpickett"
---
# CS1593 de erro do compilador
Delegate 'del' não obtém argumentos 'number'  
  
 O número de argumentos passados para um [Delegar](../Topic/delegate%20\(C%23%20Reference\).md) invocação não concorda com o número de parâmetros na declaração do delegado.  
