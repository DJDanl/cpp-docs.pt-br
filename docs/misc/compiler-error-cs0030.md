...
Não é possível converter o tipo 'type' para 'type'  
 ...
 Você deve fornecer as rotinas de conversão para dar suporte a determinadas sobrecargas do operador. Para obter mais informações, consulte [Operadores de conversão](../Topic/Conversion%20Operators%20\(C%23%20Programming%20Guide\).md).  
