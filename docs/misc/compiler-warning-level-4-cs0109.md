...
O membro 'member' não oculta um membro herdado. A palavra\-chave new não é necessária  
 ...
 Uma declaração de classe incluída o [novo](../Topic/new%20\(C%23%20Reference\).md) palavra\-chave mesmo que a declaração não substitui uma declaração existente em uma classe base. Você pode excluir o **novo** palavra\-chave.  
