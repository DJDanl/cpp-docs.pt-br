...
Uma propriedade, procedimento ou evento em uma classe derivada usa um `Implements` cláusula especificando um membro de interface derivada que já é implementado na interface base na classe base.  
 ...
 Uma classe derivada pode reimplementar um membro de interface que é implementado pela classe base. Isso não é o mesmo que substituir a implementação da classe base. Para obter mais informações, consulte [Implements](../Topic/Implements%20Clause%20\(Visual%20Basic\).md).  
