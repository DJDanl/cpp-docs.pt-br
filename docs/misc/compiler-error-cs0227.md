...
Código sem segurança só pode aparecer se a compilação for com \/unsafe  
 ...
 Se o código\-fonte contém o [unsafe](../Topic/unsafe%20\(C%23%20Reference\).md) palavra\-chave, o [\/unsafe](../Topic/-unsafe%20\(C%23%20Compiler%20Options\).md) também deve ser usada a opção de compilador. Para obter mais informações, consulte [Código não seguro e ponteiros](../Topic/Unsafe%20Code%20and%20Pointers%20\(C%23%20Programming%20Guide\).md).  
