...
Um método parcial deve ser declarado em uma classe ou struct parcial  
 ...
 Não é possível declarar um [parcial](../Topic/partial%20\(Method\)%20\(C%23%20Reference\).md) método, a menos que ela é encapsulada em uma classe parcial ou estrutura parcial.  
