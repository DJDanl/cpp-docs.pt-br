...
Ref ou out argumento deve ser uma variável pode ser atribuída  
 ...
 Somente uma variável pode ser passada como um [ref](../Topic/ref%20\(C%23%20Reference\).md) parâmetro em uma chamada de método. Um `ref` valor é como passar um ponteiro.  
