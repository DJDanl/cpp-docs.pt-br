...
Uma classe ou estrutura é exibido em várias definições no mesmo tipo de continente, e mais de uma definição não está marcado como `Partial`.  
 ...
 Você deve usar o [Parcial](../Topic/Partial%20\(Visual%20Basic\).md) palavra\-chave em pelo menos uma das várias definições de uma classe ou estrutura, mas é recomendável que você usá\-lo em todas as definições parciais.  
...
-   Use o [Parcial](../Topic/Partial%20\(Visual%20Basic\).md) palavra\-chave em cada definição parcial da classe ou estrutura.