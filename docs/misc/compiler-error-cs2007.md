...
Opção de linha de comando não reconhecida: 'option'  
 ...
 O compilador foi passado uma cadeia de caracteres que não era um [opção de compilador](../Topic/C%23%20Compiler%20Options.md), embora ele começou com uma barra \(\/\).  
