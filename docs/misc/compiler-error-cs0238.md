...
'member' não pode ser sealed porque não é uma substituição  
 ...
 [lacrado](../Topic/sealed%20\(C%23%20Reference\).md) foi usado em um membro que também não foi marcado com [substituir](../Topic/override%20\(C%23%20Reference\).md). Para obter mais informações, consulte [Herança](../Topic/Inheritance%20\(C%23%20Programming%20Guide\).md).  
