...
Este erro geralmente ocorre como resultado de um arquivo corrompido. Você talvez precise reinstalar [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)].  
