...
'member': novo membro protegido declarado na classe sealed  
 ...
 Um [lacrado](../Topic/sealed%20\(C%23%20Reference\).md) classe não pode apresentar um [protegido](../Topic/protected%20\(C%23%20Reference\).md) membro porque nenhuma outra classe poderão herdar do `sealed` da classe e usar o `protected` membro.  
