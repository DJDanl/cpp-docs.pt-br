...
-   Definir o [Manifesto de implantação do ClickOnce](../Topic/ClickOnce%20Deployment%20Manifest.md)`extension` atributo para um valor que começa com um caractere de ponto \(.\), por exemplo, ". doc".  
