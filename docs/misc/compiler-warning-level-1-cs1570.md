...
O comentário XML em 'em construção' mal\-formados XML — 'razão'  
 ...
 Ao usar [\/doc](../Topic/-doc%20\(C%23%20Compiler%20Options\).md), os comentários no código\-fonte devem ser em XML. Qualquer erro com a marcação XML irá gerar CS1570. Por exemplo:  
