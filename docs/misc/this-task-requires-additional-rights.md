...
Este erro é exibido se um comando Visual Studio é chamado por um usuário cuja conta tem permissões insuficientes concluir a operação.  
 ...
 Para obter mais informações sobre permissões para executar o Visual Studio, consulte [Permissões de usuário](../Topic/User%20Permissions%20and%20Visual%20Studio.md).  
