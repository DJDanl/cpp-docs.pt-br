...
Uma classe usa um [Instrução Inherits](../Topic/Inherits%20Statement.md) para especificar uma base de dados de classe, mas não pode acessar nenhum construtor na classe base pretendida.  
...
## Consulte também  
 ...
 [Operador New](../Topic/New%20Operator%20\(Visual%20Basic\).md)   
