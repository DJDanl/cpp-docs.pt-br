...
'event': evento na interface não pode ter inicializador  
 ...
 Um evento em uma interface não pode ter um inicializador. Para obter mais informações, consulte [Interfaces](../Topic/Interfaces%20\(C%23%20Programming%20Guide\).md).  
