...
'membro de interface ': contendo o tipo não implementa a interface 'interface'  
 ...
 Você tentou implementar um membro de interface em um [classe](../Topic/class%20\(C%23%20Reference\).md) que derivam o [interface](../Topic/interface%20\(C%23%20Reference\).md). Você deve excluir a implementação do membro da interface ou adicionar a interface para a lista de classe base da classe.  
