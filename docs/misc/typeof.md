...
---
# __typeof
**Observação** neste tópico se aplica somente à versão 1 de Managed Extensions for C\+\+. Esta sintaxe só deve ser usada para manter o código da versão 1. Consulte [typeid](../Topic/typeid%20%20\(C++%20Component%20Extensions\).md) para obter informações sobre como usar a funcionalidade equivalente na nova sintaxe.  
...
## Comentários  
 O **TypeOf** operador permite que você obtenha o **System:: Type** tipo de um tipo que você especificar.**TypeOf** também pode ser usado para retornar um valor de **System:: Type** em um bloco de atributo personalizado. Consulte [atributo](../windows/attribute.md) para obter mais informações sobre como criar seus próprios atributos.  
