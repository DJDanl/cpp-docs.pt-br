...
-   Já existe um link. O [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] e [!INCLUDE[csprcs](../ide/includes/csprcs_md.md)] sistema de projeto tem uma limitação que pode haver somente um link com o mesmo nome por projeto. Por exemplo, isso significa que você não pode ter um link para o VB na pasta A e B da pasta do projeto.  
