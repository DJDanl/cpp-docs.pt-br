---
title: "CS0538 de erro do compilador | Microsoft Docs"
ms.custom: ""
ms.date: "11/17/2016"
...
'name' na declaração de interface explícita não é uma interface  
 ...
 Foi feita uma tentativa para declarar explicitamente uma [interface](../Topic/interface%20\(C%23%20Reference\).md), mas não foi especificada uma interface.  
