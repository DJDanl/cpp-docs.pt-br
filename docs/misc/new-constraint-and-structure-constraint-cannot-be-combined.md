...
Uma lista de restrição inclui tanto o [Operador New](../Topic/New%20Operator%20\(Visual%20Basic\).md) restrição e o [estrutura \(Visual Basic\)](http://msdn.microsoft.com/pt-br/263ce115-ac36-4c05-8cb7-0e0eead5c6d0) restrição.  
