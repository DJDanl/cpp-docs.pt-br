...
Os exemplos incluídos na [!INCLUDE[vsipsdk](../mfc/includes/vsipsdk_md.md)] fazer uso de muitos serviços.  A lista a seguir mostra que vários comumente usados serviços e as amostras de usá\-los.  
...
|<xref:Microsoft.VisualStudio.Shell.Interop.SVsActivityLog>|[Como: usar o Log de atividades](../Topic/How%20to:%20Use%20the%20Activity%20Log.md)|  
...
## Consulte também  
 [Lista de serviços disponíveis](../Topic/List%20of%20Available%20Services.md)   
