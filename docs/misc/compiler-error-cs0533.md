...
'membro de classe derivado' oculta o membro abstrato herdado 'membro da classe base'  
 ...
 Uma base de [classe](../Topic/class%20\(C%23%20Reference\).md) método está oculto. Verifique a sintaxe da sua declaração para ver se ele está correto.  
  
 Para obter mais informações, consulte [base](../Topic/base%20\(C%23%20Reference\).md).  
