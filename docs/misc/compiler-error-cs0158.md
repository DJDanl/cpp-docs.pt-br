...
O rótulo 'Rótulo' Sombra de outro rótulo com o mesmo nome em um escopo contido  
 ...
 Um rótulo em um escopo interno oculta um rótulo com o mesmo nome em um escopo externo. Para obter mais informações, consulte [goto](../Topic/goto%20\(C%23%20Reference\).md).  
