...
'class1': não é possível derivar do tipo sealed 'class2'  
 ...
 Um [lacrado](../Topic/sealed%20\(C%23%20Reference\).md) classe não pode atuar como um [base](../Topic/base%20\(C%23%20Reference\).md) classe. Estruturas são seladas por padrão.  
