...
O tipo 'class' já define um membro denominado 'member' com os mesmos tipos de parâmetro  
 ...
 CS0111 ocorre se uma classe contiver duas declarações de membro com o mesmo nome e tipos de parâmetro. Para obter mais informações, consulte [Métodos](../Topic/Methods%20\(C%23%20Programming%20Guide\).md).  
