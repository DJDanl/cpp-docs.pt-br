...
-   Adicione uma referência ao assembly que tem o coclass \(na maioria das vezes que a interface e coclass devem estar no mesmo assembly\). Consulte [\/Reference](../Topic/-reference%20\(C%23%20Compiler%20Options\).md) ou [Add Reference Dialog Box](http://msdn.microsoft.com/pt-br/2feb0fe2-0805-4cc9-8cba-b0315849dfb7) para obter informações.  
