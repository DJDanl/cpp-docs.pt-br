...
Acessador de propriedade já definido  
 ...
 Ao declarar uma [propriedade](../Topic/Using%20Properties%20\(C%23%20Programming%20Guide\).md), você também deve declarar seus métodos do acessador. No entanto, uma propriedade não pode ter mais de um `get` método acessador ou mais de um `set` método do acessador.  
