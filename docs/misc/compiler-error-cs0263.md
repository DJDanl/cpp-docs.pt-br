...
Declarações parciais de 'type' não devem especificar classes base diferentes  
 ...
 Ao definir um tipo em declarações parciais, especifique os mesmos tipos de base em cada uma das declarações parciais. Para obter mais informações, consulte [Classes e métodos partial](../Topic/Partial%20Classes%20and%20Methods%20\(C%23%20Programming%20Guide\).md).  
