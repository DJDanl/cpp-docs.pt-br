...
Declarações parciais de 'type' devem ser todas as classes, structs ou interfaces  
 ...
 Esse erro ocorre se um tipo parcial é declarado como um tipo diferente de construção em vários lugares. Para obter mais informações, consulte [Classes e métodos partial](../Topic/Partial%20Classes%20and%20Methods%20\(C%23%20Programming%20Guide\).md).  
