...
O parâmetro nome 'nome do parâmetro' é uma duplicata  
 ...
 Uma declaração de método usado o mesmo nome de parâmetro mais de uma vez. Nomes de parâmetro devem ser exclusivos em uma declaração de método. Para obter mais informações, consulte [Métodos](../Topic/Methods%20\(C%23%20Programming%20Guide\).md).  
