...
Um alias de importação é definido com um [de](../Topic/Of%20Clause%20\(Visual%20Basic\).md) cláusula que passa os argumentos para o alias de importação de tipo.  
...
## Consulte também  
 [Instrução Imports \(tipo e namespace .NET\)](../Topic/Imports%20Statement%20\(.NET%20Namespace%20and%20Type\).md)   
 [Referências e a instrução Imports](../Topic/References%20and%20the%20Imports%20Statement%20\(Visual%20Basic\).md)   
