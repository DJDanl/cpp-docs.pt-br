...
Não é possível criar uma instância da classe abstrata ou interface 'interface'  
 ...
 Não é possível criar uma instância de um [abstrato](../Topic/abstract%20\(C%23%20Reference\).md) classe ou um [interface](../Topic/interface%20\(C%23%20Reference\).md). Para obter mais informações, consulte [Interfaces](../Topic/Interfaces%20\(C%23%20Programming%20Guide\).md).  
