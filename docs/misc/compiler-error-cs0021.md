...
Não é possível aplicar a indexação com \[\] a uma expressão do tipo 'type'  
 ...
 Foi feita uma tentativa para acessar um valor por meio de um indexador em um tipo de dados que não oferece suporte a [Indexadores](../Topic/Indexers%20\(C%23%20Programming%20Guide\).md).  
