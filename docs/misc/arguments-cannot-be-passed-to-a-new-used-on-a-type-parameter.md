...
Uma declaração ou instrução de atribuição chama um tipo genérico e fornece argumentos de construtor para um parâmetro de tipo que tem o [Operador New](../Topic/New%20Operator%20\(Visual%20Basic\).md) restrição.  
