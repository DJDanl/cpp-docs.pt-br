...
Delegado 'delegado' tem alguns argumentos inválidos  
 ...
 O tipo de um argumento passado para um [Delegar](../Topic/delegate%20\(C%23%20Reference\).md) invocação não concordar com o tipo do parâmetro na declaração do delegado.  
