...
Acessibilidade inconsistente: tipo de parâmetro 'type' é menos acessível que o indexador 'indexador'  
 ...
 Uma construção pública deve retornar um objeto acessível publicamente. Para obter mais informações, consulte [Modificadores de acesso](../Topic/Access%20Modifiers%20\(C%23%20Programming%20Guide\).md).  
