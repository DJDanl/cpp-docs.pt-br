...
Uma classe derivada não declara um construtor, e [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] não é possível gerar um porque não há nenhum construtor de classe base pode chamar.  
