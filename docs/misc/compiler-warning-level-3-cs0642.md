...
Instrução empty possivelmente incorreta  
 ...
 Você pode usar **\/nowarn** opção de compilador ou `#pragmas warning` para desabilitar o aviso; consulte [\/nowarn \(Suppress Specified Warnings\)](../Topic/-nowarn%20\(C%23%20Compiler%20Options\).md) ou [\#pragma warning](../Topic/%23pragma%20warning%20\(C%23%20Reference\).md) para obter mais informações.  
