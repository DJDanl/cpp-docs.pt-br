...
O método abstrato 'method' não pode ser marcado como virtual  
 ...
 É redundante para marcar um método membro como [abstrato](../Topic/abstract%20\(C%23%20Reference\).md) e [virtual](../Topic/virtual%20\(C%23%20Reference\).md) porque **abstrato** implica **virtual**.  
