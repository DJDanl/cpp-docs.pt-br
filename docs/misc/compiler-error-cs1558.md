...
'class' não tem um método Main estático adequado  
 ...
 O [\/principal](../Topic/-main%20\(C%23%20Compiler%20Options\).md) opção de compilador especificada uma classe na qual procurar um **principal** método. No entanto, o [principal](../Topic/Main\(\)%20and%20Command-Line%20Arguments%20\(C%23%20Programming%20Guide\).md) método não foi definido corretamente.  
