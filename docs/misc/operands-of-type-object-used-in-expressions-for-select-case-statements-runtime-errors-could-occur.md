...
A `Select`...`Case` construção usa uma ou mais expressões do [Tipo de dados Object](../Topic/Object%20Data%20Type.md).  
...
## Consulte também  
 [Instrução Select...Case](../Topic/Select...Case%20Statement%20\(Visual%20Basic\).md)   
 [Operadores aritméticos no Visual Basic](../Topic/Arithmetic%20Operators%20in%20Visual%20Basic.md)   
