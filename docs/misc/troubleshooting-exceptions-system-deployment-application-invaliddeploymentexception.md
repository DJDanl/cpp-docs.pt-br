 ...
 **Use o recurso do ClickOnce para implantar o aplicativo.**  
 Use o ClickOnce para publicar aplicativos em um servidor Web ou rede arquivo compartilhamento para instalação simplificada. Para obter mais informações, consulte [Segurança e implantação do ClickOnce](../Topic/ClickOnce%20Security%20and%20Deployment.md).  
  
## Consulte também  
 <xref:System.Deployment.Application.InvalidDeploymentException>   
 [Use the Exception Assistant](../Topic/How%20to:%20Use%20the%20Exception%20Assistant.md)   
 [Solução de problemas de implantações do ClickOnce](../Topic/Troubleshooting%20ClickOnce%20Deployments.md)   
