...
O parâmetro de saída 'parâmetro' deve ser atribuído ao antes controle saia do método atual  
 ...
 Um parâmetro marcado com o [out](../Topic/out%20\(C%23%20Reference\).md) palavra\-chave não foi atribuído um valor no corpo do método. Para obter mais informações, consulte [Passando parâmetros](../Topic/Passing%20Parameters%20\(C%23%20Programming%20Guide\).md).  
