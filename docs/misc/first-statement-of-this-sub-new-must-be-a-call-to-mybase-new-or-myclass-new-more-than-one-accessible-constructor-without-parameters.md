...
A primeira instrução deste 'Sub New' deve ser uma chamada para 'MyBase. New' ou 'MyClass. New' porque a classe base '\< base \>' de '\< derived \>' tem mais de um 'Sub New' acessível que pode ser chamado sem argumentos.  
 ...
 Um construtor de classe não fornece uma chamada para um construtor de classe base, e [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] não pode fornecer uma chamada implícita porque não é possível determinar qual construtor de classe base chamar.  
