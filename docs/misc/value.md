...
# __value
> [!NOTE]
>  Este tópico se aplica apenas a versão 1 de Managed Extensions for C\+\+. Esta sintaxe só deve ser usada para manter o código da versão 1. Consulte [Classes and Structs](../windows/classes-and-structs-cpp-component-extensions.md) para obter informações sobre como usar a funcionalidade equivalente na nova sintaxe.  
...
|------------------------------------|---------|---------------------------------|  
|struct GC<br /><br /> \- ou \-<br /><br /> classe GC|classe|[classe](../Topic/class%20\(C%23%20Reference\).md) palavra\-chave|  
|struct Value<br /><br /> \- ou \-<br /><br /> classe Value|struct|[struct](../Topic/struct%20\(C%23%20Reference\).md) palavra\-chave|  
