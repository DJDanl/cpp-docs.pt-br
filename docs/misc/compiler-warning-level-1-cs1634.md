...
Restauração ou desabilitação esperada  
 ...
 Esse erro ocorre se uma cláusula de aviso \#pragma está incorreta, como se, desabilitar ou restauração foi omitida. Para obter mais informações, consulte o [\#pragma aviso](../Topic/%23pragma%20warning%20\(C%23%20Reference\).md) tópico.  
