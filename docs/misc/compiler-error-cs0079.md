...
O evento 'event' só pode aparecer à esquerda de \+ \= ou \=  
 ...
 Um [evento](../Topic/event%20\(C%23%20Reference\).md) foi chamado incorretamente. Para obter mais informações, consulte [Eventos](../Topic/Events%20\(C%23%20Programming%20Guide\).md) e [Delegados](../Topic/Delegates%20\(C%23%20Programming%20Guide\).md).  
