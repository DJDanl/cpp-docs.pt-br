...
Membro 'member1' substitui o membro obsoleto ' membro2. Adicionar o obsoleto atributo 'member1'  
 ...
 O compilador encontrou um `override` para um método marcado como `obsolete`. No entanto, o método de substituição não foi marcado como obsoleto. Substituindo o método ainda irá gerar [CS0612](../Topic/Compiler%20Warning%20\(level%201\)%20CS0612.md), se a chamada.  
