...
Um tipo genérico é marcado como `<CLSCompliant(True)>`, mas uma restrição em um de seus parâmetros de tipo Especifica um tipo que está marcado como `<CLSCompliant(False)>`, não é marcada ou não se qualifica porque ele é um tipo incompatível.  
 ...
 O seguinte [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] tipos de dados não são compatíveis com CLS:  
  
-   [Tipo de dados SByte](../Topic/SByte%20Data%20Type%20\(Visual%20Basic\).md)  
  
-   [Tipo de dados UInteger](../Topic/UInteger%20Data%20Type.md)  
  
-   [Tipo de dados ULong](../Topic/ULong%20Data%20Type%20\(Visual%20Basic\).md)  
  
-   [Tipo de dados UShort](../Topic/UShort%20Data%20Type%20\(Visual%20Basic\).md)  
