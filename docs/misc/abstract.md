...
# __abstract
> [!NOTE]
>  Este tópico se aplica apenas a versão 1 de Managed Extensions for C\+\+. Esta sintaxe só deve ser usada para manter o código da versão 1. Consulte [abstract](../windows/abstract-cpp-component-extensions.md) para obter informações sobre como usar a funcionalidade equivalente na nova sintaxe.  
...
## Comentários  
 ...
 Diferente da noção de C\+\+ de um [abstrato](../cpp/abstract-classes-cpp.md) classe base, uma classe com o `__abstract` palavra\-chave pode definir as funções de membro.  
