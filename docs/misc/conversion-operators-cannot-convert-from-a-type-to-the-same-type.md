...
-   Se você precisar executar uma transformação no conteúdo do parâmetro, use um [Instrução Function](../Topic/Function%20Statement%20\(Visual%20Basic\).md) para definir uma `Function` procedimento em vez de um operador.  
