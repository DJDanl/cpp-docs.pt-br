...
Uma classe, estrutura ou interface declara uma propriedade padrão com o [Padrão](../Topic/Default%20\(Visual%20Basic\).md) palavra\-chave, mas também se aplica a <xref:System.Reflection.DefaultMemberAttribute> para designar um membro diferente como o membro padrão.  
...
## Consulte também  
 ...
 [Padrão](../Topic/Default%20\(Visual%20Basic\).md)   
