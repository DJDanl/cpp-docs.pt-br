...
'interface' já está listado na lista de interface  
 ...
 Uma lista de herança da interface inclui uma duplicata. Um [interface](../Topic/interface%20\(C%23%20Reference\).md) só pode ser especificada uma vez na lista de herança.  
