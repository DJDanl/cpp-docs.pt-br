...
Um [Instrução Imports \(tipo e namespace .NET\)](../Topic/Imports%20Statement%20\(.NET%20Namespace%20and%20Type\).md) Especifica um elemento de programação que não pode ser importado.  
