...
**MSB3121: O elemento de associação de arquivo no manifesto do aplicativo está faltando um ou mais dos seguintes atributos: extensão, descrição, progid ou ícone padrão.**  
 ...
 O [Manifesto de implantação do ClickOnce](../Topic/ClickOnce%20Deployment%20Manifest.md) deve conter valores para todos os quatro atributos.  
  
### Para corrigir este erro  
  
-   Defina cada [Manifesto de implantação do ClickOnce](../Topic/ClickOnce%20Deployment%20Manifest.md) de atributo para um valor válido.  
