...
Interfaces não podem conter construtores  
 ...
 Construtores não podem ser definidos para [interfaces](../Topic/interface%20\(C%23%20Reference\).md). Um método é considerado um construtor se ele tem o mesmo nome que a classe e nenhum tipo de retorno.  
