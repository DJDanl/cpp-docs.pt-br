...
Não é possível definir ou remover a definição símbolos de pré\-processamento após o primeiro token no arquivo  
 ...
 O `#define` e `#undef` [diretivas de pré\-processador](../Topic/C%23%20Preprocessor%20Directives.md) deve ser usado no início de um programa, antes de quaisquer outras palavras\-chave, como aqueles usados na declaração de namespace.  
