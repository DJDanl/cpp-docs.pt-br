...
Goto case só é válido dentro de uma instrução switch  
 ...
 Foi feita uma tentativa para usar [Alternar](../Topic/switch%20\(C%23%20Reference\).md) sintaxe fora de um **Alternar** instrução. Para obter mais informações, consulte [switch](../Topic/switch%20\(C%23%20Reference\).md).  
