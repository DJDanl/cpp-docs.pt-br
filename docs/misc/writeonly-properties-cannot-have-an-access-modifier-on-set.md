...
Um `WriteOnly` declaração de propriedade especifica os níveis de acesso em ambos os [Instrução Property](../Topic/Property%20Statement.md) e [Instrução Set](../Topic/Set%20Statement%20\(Visual%20Basic\).md).  
