...
Uma instrução de declaração utiliza uma [Operador New](../Topic/New%20Operator%20\(Visual%20Basic\).md) cláusula especificando um parâmetro de tipo como o tipo a ser criado e o parâmetro de tipo é declarado sem uma `New` restrição.  
