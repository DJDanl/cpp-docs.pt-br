...
'declaração de ': declaração de interface explícita só pode ser declarada em uma classe ou struct  
 ...
 Explícito [interface](../Topic/interface%20\(C%23%20Reference\).md) declaração foi encontrada fora de um [classe](../Topic/class%20\(C%23%20Reference\).md) ou [struct](../Topic/struct%20\(C%23%20Reference\).md).  
