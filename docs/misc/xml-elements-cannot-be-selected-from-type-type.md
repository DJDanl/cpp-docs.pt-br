...
Um elemento filho XML foi referenciado para um objeto que não é do tipo <xref:System.Xml.Linq.XElement>, <xref:System.Xml.Linq.XDocument>, ou `IEnumerable(Of XElement)`. Para obter mais informações, consulte [Propriedade do eixo filho XML](../Topic/XML%20Child%20Axis%20Property%20\(Visual%20Basic\).md).  
...
## Consulte também  
 [Propriedade do eixo filho XML](../Topic/XML%20Child%20Axis%20Property%20\(Visual%20Basic\).md)   
