...
O tipo 'type' na lista de interface não é uma interface  
 ...
 É possível que um [struct](../Topic/struct%20\(C%23%20Reference\).md) ou [interface](../Topic/interface%20\(C%23%20Reference\).md) para herdar de outra interface, mas não de qualquer outro tipo.  
