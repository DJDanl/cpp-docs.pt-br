...
O lado esquerdo de uma atribuição deve ser uma variável, propriedade ou indexador  
 ...
 Para corrigir esse erro, certifique\-se de que todos os operadores estão no lado direito e que o lado esquerdo é uma variável, propriedade ou indexador. Para obter mais informações, consulte [Instruções, expressões e operadores](../Topic/Statements,%20Expressions,%20and%20Operators%20\(C%23%20Programming%20Guide\).md).  
