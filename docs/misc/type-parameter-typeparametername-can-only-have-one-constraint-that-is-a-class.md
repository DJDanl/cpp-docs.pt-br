...
Uma lista de restrição inclui mais de uma classe.  
 ...
 Uma lista de restrição em um parâmetro de tipo pode aceitar qualquer número de interfaces, mas no máximo uma classe. Um argumento de tipo fornecido para esse parâmetro de tipo deve herdar da classe, e [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] não oferece suporte a várias heranças.  
