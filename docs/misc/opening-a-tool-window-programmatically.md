...
1.  Crie o painel de janela de ferramenta, quadro e o VSPackage que implementá\-las. Para obter mais informações, consulte [Adicionar uma janela de ferramentas](../Topic/Adding%20a%20Tool%20Window.md).  
...
2.  Adicionar o <xref:Microsoft.VisualStudio.Shell.ProvideToolWindowAttribute> para o VSPackage que fornece a ele.  
    ...
    ```  
     ...
     Esse registros a janela da ferramenta PersistedWindowPane para ser aberto como encaixada **Solution Explorer**. Para obter mais informações, consulte [Registrando uma janela de ferramentas](../Topic/Registering%20a%20Tool%20Window.md).  
