...
Uma classe é definida em dois ou mais declarações parciais, que contêm mais de um [Instrução Inherits](../Topic/Inherits%20Statement.md) especificando mais de uma classe base.  
