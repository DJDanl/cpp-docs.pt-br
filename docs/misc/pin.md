...
---
# __pin
**Observação** neste tópico se aplica somente à versão 1 de Managed Extensions for C\+\+. Esta sintaxe só deve ser usada para manter o código da versão 1. Consulte [pin\_ptr \(C\+\+\/CLI\)](../Topic/pin_ptr%20\(C++-CLI\).md) para obter informações sobre como usar a funcionalidade equivalente na nova sintaxe.  
