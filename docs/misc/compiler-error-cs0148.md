...
O delegado 'delegate' não tem um construtor válido  
 ...
 Importado e usado um programa gerenciado \(um que usa o .NET Framework common language runtime\) que foi criado com outro compilador. Esse compilador permitido um malformados [Delegar](../Topic/delegate%20\(C%23%20Reference\).md) construtor. Para obter mais informações, consulte [Delegados](../Topic/Delegates%20\(C%23%20Programming%20Guide\).md).