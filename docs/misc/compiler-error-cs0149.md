...
Nome de método esperado  
 ...
 Ao criar um [Delegar](../Topic/delegate%20\(C%23%20Reference\).md), especificar um método. Para obter mais informações, consulte [Delegados](../Topic/Delegates%20\(C%23%20Programming%20Guide\).md).  
