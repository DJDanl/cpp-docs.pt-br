...
> [!NOTE]
>  No c\# 2.0, o compilador gerará automaticamente atual e MoveNext para você. Para obter mais informações, consulte o exemplo de código [Interfaces genéricas](../Topic/Generic%20Interfaces%20\(C%23%20Programming%20Guide\).md).  
