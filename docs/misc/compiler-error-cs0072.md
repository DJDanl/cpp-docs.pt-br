...
'event': não é possível substituir; 'method' não é um evento  
 ...
 Um [evento](../Topic/event%20\(C%23%20Reference\).md) somente pode substituir outro evento. Para obter mais informações, consulte [Eventos](../Topic/Events%20\(C%23%20Programming%20Guide\).md).  
