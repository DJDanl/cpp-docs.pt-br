...
Este tópico foi consolidado com outros tipos de conteúdo.  Vá para [Gerando código a partir de uma linguagem específica do domínio](../Topic/Generating%20Code%20from%20a%20Domain-Specific%20Language.md).