...
Uso da palavra\-chave 'base' não é válido neste contexto  
 ...
 O [base](../Topic/base%20\(C%23%20Reference\).md) palavra\-chave deve ser usada para especificar um determinado membro da classe base. Para obter mais informações, consulte [Construtores](../Topic/Constructors%20\(C%23%20Programming%20Guide\).md).  
