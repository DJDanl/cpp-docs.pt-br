...
-   O argumento de tipo deve herdar de no máximo uma classe  
 ...
 Você pode combinar os requisitos acima para um parâmetro de tipo único.[!INCLUDE[vbprvb](../Token/vbprvb_md.md)] não é possível construir o tipo, a menos que o código fornece argumentos de tipo que atendem a cada restrição em cada parâmetro de tipo definido no tipo genérico.  
