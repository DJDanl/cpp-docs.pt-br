...
'type' não é um tipo de referência necessária à instrução lock  
 ...
 O [bloqueio](../Topic/lock%20Statement%20\(C%23%20Reference\).md) instrução só pode avaliar os tipos de referência. Para obter mais informações, consulte [Sincronização de thread](../Topic/Thread%20Synchronization%20\(C%23%20and%20Visual%20Basic\).md) e [Tipos de referência](../Topic/Reference%20Types%20\(C%23%20Reference\).md).  
