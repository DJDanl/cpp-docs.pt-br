...
O rótulo 'Rótulo' já está nesta instrução switch  
 ...
 Um rótulo foi repetido em um [Alternar](../Topic/switch%20\(C%23%20Reference\).md) instrução. Para obter mais informações, consulte [switch](../Topic/switch%20\(C%23%20Reference\).md).  
