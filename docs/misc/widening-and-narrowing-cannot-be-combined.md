...
Um [Instrução Operator](../Topic/Operator%20Statement.md) especifica ambos [Widening](../Topic/Widening%20\(Visual%20Basic\).md) e [Narrowing](../Topic/Narrowing%20\(Visual%20Basic\).md).  
