...
Esperado; ou \= \(não é possível especificar argumentos de construtor na declaração\)  
 ...
 Uma referência a uma classe foi formada como se um objeto para a classe que está sendo criado. Por exemplo, houve uma tentativa para passar uma variável para um construtor. Use o [novo](../Topic/new%20\(C%23%20Reference\).md) operador para criar um objeto de uma classe.  
