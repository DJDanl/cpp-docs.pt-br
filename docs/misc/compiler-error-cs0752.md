...
Um método parcial não pode ter parâmetros out  
 ...
 Um método parcial não pode ter um [out](../Topic/out%20\(C%23%20Reference\).md) parâmetro. Parâmetros de saída não são permitidas porque se o método parcial é removido pelo compilador, não há nenhuma garantia de que o parâmetro de saída é atribuído.  
...
## Consulte também  
 [Classes e métodos partial](../Topic/Partial%20Classes%20and%20Methods%20\(C%23%20Programming%20Guide\).md)