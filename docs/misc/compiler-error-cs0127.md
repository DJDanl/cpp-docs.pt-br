...
Como 'function' retorna void, uma palavra\-chave return não deve ser seguida por uma expressão de objeto  
 ...
 Um método com um [void](../Topic/void%20\(C%23%20Reference\).md) tipo não pode retornar um valor de retorno. Para obter mais informações, consulte [Métodos](../Topic/Methods%20\(C%23%20Programming%20Guide\).md).  
