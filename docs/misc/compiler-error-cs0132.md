...
'construtor': um construtor estático não deve ter parâmetro  
 ...
 Um [estático](../Topic/static%20\(C%23%20Reference\).md) construtor não pode ser declarado com um ou mais parâmetros. Para obter mais informações, consulte [Construtores](../Topic/Constructors%20\(C%23%20Programming%20Guide\).md).  
