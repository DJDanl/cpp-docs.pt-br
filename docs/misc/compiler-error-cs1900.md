...
Nível de aviso deve estar no intervalo de 0 a 4  
 ...
 O [\/ Avisar](../Topic/-warn%20\(C%23%20Compiler%20Options\).md) opção de compilador só pode ter um dos cinco valores possíveis \(0, 1, 2, 3 ou 4\). Qualquer outro valor passado para **\/warn** resultará em CS1900.  
