...
O parâmetro params não pode ser declarado como ref ou out  
 ...
 As palavras\-chave [ref](../Topic/ref%20\(C%23%20Reference\).md) ou [out](../Topic/out%20\(C%23%20Reference\).md) não pode ser usado com o [params](../Topic/params%20\(C%23%20Reference\).md) palavra\-chave.  
