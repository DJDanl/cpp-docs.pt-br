...
Um procedimento em uma classe derivada substitui um procedimento com o mesmo nome na classe base, mas as listas de parâmetros são diferentes.  
 ...
 Para substituir um procedimento em uma classe herdada, o procedimento de substituição deve corresponder sua lista de parâmetros, o acesso de nível e tipo de retorno \(se houver\). Em particular, ele deve corresponder a qualquer [Opcional](../Topic/Optional%20\(Visual%20Basic\).md) ou [ParamArray](../Topic/ParamArray%20\(Visual%20Basic\).md) declaração.  
...
-   Se você quiser uma lista de parâmetros diferente da versão da classe base, você não pode substituí\-la. Considere a sobrecarga em vez disso. Para obter mais informações, consulte [Sobrecarga de procedimento](../Topic/Procedure%20Overloading%20\(Visual%20Basic\).md).  
  
## Consulte também  
 [Substituições](../Topic/Overrides%20\(Visual%20Basic\).md)   
