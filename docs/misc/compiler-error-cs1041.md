...
Identificador esperado 'palavra\-chave' é uma palavra\-chave  
 ...
 Uma palavra reservada para a linguagem c\# foi encontrada onde era esperado um identificador. Substitua o [palavra\-chave](../Topic/C%23%20Keywords.md) com um identificador especificado pelo usuário.  
