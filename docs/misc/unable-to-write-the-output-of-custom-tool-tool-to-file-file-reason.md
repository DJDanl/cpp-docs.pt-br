...
-   Reiniciar [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] e execute novamente a ferramenta personalizada clicando duas vezes o arquivo afetado e selecionando **Executar ferramenta personalizada** no menu de atalho.  
