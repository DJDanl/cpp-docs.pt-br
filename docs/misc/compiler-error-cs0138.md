...
Uso de uma diretiva de namespace só pode ser aplicada a namespaces. 'type' é um tipo não é um namespace  
 ...
 Um [usando](../Topic/using%20\(C%23%20Reference\).md) diretiva só pode ter o nome de um namespace como um parâmetro. Para obter mais informações, consulte [Namespaces](../Topic/Namespaces%20\(C%23%20Programming%20Guide\).md).  
