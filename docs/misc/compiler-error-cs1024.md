...
Diretiva de pré\-processamento esperada  
 ...
 Início de uma linha com o símbolo de sustenido \(\#\), mas a cadeia de caracteres subseqüente não era válido [diretiva de pré\-processador](../Topic/C%23%20Preprocessor%20Directives.md).  
