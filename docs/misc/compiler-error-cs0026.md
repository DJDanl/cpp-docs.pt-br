...
Palavra\-chave 'this' não é válida em uma propriedade estática, um método estático ou um inicializador de campo estático  
 ...
 O [this](../Topic/this%20\(C%23%20Reference\).md) palavra\-chave se refere a um objeto, que é uma instância de um tipo. Como os métodos estáticos são independentes de qualquer instância da classe recipiente, a palavra\-chave "this" não faz sentida e, portanto, não é permitida. Para obter mais informações, consulte [Classes static e membros de classes static](../Topic/Static%20Classes%20and%20Static%20Class%20Members%20\(C%23%20Programming%20Guide\).md) e [Objetos](../Topic/Objects%20\(C%23%20Programming%20Guide\).md).  
