---
title: "CS0193 de erro do compilador | Microsoft Docs"
ms.custom: ""
ms.date: "11/17/2016"
...
manager: "wpickett"
---
# CS0193 de erro do compilador
O \* ou \-\> operador deve ser aplicado a um ponteiro  
  
 O **\*** ou **\-\>** operador foi usado com um tipo de nonpointer. Para obter mais informações, consulte [Tipos de ponteiro](../Topic/Pointer%20types%20\(C%23%20Programming%20Guide\).md).  
