...
O diretório não foi encontrado.  
 ...
 Esse aviso pode ocorrer se você estiver usando a propriedade de **CodeAnalysisDependentAssemblyPaths** de [!INCLUDE[vstecmsbuild](../build/includes/vstecmsbuild_md.md)] para especificar caminhos de busca adicionais do assembly de referência e um desses caminhos não existe.  
  
-   Se CA0067 de aviso é exibida com os erros de [CA0058](../misc/ca0058.md) ou avisos de [CA0060](../Topic/CA0060.md) , resolvendo os outros erros geralmente resolve CA0067.  
