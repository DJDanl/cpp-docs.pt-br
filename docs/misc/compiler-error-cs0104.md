---
title: "CS0104 de erro do compilador | Microsoft Docs"
ms.custom: ""
ms.date: "11/17/2016"
...
manager: "wpickett"
---
# CS0104 de erro do compilador
'referência' é uma referência ambígua entre 'identifier' e 'Identificador'  
  
 Contém o programa [usando](../Topic/using%20\(C%23%20Reference\).md) diretivas para dois namespaces e seu código referencia um nome que aparece nos dois namespaces.  
