...
Comentário XML em 'member' tem atributo cref sintaticamente incorreto 'invalid\_syntax'  
 ...
 Um dos parâmetros passados para uma marca para comentários de documentação tem sintaxe inválida. Para obter mais informações, consulte [Marcas recomendadas para comentários de documentação](../Topic/Recommended%20Tags%20for%20Documentation%20Comments%20\(C%23%20Programming%20Guide\).md).  
