...
Método deve ter um tipo de retorno  
 ...
 Um método que é declarado em uma classe, estrutura ou interface deve ter um tipo de retorno explícito. No exemplo a seguir, o método quadrado tem um valor de retorno [seqüência](../Topic/string%20\(C%23%20Reference\).md):  
...
## Consulte também  
 ...
 [Construtores](../Topic/Constructors%20\(C%23%20Programming%20Guide\).md)