...
Inicializadores de objeto não podem ser usados para inicializar qualquer membro de uma classe é declarada como compartilhada. Para obter mais informações, consulte [Compartilhado](../Topic/Shared%20\(Visual%20Basic\).md).  
