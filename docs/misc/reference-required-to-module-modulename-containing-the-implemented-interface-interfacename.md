...
Referência necessária para o módulo '\< modulename \>' que contém a interface implementada '\< interfacename \>'. Adicione uma ao seu projeto.  
 ...
 A interface é definida em um módulo que não é referenciado diretamente em seu projeto. O [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] compilador requer uma referência para evitar ambigüidade, caso a interface é definida em mais de um módulo.  
