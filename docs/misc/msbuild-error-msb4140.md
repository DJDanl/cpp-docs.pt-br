...
**MSB4140: ToolsVersion padrão é especificado ou no Registro ou no arquivo de configuração.**  
 ...
 O projeto não especificar um valor padrão de `ToolsVersion` .  Portanto, [!INCLUDE[vstecmsbuild](../build/includes/vstecmsbuild_md.md)] não souber valor a ser usado.  
