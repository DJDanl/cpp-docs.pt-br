---
title: "Infelizmente, n&#227;o h&#225; informa&#231;&#245;es espec&#237;ficas sobre este erro do Visual Basic | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
manager: "wpickett"
---
# Infelizmente, n&#227;o h&#225; informa&#231;&#245;es espec&#237;ficas sobre este erro do Visual Basic
Desculpe, mas não temos informações específicas sobre este erro. Você pode procurar o texto de mensagem e um número de erro localizar informações na web. Ou, você pode solicitar outros desenvolvedores usando um destes fóruns:  
  
 [Linguagem Visual Basic](http://go.microsoft.com/fwlink/?LinkId=145963)  
 Fornece um fórum para perguntas e discussões gerais sobre do [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] sintaxe de linguagem e compilador.  
  
 [Atualização e interoperabilidade do Visual Basic](http://go.microsoft.com/fwlink/?LinkId=145966)  
 Fornece um fórum para perguntas sobre e problemas com a atualização para [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] e trabalhar com os recursos de interoperabilidade.  
  
 [IDE do Visual Basic](http://go.microsoft.com/fwlink/?LinkId=145971)  
 Fornece um fórum para perguntas sobre como trabalhar no [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] ambiente.  
  
 [Visual Basic\-geral](http://go.microsoft.com/fwlink/?LinkId=145973)  
 Fornece um fórum para perguntas sobre e problemas com [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] que não são discutidas em outros fóruns.  
  
 [StackOverflow](http://stackoverflow.com/questions/tagged/vb.net)  
 Fornece um fórum para perguntas sobre e problemas com [!INCLUDE[vbprvb](../Token/vbprvb_md.md)].  
  
 Consulte também:  
 [Recursos adicionais para programadores do Visual Basic](../Topic/Additional%20Resources%20for%20Visual%20Basic%20Programmers.md)  
  
## Consulte também  
 [Guia de programação do Visual Basic](../Topic/Visual%20Basic%20Programming%20Guide.md)   
 [Referência do Visual Basic](../Topic/Reference%20\(Visual%20Basic\).md)