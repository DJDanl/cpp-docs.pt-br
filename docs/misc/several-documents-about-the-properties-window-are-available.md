...
[!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)]Ajuda contém os seguintes documentos sobre o  **Propriedades** janela mas não pode determinar qual deles melhor se aplica à sua solicitação de Ajuda. Selecione o documento que melhor corresponde à tarefa que você está tentando realizar.  
...
|[Referência da interface do usuário do Designer de Projeto](../Topic/Project%20Properties%20Reference.md)|Fornece links para tópicos sobre  **Project Designer** páginas.|  
...
|[Janela Propriedades](../Topic/Properties%20Window.md)|Descreve o  **Propriedades** janela, que você pode usar para alterar as propriedades de tempo de design, propriedades do projeto e propriedades de solução.|