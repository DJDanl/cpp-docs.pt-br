...
2.  Se o erro persistir, salve seu trabalho e reinicie o [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)].  
  
3.  Se o erro persistir, reinstale [!INCLUDE[vbprvb](../Token/vbprvb_md.md)].  
