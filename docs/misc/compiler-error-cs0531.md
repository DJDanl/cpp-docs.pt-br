---
title: "CS0531 de erro do compilador | Microsoft Docs"
ms.custom: ""
ms.date: "11/17/2016"
...
manager: "wpickett"
---
# CS0531 de erro do compilador
'member': membros de interface não podem ter uma definição  
  
 Métodos que são declarados em um [interface](../Topic/interface%20\(C%23%20Reference\).md) devem ser implementados em uma classe que herda dela e não na própria interface.  
