...
Não use 'ParamArrayAttribute'. Use a palavra\-chave 'params'.  
 ...
 O compilador c\# não permite o uso de <xref:System.ParamArrayAttribute?displayProperty=fullName>; use [params](../Topic/params%20\(C%23%20Reference\).md) em vez disso.  
