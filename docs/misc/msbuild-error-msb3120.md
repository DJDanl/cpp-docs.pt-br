...
-   Definir o [Manifesto de implantação do ClickOnce](../Topic/ClickOnce%20Deployment%20Manifest.md)`extension` de atributo para um valor que não tem mais caracteres do que o limite permitido para o sistema operacional de destino.  
