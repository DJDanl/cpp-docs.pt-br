...
Não é possível obter o endereço da expressão especificada  
 ...
 Você pode obter o endereço de campos, variáveis locais e indireção de ponteiros, mas você não pode obter, por exemplo, o endereço da soma das duas variáveis locais. Para obter mais informações, consulte [Código não seguro e ponteiros](../Topic/Unsafe%20Code%20and%20Pointers%20\(C%23%20Programming%20Guide\).md).  
