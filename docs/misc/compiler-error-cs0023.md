...
Operador 'operator' não pode ser aplicado a operando do tipo 'type'  
 ...
 Foi feita uma tentativa de aplicar um operador a uma variável cujo tipo não foi projetado para trabalhar com o operador. Para obter mais informações, consulte [Tipos](../Topic/Types%20\(C%23%20Programming%20Guide\).md) e [Operadores em C\#](../Topic/C%23%20Operators.md).  
