...
Não é possível definir métodos sobrecarregados que diferem somente em ref e out.  
 ...
 Métodos que diferem apenas em termos de uso [ref](../Topic/ref%20\(C%23%20Reference\).md) e [out](../Topic/out%20\(C%23%20Reference\).md) em um parâmetro não são permitidos.  
