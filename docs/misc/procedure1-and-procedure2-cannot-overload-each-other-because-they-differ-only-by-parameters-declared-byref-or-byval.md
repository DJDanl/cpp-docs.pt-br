...
'\< procedure1 \>' e '\< procedure2 \>' não pode sobrecarregar porque diferem somente pelos parâmetros declarados ByRef nem ByVal. Sombras assumidas.  
 ...
 Essa mensagem é um aviso.`Shadows` será considerado por padrão. Para obter informações sobre como ocultar avisos ou tratar avisos como erros, consulte [Configurando avisos no Visual Basic](../Topic/Configuring%20Warnings%20in%20Visual%20Basic.md).  
