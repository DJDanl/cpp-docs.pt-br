...
## Consulte também  
 [Caixa de diálogo Configurações de Compilador Avançadas \(Visual Basic\)](../Topic/Advanced%20Compiler%20Settings%20Dialog%20Box%20\(Visual%20Basic\).md)   
 [Página de Compilação, Designer de Projeto \(C\#\)](../Topic/Build%20Page,%20Project%20Designer%20\(C%23\).md)