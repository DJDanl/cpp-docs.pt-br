...
Um parâmetro params deve ser o último parâmetro em uma lista de parâmetros formais.  
 ...
 O [params](../Topic/params%20\(C%23%20Reference\).md) parâmetro oferece suporte a um número variável de argumentos e deve ser após todos os outros parâmetros. Para obter mais informações, consulte [Métodos](../Topic/Methods%20\(C%23%20Programming%20Guide\).md).  
