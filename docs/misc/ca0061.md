...
## Propriedade de CodeAnalysisRules MSBuild  
 Na análise de código de [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)], as regras podem ser especificadas usando a propriedade de CodeAnalysisRules de MSBuild com o seguinte formato:  
