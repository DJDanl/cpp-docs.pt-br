---
title: "CS0544 de erro do compilador | Microsoft Docs"
ms.custom: ""
ms.date: "11/16/2016"
...
manager: "wpickett"
---
# CS0544 de erro do compilador
'substituição de propriedade ': não é possível substituir porque 'não property' não é uma propriedade  
  
 Foi feita uma tentativa para substituir um tipo de dados nonproperty uma [propriedade](../Topic/Properties%20\(C%23%20Programming%20Guide\).md), que não é permitido.  
