...
Um literal XML ou propriedade de eixo XML foi referenciada no **inspeção** ou **imediato** durante uma sessão de depuração XML em [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] recursos não estão disponíveis. Esse é o caso para um assembly que não usa o XML no [!INCLUDE[vbprvb](../Token/vbprvb_md.md)] recursos ou é uma criação de versão.  
...
## Consulte também  
 [Depurando o aplicativo do Visual Basic](../Topic/Debugging%20Your%20Visual%20Basic%20Application.md)   
