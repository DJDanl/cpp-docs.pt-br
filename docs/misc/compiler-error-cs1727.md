...
Não é possível enviar o relatório de erros automaticamente sem autorização. Visite ' para autorizar o envio de relatório de erros.  
 ...
 O site listado na mensagem de erro explica como habilitar o relatório de erros automático [!INCLUDE[vsprvslong](../error-messages/compiler-errors-1/includes/vsprvslong_md.md)] Ferramentas de linha de comando.  
