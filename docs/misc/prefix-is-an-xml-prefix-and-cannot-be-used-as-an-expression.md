...
## Consulte também  
 ...
 [Instrução Imports \(namespace XML\)](../Topic/Imports%20Statement%20\(XML%20Namespace\).md)   
 [Operador GetXmlNamespace](../Topic/GetXmlNamespace%20Operator%20\(Visual%20Basic\).md)   
