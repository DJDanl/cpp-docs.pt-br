...
Palavra\-chave 'base' não está disponível em um método estático  
 ...
 O [base](../Topic/base%20\(C%23%20Reference\).md) palavra\-chave foi usada uma [estático](../Topic/static%20\(C%23%20Reference\).md) método.`base` só pode ser chamado em um construtor de instância, o método de instância ou o acessador de instância.  
