...
Não são permitidos especificadores de parâmetro padrão  
 ...
 [Parâmetros de método](../Topic/Method%20Parameters%20\(C%23%20Reference\).md) não podem ter valores padrão. Use sobrecargas do método para obter o mesmo efeito. Para obter mais informações, consulte [Passando parâmetros](../Topic/Passing%20Parameters%20\(C%23%20Programming%20Guide\).md).  
