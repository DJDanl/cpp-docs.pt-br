...
Falha na inicialização de uma classe. Uma causa possível é danificado [!INCLUDE[dnprdnshort](../Token/dnprdnshort_md.md)] instalação.  
...
2.  Reinstale o [!INCLUDE[dnprdnshort](../Token/dnprdnshort_md.md)] e recompilar o programa.  
