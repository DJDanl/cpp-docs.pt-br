...
Quando o upload e download de arquivos com o [Objeto My.Computer.Network](../Topic/My.Computer.Network%20Object.md), você deve especificar um `connectionTimeout` maior que `0`.  
