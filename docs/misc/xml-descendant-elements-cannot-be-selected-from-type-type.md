...
Um descendente XML foi referenciado por um objeto que não é do tipo <xref:System.Xml.Linq.XElement>, <xref:System.Xml.Linq.XDocument>, ou `IEnumerable(Of XElement)`. Para obter mais informações, consulte [Propriedade de eixo descendente XML](../Topic/XML%20Descendant%20Axis%20Property%20\(Visual%20Basic\).md).  
...
## Consulte também  
 [Propriedade de eixo descendente XML](../Topic/XML%20Descendant%20Axis%20Property%20\(Visual%20Basic\).md)   
 [Propriedades do eixo XML](../Topic/XML%20Axis%20Properties%20\(Visual%20Basic\).md)   
