...
Acessibilidade inconsistente: tipo de parâmetro 'type' é menos acessível que delegar 'representante'  
 ...
 O tipo de retorno e cada um dos tipos referenciados na lista de parâmetros formais de um método devem ser pelo menos tão acessíveis quanto o método em si. Para obter mais informações, consulte [Modificadores de acesso](../Topic/Access%20Modifiers%20\(C%23%20Programming%20Guide\).md).  
