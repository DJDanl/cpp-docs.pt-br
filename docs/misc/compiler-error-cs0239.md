...
'member': não é possível substituir o membro herdado 'membro herdado' porque ele é sealed  
 ...
 Não é um membro [substituir](../Topic/override%20\(C%23%20Reference\).md) um [lacrado](../Topic/sealed%20\(C%23%20Reference\).md) membro herdado. Para obter mais informações, consulte [Contexto verificado e não verificado](../Topic/Checked%20and%20Unchecked%20\(C%23%20Reference\).md).  
