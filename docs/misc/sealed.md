...
# __sealed
> [!NOTE]
>  Este tópico se aplica apenas a versão 1 de Managed Extensions for C\+\+. Esta sintaxe só deve ser usada para manter o código da versão 1. Consulte [sealed](../windows/sealed-cpp-component-extensions.md) para obter informações sobre como usar a funcionalidade equivalente na nova sintaxe.  
...
-   O **sealed** palavra\-chave não é permitida quando usada com a [interface](../Topic/__interface.md) palavra\-chave.  
