...
Um objeto de tipo conversível em 'type' é necessário  
 ...
 Uma instrução de retorno está presente, mas a instrução não retorna um valor do tipo esperado. Para obter mais informações, consulte [Propriedades](../Topic/Properties%20\(C%23%20Programming%20Guide\).md).  
