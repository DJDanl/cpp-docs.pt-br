...
Uma classe ou interface inclui um [Instrução Inherits](../Topic/Inherits%20Statement.md) especificando um parâmetro de tipo genérico.  
...
-   Se o tipo base deve ser representado por um parâmetro de tipo genérico, nenhum outro tipo pode herdar dele. Remover o [Instrução Inherits](../Topic/Inherits%20Statement.md).  
