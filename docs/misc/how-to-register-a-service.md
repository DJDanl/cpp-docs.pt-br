...
A estrutura de pacote gerenciado \(MPF\) fornece atributos para controlar o registro de serviços gerenciados. O utilitário RegPkg usa esses atributos para registrar o serviço com [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)].  
...
## Exemplo  
 ...
 O <xref:Microsoft.VisualStudio.Shell.ProvideServiceAttribute> registra o serviço SMyGlobalService com [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)]. Para obter mais informações sobre <xref:Microsoft.VisualStudio.Shell.DefaultRegistryRootAttribute> e <xref:Microsoft.VisualStudio.Shell.PackageRegistrationAttribute>, consulte [VSPackages registrar e cancelar o registro](../Topic/Registering%20and%20Unregistering%20VSPackages.md).  
