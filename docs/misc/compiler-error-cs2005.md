...
Especificação de arquivo ausente para a opção 'option'  
 ...
 Um [opção de compilador](../Topic/C%23%20Compiler%20Options.md) apenas parcialmente foi especificado.  
  
 Por exemplo, ao usar [\/recurse](../Topic/-recurse%20\(C%23%20Compiler%20Options\).md), você deve especificar o arquivo a ser pesquisado: **\/recurse:***filename***. CS**.  
