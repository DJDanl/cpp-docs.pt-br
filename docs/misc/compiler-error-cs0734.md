...
A opção \/moduleassemblyname só pode ser especificada ao criar um tipo de destino de 'module'  
 ...
 A opção de compilador **\/moduleassemblyname** só deve ser usado ao criar um. netmodule. Consulte [\/moduleassemblyname \(Specify Friend Assembly for Module\)](../Topic/-moduleassemblyname%20\(C%23%20Compiler%20Option\).md) para obter mais informações.  
