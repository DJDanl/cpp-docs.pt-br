...
Um [Instrução Dim](../Topic/Dim%20Statement%20\(Visual%20Basic\).md) usa um [Operador New](../Topic/New%20Operator%20\(Visual%20Basic\).md) cláusula ao declarar uma variável de um tipo de interface.  
