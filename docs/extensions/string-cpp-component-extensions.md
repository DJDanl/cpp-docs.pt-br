...
- {1&gt;Tratamento de exceções&lt;1}. Quando um literal de cadeia de caracteres é lançado, o compilador o captura como um literal de cadeia de caracteres.
