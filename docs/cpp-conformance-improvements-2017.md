...
No Visual Studio 2017 versão 15.9, no modo **/permissive-**, o compilador gera C3861: *'from_template': identificador não encontrado*.d

Para corrigir o erro, declare `a` antes de `A`.
