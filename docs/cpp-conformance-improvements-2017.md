...
**static_assert concisa** (disponível com **/std:c++17**)  
No C++ 17, o parâmetro de mensagem para static_assert é opcional. Para obter mais informações, consulte [Extending static_assert, v2 (Estendendo static_assert, v2)](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2014/n3928.pdf).

**Atributo [[fallthrough]]** (disponível com **/std:c++17**)  
O atributo [[fallthrough]] pode ser usado no contexto de instruções switch como uma dica para o compilador de que o comportamento de fall-through é intencional. Isso impede o compilador de emitir avisos em tais casos. Para obter mais informações, consulte [Wording for [[fallthrough]] attribute (Expressão para atributo [[fallthrough]])](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0188r0.pdf).

**Baseada em intervalo generalizado para loops** (sem opção de compilador necessária)  
...
**Usando namespaces de atributo sem repetição**  
Nova sintaxe para permitir apenas um único identificador de namespace em uma lista de atributos. Para saber mais, veja [Atributos em C++](cpp/attributes2.md).
...
**Regras de construção para valores de classe de enumeração**  
...
**Removendo a palavra-chave "register" preterida**  
...
**Nova opção de compilador do constexpr externo**  
...
**Removendo Especificações de Exceção Dinâmica**  
...
**Reescrevendo enable_shared_from_this**  
...
**Preterindo partes residuais da biblioteca**  
...
**Removendo o suporte ao alocador em std::function**  
...
**Corrigindo shared_ptr para matrizes**  
...
**Esclarecendo insert_return_type**  
...
**Variáveis embutidas para a STL**  
