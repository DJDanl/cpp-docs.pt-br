...
|[Cadeia de caracteres:: GetHashCode](#gethashcode)|Retorna o código hash para essa instância.|
...
Método estático que compara dois objetos `String` avaliando os valores numéricos dos caracteres correspondentes nos dois valores de cadeia de caracteres representados pelos objetos.
...
## <a name="data"></a>Cadeia de caracteres::D método do ATA
...
Use este método para converter de `Platform::String^` em `wchar_t*`. Quando o objeto `String` sai do escopo, não há mais garantia de que ponteiro Dados seja válido. Para armazenar os dados além do tempo de vida do objeto `String` original, use [wcscpy_s](../c-runtime-library/reference/strcpy-s-wcscpy-s-mbscpy-s.md) para copiar a matriz na memória que você mesmo alocou.

## <a name="dispose"></a>Cadeia de caracteres::D método ispose
...
**true** se o objeto de `String` atual for **nulo** ou a cadeia de caracteres vazia (L ""); caso contrário, **false**.
...
**true** se o objeto de `String` atual for rápido; caso contrário, **false**.
...
Recupera o número de caracteres no objeto de `String` atual.
...
O número de caracteres no objeto de `String` atual.
...
##  <a name="operator-equality"></a>Operador String:: Operator = =
...
##  <a name="operator-greater-than"></a>Cadeia de caracteres:: operador &gt;

Indica se o valor de um objeto de `String` é maior que o valor de um segundo objeto de `String`.
...
Indica se o valor de um objeto de `String` é maior ou igual ao valor de um segundo objeto de `String`.
...
## <a name="operator-inequality"></a>Cadeia de caracteres:: operador! =

Indica se dois objetos de `String` especificados têm valores diferentes.
...
## <a name="operator-less-than"></a>Cadeia de caracteres:: operador &lt;
...
Inicializa uma nova instância da classe `String` com uma cópia dos dados da cadeia de caracteres de entrada.
...
## <a name="tostring"></a>Cadeia de caracteres:: ToString

Retorna um objeto `String` cujo valor é igual à cadeia de caracteres atual.
...
Um objeto `String` cujo valor é igual à cadeia de caracteres atual.
