...
>>>>>>> master
 ...
 O exemplo extraído de um trecho de código no [fórum sobre a compilação de aplicativos da Windows Store](http://social.msdn.microsoft.com/Forums/winappswithnativecode/thread/211ef583-db11-4e55-926b-6d9ab53dbdb4). O autor desse trecho de código oferece os seguintes avisos de isenção de responsabilidade e estipulações:  
...
2.  Após a compilação do código, você também precisará passar Runtimeobject.lib e Rometadata.lib ao Vinculador.  
  
3.  Este trecho é apresentado no estado em que se encontra. Embora seja esperado que funcione corretamente, ele pode conter erros.  
