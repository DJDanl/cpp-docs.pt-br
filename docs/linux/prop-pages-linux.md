---
title: Páginas de propriedades do projeto do Linux | Microsoft Docs
ms.custom: ''
ms.date: 10/26/2017
ms.technology:
- cpp-linux
...
---
# <a name="linux-project-property-page-reference"></a>Referência de página de propriedades do projeto do Linux

Esta seção contém o conteúdo de referência para as páginas de propriedades em um projeto do Linux do Visual C++.
