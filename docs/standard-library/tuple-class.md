...
*À esquerda*\
Uma tupla cujos elementos deverão ser trocados por aqueles da tupla *certa*.

*Certo*\
Uma tupla cujos elementos deverão ser trocados por aqueles da tupla *esquerdo*.
