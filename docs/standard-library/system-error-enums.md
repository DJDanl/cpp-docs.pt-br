...
|||  
|-|-|  
|[Enumeração errc](#errc_enumeration)|[Enumeração io_errc](#io_errc_enumeration)|  
  
##  <a name="errc_enumeration"></a>  Enumeração errc  
...
##  <a name="io_errc_enumeration"></a>  Enumeração io_errc  
 Fornece nomes simbólicos para as condições de erro em \<iostream>. Pode ser usado para criar objetos [error_condition](../standard-library/error-condition-class.md) a serem comparados com o valor retornado pela função [ios_base::failure](../standard-library/ios-base-class.md#ios_base__failure)`code()`.  
