...
ms.locfileid: "87232827"
---
# <a name="ltvariantgt-functions"></a>&lt;funções de variante &gt;
...
Retornar **`true`** se houver uma variante.
...
## <a name="visit"></a><a name="visit"></a>Visite
