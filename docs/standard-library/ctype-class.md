...
`maskVal` O valor da máscara para os quais o caractere é a ser testada.

`ch` O caractere cujos atributos serão testados.

`first` Um ponteiro para o primeiro caractere no intervalo cujos atributos devem ser classificados.

`last` Um ponteiro para o caractere imediatamente após o último caractere no intervalo cujos atributos devem ser classificados.
...
`ch` O caractere de tipo `Chartype` usado pela localidade a ser convertido.

`default` O valor padrão a ser atribuído pela função de membro para caracteres de tipo `CharType` que não têm caracteres equivalente do tipo `char`.

`first` Um ponteiro para o primeiro caractere no intervalo de caracteres a ser convertido.

`last` Um ponteiro para o caractere imediatamente após o último caractere no intervalo de caracteres a ser convertido.
...
`maskVal` O valor da máscara para correspondência com um caractere.

`first` Um ponteiro para o primeiro caractere no intervalo a ser verificado.

`last` Um ponteiro para o caractere imediatamente após o último caractere no intervalo a ser verificado.
...
`maskVal` O valor da máscara não devem ter correspondência com um caractere.
...
`first` Um ponteiro para o primeiro caractere no intervalo de caracteres cujos casos devem ser convertidos.

`last` Um ponteiro para o caractere imediatamente após o último caractere no intervalo de caracteres cujos casos devem ser convertidos.
...
`byte` O caractere de tipo `char` no conjunto a ser convertida de caracteres nativo.
...
`ch` O caractere a ser convertida em maiusculas.
...
`byte` O caractere de tipo char no caractere nativo definido para ser convertido.
