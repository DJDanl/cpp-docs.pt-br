...
ms.locfileid: "72687605"
---
# <a name="numpunct_byname-class"></a>Classe numpunct_byname

O modelo de classe derivada descreve um objeto que pode servir como uma faceta `numpunct` de uma determinada localidade, permitindo a formatação e a pontuação de expressões numéricas e booleanas.
