---
title: Contêiner Class::const_reverse_iterator | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
ms.locfileid: "33841252"
---
# <a name="container-classconstreverseiterator"></a>Classe de Contêiner::const_reverse_iterator
...
Descreve um objeto que pode servir como um iterador inverso constante para a sequência controlada.
...
Descrito aqui como um sinônimo para o tipo não especificado **T8** (normalmente, [reverse_iterator](../standard-library/container-class-reverse-iterator.md) <[const_iterator](../standard-library/container-class-const-iterator.md)`>`).
