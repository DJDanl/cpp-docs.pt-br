---
title: Classe de Contêiner::const_reverse_iterator
ms.date: 11/04/2016
helpviewer_keywords:
...
Ele é descrito aqui como um sinônimo para o tipo não especificado `T8` (normalmente [reverse_iterator](../standard-library/container-class-reverse-iterator.md) <[const_iterator](../standard-library/container-class-const-iterator.md)`>`).
