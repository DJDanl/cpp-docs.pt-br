...
## Exemplo  
 O construtor de `const_mem_fun_ref_t` geralmente não é usado diretamente; a função `mem_fun_ref` auxiliar é usada para adaptar funções de membro.  Consulte [mem\_fun\_ref](../Topic/mem_fun_ref%20Function.md) para obter um exemplo de como usar adaptadores da função de membro.  
