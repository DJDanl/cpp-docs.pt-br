...
helpviewer_keywords: 
  ...
  - "Classe bernoulli_distribution [TR1]"
...
|`bernoulli_distribution::operator()`||[bernoulli\_distribution::param\_type](../Topic/bernoulli_distribution::param_type.md)|  
 ...
 Para obter informações detalhadas sobre a função de probabilidade discreta distribuição Bernoulli, consulte o artigo da Wolfram MathWorl[Bernoulli Distribution \(em inglês\)](http://go.microsoft.com/fwlink/?LinkId=398467).  
