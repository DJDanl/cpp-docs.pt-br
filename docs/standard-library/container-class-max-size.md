---
title: Contêiner Class::max_size | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
---
# <a name="container-classmaxsize"></a>Classe de Contêiner::max_size
...
Retorna o tamanho da sequência mais longa que o objeto pode controlar, em tempo constante, independentemente do tamanho da sequência controlada.
