...
Uma instância do predicado de tipo se aplica true se o tipo *Ty* é uma classe que declara ou herda uma função virtual, caso contrário, ela mantém false.
