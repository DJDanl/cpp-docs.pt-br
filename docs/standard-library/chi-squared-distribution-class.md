...
Para obter informações detalhadas sobre a distribuição qui-quadrado, consulte o artigo [Geometric Distribution](http://go.microsoft.com/fwlink/LinkId=400528) (Distribuição geométrica) da Wolfram MathWorld.  
