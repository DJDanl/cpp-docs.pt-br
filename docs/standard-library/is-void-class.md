...
Uma instância do predicado de tipo será verdadeira se o tipo *T* é **void** ou uma forma qualificada por cv de **void**, caso contrário, será falsa.
