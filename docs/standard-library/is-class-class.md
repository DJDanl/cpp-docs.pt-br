...
Uma instância do predicado de tipo se aplica true se o tipo *Ty* é um tipo definido como um **`class`** ou uma **`struct`** `cv-qualified` forma de um deles, caso contrário, ele mantém false.
