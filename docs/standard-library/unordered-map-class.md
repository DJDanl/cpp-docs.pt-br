...
`operator[]` pode ser usado para inserir elementos em um mapa *m* usando *m*[*chave*] = `DataValue`; onde `DataValue` é o valor da `mapped_type` do elemento com uma chave valor de *chave*.
