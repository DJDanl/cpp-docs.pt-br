...
|[repeti](../standard-library/container-class-iterator.md)|Descreve um objeto que pode servir como um iterador para a sequência controlada.|
...
|[value_type](../standard-library/container-class-value-type.md)|Atua como um sinônimo para o parâmetro de modelo `Ty` .|
...
|[empty](../standard-library/container-class-empty.md)|Retorna **`true`** uma sequência controlada vazia.|
|[completo](../standard-library/container-class-end.md)|Retorna um iterador que aponta para imediatamente após o fim da sequência.|
...
|[permuta](../standard-library/container-class-swap.md)
