...
*À direita* um `packaged_task` objeto.
...
*alocação* um alocador de memória. Para obter mais informações, consulte [\<allocators>](../standard-library/allocators-header.md).

*Fn* um objeto de função.
