...
Descrito aqui como um sinônimo para o tipo não especificado **T2** (normalmente, **Alloc::reference**). Um objeto do tipo **reference** pode ser convertido em um objeto do tipo [const_reference](../standard-library/container-class-const-reference.md).
