...
- Se *count* > 0, **n** = *count*. Fornecido **d** = (*alto* - *baixo*)/ **n** é maior que zero, usando subintervalos de **d** uniforme, cada peso é atribuído da seguinte `weight[k] = weightfunc(x)`maneira:, em que **x** = *baixo*  +  **k**    d/2, para k = 0,..., n-1. +  * 
