...
O construtor de lista do inicializador que tem um *weightlist* parâmetro constrói um objeto de distribuição com pesos da lista do inicializador *weightlist*.
