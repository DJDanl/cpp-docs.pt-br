...
| - | - |
| [Algoritmos](./algorithms.md) | [\<algorithm>](algorithm.md), [\<cstdlib>](cstdlib.md), [\<numeric>](numeric.md) |
...
|Categoria|Cabeçalhos|
|-|-|
|[Algoritmos](./algorithms.md)|[\<algorithm>](algorithm.md)|
