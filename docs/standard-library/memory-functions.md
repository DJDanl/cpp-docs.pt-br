...
### <a name="parameters"></a>Parâmetros  
 ...
 `Ptr`  
 O endereço inicial do pool de armazenamento contíguo disponível a ser usado. Esse parâmetro também é um parâmetro de saída e é definido para conter o novo endereço inicial se o alinhamento for bem-sucedida. Se `align()` for malsucedido, esse parâmetro não será modificado.  
