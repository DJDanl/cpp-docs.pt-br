...
ms.locfileid: "50475408"
---
# <a name="container-classend"></a>Classe de Contêiner::end
...
Retorna um iterador que aponta para imediatamente após o fim da sequência.
