...
*STR* um std:: String, char *, cadeia de caracteres literal ou brutos cadeia de caracteres literal ou uma versão larga de qualquer um deles (por exemplo, std:: wstring, wchar_t\*).
