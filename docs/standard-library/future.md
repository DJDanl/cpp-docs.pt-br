...
|Nome|Descrição|
|----------|-----------------|
|[Classe futura](../standard-library/future-class.md)|Descreve um objeto de retorno assíncrono.|
...
|[permuta](../standard-library/future-functions.md#swap)|Troca o estado assíncrono associado de um objeto `promise` pelo de outro objeto.|
