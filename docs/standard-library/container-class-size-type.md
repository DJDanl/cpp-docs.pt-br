---
title: Contêiner Class::size_type | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
Descrito aqui como um sinônimo para o tipo não especificado **T0** (normalmente, **Alloc::size_type**).
