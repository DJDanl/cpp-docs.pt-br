...
### <a name="remarks"></a>Comentários  
 ...
 O valor retornado é um valor de entidade de segurança entre +pi/2 e –pi/2 consistente com a entrada do valor de seno.  
...
### <a name="remarks"></a>Comentários  
 ...
 O valor retornado é um valor de entidade de segurança entre +pi/2 e –pi/2 consistente com a entrada do valor de tangente.  
...
### <a name="remarks"></a>Comentários  
 ...
 Essa função preserva as informações dos sinais dos componentes no argumento que está perdido pela função de tangente padrão e esse conhecimento do quadrante permite que o valor retornado seja atribuído a um ângulo exclusivo entre +pi e –pi.  
