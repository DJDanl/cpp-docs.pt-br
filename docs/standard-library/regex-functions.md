...
*BidIt*<br/> O tipo de iterador para subcorrespondências. Para isso é um dos casos de comuns `string::const_iterator`, `wstring::const_iterator`, `const char*` ou `const wchar_t*`.
