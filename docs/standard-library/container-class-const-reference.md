---
title: Contêiner Class::const_reference | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
ms.locfileid: "33841507"
---
# <a name="container-classconstreference"></a>Classe de Contêiner::const_reference
...
Descreve um objeto que pode servir como uma referência constante para um elemento da sequência controlada.
...
Descrito aqui como um sinônimo para o tipo não especificado **T3** (normalmente, **Alloc::const_reference**).
