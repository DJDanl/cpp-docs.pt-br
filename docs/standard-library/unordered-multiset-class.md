...
## <a name="unordered_multisetbegin"></a><a name="begin"></a>unordered_multiset::começar
...
## <a name="unordered_multisetbucket"></a><a name="bucket"></a>unordered_multiset::balde
...
## <a name="unordered_multisetclear"></a><a name="clear"></a>unordered_multiset::claro
...
## <a name="unordered_multisetcount"></a><a name="count"></a>unordered_multiset::contagem
...
## <a name="unordered_multisetempty"></a><a name="empty"></a>unordered_multiset::vazio
...
## <a name="unordered_multisetend"></a><a name="end"></a>unordered_multiset::fim
...
## <a name="unordered_multiseterase"></a><a name="erase"></a>unordered_multiset:apagar
...
## <a name="unordered_multisetfind"></a><a name="find"></a>unordered_multiset::encontrar
...
## <a name="unordered_multisetinsert"></a><a name="insert"></a>unordered_multiset::inserção
...
|*Valty*|Parâmetro de modelo que especifica o tipo de argumento que o unordered_multiset pode usar para construir um elemento de [value_type](../standard-library/map-class.md#value_type), e aperfeiçoa *Val* como argumento.|
...
A função membro de intervalo (5) insere a seqüência de valores do elemento `[First, Last)`em um unordered_multiset que corresponde a cada elemento endereçado por um iterizador na faixa; portanto, *o último* não é inserido. A função de membro do contêiner `end()` refere-se à posição logo após o último elemento no contêiner, por exemplo, a instrução `m.insert(v.begin(), v.end());` insere todos os elementos de `v` em `m`.
...
A função `(float)`membro retorna [unordered_multiset::tamanho](#size)`() / (float)`[unordered_multiset:bucket_count](#bucket_count)`()`, o número médio de elementos por balde.
...
## <a name="unordered_multisetoperator"></a><a name="op_eq"></a>unordered_multiset:operador=
...
|Parâmetro|Descrição|
|-|-|
|*Certo*|O [unordered_multiset](../standard-library/unordered-multiset-class.md) que está sendo copiado para o `unordered_multiset`.|

### <a name="remarks"></a>Comentários

Depois de apagar quaisquer `unordered_multiset`elementos `operator=` existentes em um , ou `unordered_multiset`copia ou move o conteúdo da direita *para* o .
...
A função do membro troca `*this` as seqüências controladas entre e *a direita*. Se [unordered_multiset::get_allocator](#get_allocator)`() == right.get_allocator()`, ele o faz em tempo constante, ele lança uma exceção `Tr`apenas como resultado da cópia dos traços armazenados objeto do tipo , e invalida nenhuma referência, ponteiros ou iteradores que designem elementos nas duas seqüências controladas. Caso contrário, executará uma série de atribuições de elemento e de chamadas do construtor proporcional ao número de elementos nas duas sequências controladas.
...
O primeiro construtor especifica uma cópia da seqüência controlada por *Right*. O segundo construtor especifica uma sequência controlada vazia. O terceiro construtor insere a sequência de valores do elemento `[First, Last)`. O quarto construtor especifica uma cópia da seqüência *movendo-se para a direita*.
