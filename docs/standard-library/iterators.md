...
> [!NOTE]
> É possível evitar o uso de iteradores explicitamente usando loops range-for. Para obter mais informações, consulte [baseada em intervalo para instrução](../cpp/range-based-for-statement-cpp.md).
