---
title: "Funções &lt;unordered_set&gt; | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
### <a name="remarks"></a>Comentários  
 A função de modelo executa `left.`[unordered_set::swap](../standard-library/unordered-set-class.md#unordered_set__swap)`(right)`.  
...
### <a name="remarks"></a>Comentários  
 A função de modelo executa `left.`[unordered_multiset::swap](../standard-library/unordered-multiset-class.md#unordered_multiset__swap)`(right)`.  
