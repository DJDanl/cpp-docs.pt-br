---
title: "Contêiner Class::reverse_iterator | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="remarks"></a>Comentários  
 Descrito aqui como um sinônimo para o tipo não especificado **T7** (normalmente, `reverse_iterator` **\<**[iterator](../standard-library/container-class-iterator.md)**>**).  
