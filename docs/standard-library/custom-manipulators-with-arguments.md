...
[Manipuladores de Stream com um argumento de saída](../standard-library/output-stream-manipulators-with-one-argument-int-or-long.md) (**int** ou **longo**)
