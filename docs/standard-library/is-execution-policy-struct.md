...
ms.locfileid: "81371623"
---
# <a name="is_execution_policy-struct"></a>is_execution_policy Struct

Detecta políticas de execução com o propósito de excluir assinaturas de função da participação ambígua de resolução de sobrecarga.
