...
O resultado de `-Left`. O modelo especializado realiza o encaminhamento do resultado, que tem o tipo que é retornado pelo unário perfeito `operator-`.
