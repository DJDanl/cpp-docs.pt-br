...
`left` Um objeto do tipo `hash_set`.

`right` Um objeto do tipo `hash_set`.
...
`left` Um objeto do tipo `hash_multiset`.

`right` Um objeto do tipo `hash_multiset`.
