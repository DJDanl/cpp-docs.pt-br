...
Uma instância do predicado de tipo se aplica true se o tipo *Ty* é uma classe que tem pelo menos uma função virtual pura, caso contrário, ela mantém false.
