...
Uma instância do predicado de tipo será verdadeira se o tipo *Ty* é uma classe que tem pelo menos uma função virtual pura, caso contrário, será falsa.
