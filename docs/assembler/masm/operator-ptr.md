...
ms.locfileid: "62199920"
---
# <a name="operator-ptr"></a>operador PTR

O força do operador primeiro a *expressão* deve ser tratada como tendo especificado *tipo*. O segundo operador especifica um ponteiro para *tipo*.
