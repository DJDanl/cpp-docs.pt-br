---
title: ML aviso A4004 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
**não é possível SUPOR CS**  
 ...
 Foi feita uma tentativa para assumir um valor para o registrador CS. CS é sempre definido como o segmento atual ou o grupo.  
