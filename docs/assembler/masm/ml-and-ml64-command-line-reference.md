...
|Opção|Action|
|------------|------------|
|**/AT**|Habilita o mínimo de suporte a modelos de memória. Habilita mensagens de erro para construções de código que violam os requisitos para arquivos de formato. com. Observe que isso não é equivalente ao [. ](dot-model.md)Diretiva **Tiny** do modelo.<br /><br /> Não disponível em ml64. exe.|
...
|**/H** *number*|Restringe nomes externos para números significativos de caracteres. O padrão é 31 caracteres.<br /><br /> Não disponível em ml64. exe.|
|**/help**|Chama QuickHelp para obter ajuda sobre ML.|
|**/I** *pathname*|Define o caminho para o arquivo de inclusão. É permitido um máximo de 10 opções **/i** .|
...
|**/Sl** *width*|Define a largura da linha da listagem de origem em caracteres por linha. O intervalo é de 60 a 255 ou 0. O padrão é 0. Igual à largura [da página](page.md) .|
...
|**/w**|O mesmo que **/W0/WX**.|
|**/W** *level*|Define o nível de aviso, em que *nível* = 0, 1, 2 ou 3.|
