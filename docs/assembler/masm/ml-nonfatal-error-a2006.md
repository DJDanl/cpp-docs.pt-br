---
title: ML erro não fatal A2006 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
-   Um símbolo foi definido em um arquivo de inclusão não foi incluído.  
  
-   Um símbolo externo usado sem uma [EXTERN](../../assembler/masm/extern-masm.md) ou [EXTERNDEF](../../assembler/masm/externdef.md) diretiva.  
