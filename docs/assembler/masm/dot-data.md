...
ms.locfileid: "43683226"
---
# <a name="data"></a>.DATA

Quando usado com [. MODELO](../../assembler/masm/dot-model.md), inicia um segmento de dados quase para dados inicializados (nome segmento data).
