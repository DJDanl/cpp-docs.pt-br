...
Sinaliza o término das declarações de prólogo.  
...
## <a name="remarks"></a>Comentários  
 Erro ao usar qualquer uma das declarações de prólogo fora da região entre [PROC](../../assembler/masm/proc.md) quadro e. ENDPROLOG.  
