...
### <a name="errors"></a>Erros  
 ...
 A arquitetura ARM não garante o que acontece quando essa instrução é executada.  Para obter detalhes sobre os formulários bem definidos dessa instrução, consulte o [Manual de referência de arquitetura ARM](http://go.microsoft.com/fwlink/p/?linkid=246464).  
