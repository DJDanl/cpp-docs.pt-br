...
Se você vincular a uma biblioteca de importação, qualquer versão mais recente das bibliotecas redistribuíveis do Visual Studio que preservar a compatibilidade com ABI poderá ser usada em tempo de execução. Por exemplo, se o aplicativo é compilado e vinculado usando o conjunto de ferramentas do Visual Studio 2015 Atualização 3, você pode usar qualquer redistribuível do Visual Studio 2017 ou do Visual Studio 2019, porque as bibliotecas do 2015, do 2017 e do 2019 mantiveram a compatibilidade binária entre as versões. O contrário não é válido: Você não poderá usar um redistribuível para uma versão do conjunto de ferramentas anterior à que você usou para compilar seu código, mesmo se elas tiverem uma ABI compatível.
...
Se você tem uma biblioteca estática que foi compilada com uma versão mais antiga dos cabeçalhos de Tempo de Execução de C, recomendamos as seguintes ações, nesta ordem:
