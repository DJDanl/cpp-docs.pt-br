...
```  
 ...
 Embora a função _tcscpy tenha sido usada, que é a função strcpy TCHAR para copiar uma cadeia de caracteres, o buffer alocado era um buffer `char`. Isso é facilmente alterado para TCHAR.  
