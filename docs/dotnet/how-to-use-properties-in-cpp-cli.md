...
Para obter informações sobre como consumir um indexador escrito em C#, consulte [como: consumir um indexador C# (C++/CLI)](./interoperability-with-other-dotnet-languages-cpp-cli.md#consume_indexer).
