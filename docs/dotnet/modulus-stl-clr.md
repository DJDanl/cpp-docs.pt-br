...
A classe do modelo descreve um funtor que, quando chamado, retorna o primeiro argumento módulo do segundo.  Use\-a especifica um objeto de função em termos de seu tipo de argumento.  
...
## Comentários  
 A classe do modelo descreve um funtor de dois argumentos.  Define o operador `operator()` membro de forma que, quando o objeto é chamado como uma função, retorna o primeiro argumento módulo do segundo.  
