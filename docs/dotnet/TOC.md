...
### [Como definir e consumir enums do C++ – CLI](how-to-define-and-consume-enums-in-cpp-cli.md)
...
## [Primer de migração do C++ – CLI](cpp-cli-migration-primer.md)
...
### [Como recuperar texto na Área de Transferência (C++ – CLI)](how-to-retrieve-text-from-the-clipboard-cpp-cli.md)
...
## [Conversão boxing (C++/CX)](boxing-cpp-cli.md)
