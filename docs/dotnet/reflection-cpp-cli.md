...
## <a name="example-boxed-value-types"></a>Exemplo: tipos de valor boxed
...
## <a name="example-enumeration-of-types"></a>Exemplo: enumeração dos tipos de
