---
title: 'Como: converter entre System:: GUID e GUID | Microsoft Docs'
...
ms.locfileid: "33127436"
---
# <a name="how-to-convert-between-systemguid-and-guid"></a>Como fazer uma conversão entre System::Guid e _GUID
O exemplo de código a seguir mostra como converter entre uma <xref:System.Guid> e um `_GUID`.  
