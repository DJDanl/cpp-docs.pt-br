---
title: 'Como: usar referências de acompanhamento no C + + c++ CLI | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
O próximo exemplo mostra que tomar o endereço de uma referência de rastreamento retorna um [interior_ptr (C++ c++ CLI)](../windows/interior-ptr-cpp-cli.md)e mostra como modificar e acessar dados por meio de uma referência de rastreamento.
