...
ms.locfileid: "74988257"
---
# <a name="how-to-convert-standard-string-to-systemstring"></a>Como converter cadeia de caracteres padrão em System::String

Este tópico mostra como converter uma C++ cadeia de caracteres de biblioteca padrão ([\<cadeia de caracteres >](../standard-library/string.md)) em um <xref:System.String>.
