...
Para obter mais informações sobre conversões, consulte [conversão Boxing](../windows/boxing-cpp-component-extensions.md) e [conversões padrão](../cpp/standard-conversions.md).
