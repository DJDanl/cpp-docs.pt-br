...
2.  Adicione uma referência a mfcmifc80.dll, o que pode ser feito clicando com o nó do projeto no **Gerenciador de soluções**, selecionando **Add**, **referência**e, em seguida, navegando até Microsoft Visual Studio 10.0\VC\atlmfc\lib.  
  
3.  Abra o UserControl1.Designer.cs e adicione a seguinte instrução using:  
...
5.  Adicione isso como a primeira linha da definição de classe para `UserControl1`:  
  
    ```  
    private ICommandSource m_CmdSrc;  
    ```  
  
6.  Adicione as seguintes definições de método para `UserControl1` (nós criaremos a identificação do controle MFC na próxima etapa):  
...
7.  Abra o aplicativo do MFC que você criou na [como: criar o controle de usuário e a exibição do Host MDI](../dotnet/how-to-create-the-user-control-and-host-mdi-view.md).  
