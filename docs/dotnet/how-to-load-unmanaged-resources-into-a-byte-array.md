...
Se você souber o tamanho do seu recurso não gerenciado, você pode alocar antecipadamente uma matriz CLR e, em seguida, carregue o recurso para a matriz usando um ponteiro para o bloco de matriz da matriz de CLR.
