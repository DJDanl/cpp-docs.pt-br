...
## Comentários  
 A função de membro retorna `(float)`[hash\_map::size](../dotnet/hash-map-size-stl-clr.md)`() /` [hash\_map::bucket\_count](../dotnet/hash-map-bucket-count-stl-clr.md)`()`.  Use\-a para determinar o tamanho médio do segmento.  
