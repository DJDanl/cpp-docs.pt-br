...
Novo no idioma: inicialização de matriz explícita que segue gcnew
...
Ver [privada Virtual funções](../dotnet/private-virtual-functions.md) para obter mais informações.
