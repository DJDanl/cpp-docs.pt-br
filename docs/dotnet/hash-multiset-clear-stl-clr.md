...
## Comentários  
 A função de membro chama efetivamente [hash\_multiset::erase](../dotnet/hash-multiset-erase-stl-clr.md)`(` [hash\_multiset::begin](../dotnet/hash-multiset-begin-stl-clr.md)`(),` [hash\_multiset::end](../dotnet/hash-multiset-end-stl-clr.md)`())`.  Use\-a para garantir que a sequência controlada está vazia.  
