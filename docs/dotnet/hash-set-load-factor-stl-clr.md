...
## Comentários  
 A função de membro retorna `(float)`[hash\_set::size](../dotnet/hash-set-size-stl-clr.md)`() /` [hash\_set::bucket\_count](../dotnet/hash-set-bucket-count-stl-clr.md)`()`.  Use\-a para determinar o tamanho médio do segmento.  
