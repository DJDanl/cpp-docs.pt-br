...
## Comentários  
 O membro que o operador copia `right` ao objeto, retornará `*this`.  Use\-a para substituir os pares armazenados de iterador com uma cópia dos pares armazenados de iterador em `right`.  
