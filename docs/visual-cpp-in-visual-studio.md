...
## <a name="general-information-about-visual-c"></a>Informações gerais sobre o Visual C++  
 ...
 [Suporte a recursos do C++11/14/17 (C++ moderno)](cpp/support-for-cpp11-14-17-features-modern-cpp.md)  
...
## <a name="writing-applications-in-c"></a>Escrevendo aplicativos no C++  
