...
# vcpkg: gerenciador de pacotes de C++ para Windows
<a id="vcpkg-c-package-manager-for-windows" class="xliff"></a> 
...
## Simples e flexível
<a id="simple-yet-flexible" class="xliff"></a>
...
## Fontes não binárias
<a id="sources-not-binaries" class="xliff"></a>
...
### Pesquisar a lista de bibliotecas disponíveis
<a id="search-the-list-of-available-libraries" class="xliff"></a>
...
### Instalar uma biblioteca em seu computador local
<a id="install-a-library-on-your-local-machine" class="xliff"></a>
...
### Listar as bibliotecas já instaladas
<a id="list-the-libraries-already-installed" class="xliff"></a>
...
<a id="integrate-with-visual-studio" class="xliff"></a>
#### Por usuário
<a id="per-user" class="xliff"></a>
...
#### Por projeto
<a id="per-project" class="xliff"></a>
...
### Exportar binários compilados e cabeçalhos
<a id="export-compiled-binaries-and-headers" class="xliff"></a>
...
### Atualizar bibliotecas instaladas
<a id="update-installed-libraries" class="xliff"></a>
...
### Contribuir com novas bibliotecas
<a id="contribute-new-libraries" class="xliff"></a>
Você pode incluir todas as biblioteca que quiser em sua coleção de portas particulares. Para sugerir uma nova biblioteca para o catálogo público, 


### Remover uma biblioteca
<a id="remove-a-library" class="xliff"></a>
...
### Personalizar o vcpkg
<a id="customize-vcpkg" class="xliff"></a>
...
## A hierarquia de pasta do vcpkg
<a id="the-vcpkg-folder-hierarchy" class="xliff"></a>
...
<a id="command-line-reference" class="xliff"></a>
