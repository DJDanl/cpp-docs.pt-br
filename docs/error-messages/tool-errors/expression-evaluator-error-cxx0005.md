---
title: CXX0005 de erro do avaliador de expressão | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33294967"
---
# <a name="expression-evaluator-error-cxx0005"></a>Erro CXX0005 (avaliador de expressão)
operador não suportado  
  
 Um operador de C sem suporte foi especificado em uma expressão. Grave uma expressão equivalente usando os operadores com suporte do C.  
