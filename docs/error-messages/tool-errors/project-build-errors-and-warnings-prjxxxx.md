---
title: Erros de compilação e avisos projeto (PRJxxxx) | Microsoft Docs
ms.custom: ''
ms.date: 11/17/2017
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33316102"
---
# <a name="project-build-errors-and-warnings-prjxxxx"></a>Erros e avisos de build do projeto (PRJxxxx)

Esta seção é uma referência para os erros gerados pelo projeto ferramentas de compilação.
