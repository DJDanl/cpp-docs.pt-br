---
title: NMAKE Erro Fatal U1087 | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
não é possível ter dependentes : e :: para mesmo destino  
  
 Não é possível especificar um destino em ambos os um único dois-pontos (**:**) e dois-pontos duplos (`::`) dependência.  
