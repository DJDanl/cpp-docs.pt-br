---
title: RC2116 de erro do compilador de recurso | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
ms.openlocfilehash: db90580a482d4d8fbe1b61c8af90788db128a49b
ms.lasthandoff: 02/25/2017

---
# <a name="resource-compiler-error-rc2116"></a>Erro RC2116 (compilador de recurso)
esperando o número de identificação  
