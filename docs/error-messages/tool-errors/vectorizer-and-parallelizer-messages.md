---
title: "Mensagens do vetorizador e do paralelizador | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
###  <a name="BKMK_ReasonCode50x"></a> 5xx  
 Os 5*xx* códigos de motivo se aplicam ao autoparalelizador e ao autovetorizador.  
...
|1005|O pragma **no\_parallel** foi especificado.|  
|1006|Essa função contém **openmp**.  Resolva isso removendo qualquer **openmp** dessa função.|  
...
|1010|O compilador detectou que o loop está usando "não igual a" \(\! \=\) para sua condição.|  
...
###  <a name="BKMK_ReasonCode140x"></a> 14xx  
 14*xx* motivo códigos ocorrem quando alguma opção que é incompatível com a autovetorização é especificada.  
  
|Código de motivo|Explicação|  
|----------------------|----------------|  
|1400|**\#pragma loop\(no\_vector\)** especificado.|  
|1401|A opção **\/kernel** é especificada quando x86 ou ARM é o alvo.|  
|1402|A opção **\/arch:SSE2** ou superior não é especificada quando x86 é o alvo.|  
|1403|A opção **\/arch:ATOM** é especificada e o loop inclui operações em doubles.|  
|1404|A opção **\/O1** ou **\/Os** é especificada.|  
