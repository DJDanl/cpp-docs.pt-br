---
title: "R6009 de erro de tempo de execução C | Documentos do Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
 ...
 **Informações para programadores**  
 ...
 Havia memória suficiente para carregar o programa, mas não há memória suficiente para criar o **envp** matriz.  Isso pode ser causado por condições de memória extremamente baixa, ou pelo uso de variável de ambiente muito grande. Considere uma das seguintes soluções:  
