...
C4251 pode ser ignorado se você estiver derivando de um tipo no C++ Standard Library, Compilando uma versão de depuração (**/MTd**) e onde a mensagem de erro do compilador se refere ao _Container_base.
