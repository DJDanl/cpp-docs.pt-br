---
title: Compilador aviso (nível 4) C4681 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "46114482"
---
# <a name="compiler-warning-level-4-c4681"></a>Compilador aviso (nível 4) C4681

'class': coclass não especifica uma interface padrão que é uma origem do evento

Um [origem](../../windows/source-cpp.md) interface não foi especificado para uma classe.
