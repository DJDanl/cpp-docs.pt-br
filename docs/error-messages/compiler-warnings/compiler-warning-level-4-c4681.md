---
title: "Compilador C4681 de aviso (n&#237;vel 4) | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
manager: "ghogen"
---
# Compilador C4681 de aviso (n&#237;vel 4)
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

'class': coclass não especifica uma interface padrão que é uma fonte de evento  
  
 Um [fonte](../Topic/source%20\(C++\).md) interface não foi especificada para uma classe.  
