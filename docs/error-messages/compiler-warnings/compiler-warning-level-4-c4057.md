---
title: "Compilador aviso (nível 4) C4057 | Documentos do Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
'operator': 'identifier1' indireção em tipos de base ligeiramente diferentes de 'identifier2'  
...
2.  Misturar **curto** e **longo** tipos.
