---
title: Compilador (nível 1) de aviso C4346 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33276257"
---
# <a name="compiler-warning-level-1-c4346"></a>Compilador C4346 de aviso (nível 1)
'name': nome dependente não é um tipo  
  
 O [typename](../../cpp/typename.md) palavra-chave é necessário se um nome dependente é tratado como um tipo. Para o código que funciona da mesma em todas as versões do Visual C++, adicionar `typename` à declaração.  
