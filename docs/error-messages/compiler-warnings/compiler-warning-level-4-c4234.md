---
title: "Compilador aviso (nível 4) C4234 | Documentos do Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
extensão não padrão usada: palavra-chave de 'palavra-chave' reservado para uso futuro  
  
 O compilador ainda não implementa a palavra-chave que é usada.  
