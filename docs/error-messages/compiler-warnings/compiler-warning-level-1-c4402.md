---
title: "Compilador aviso (nível 1) C4402 | Documentos do Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
deve usar operador PTR  
 ...
 Um tipo é usado em um operando sem um operador PTR quando se referir ao ou conversão para um tipo de código de assembly embutido.  
