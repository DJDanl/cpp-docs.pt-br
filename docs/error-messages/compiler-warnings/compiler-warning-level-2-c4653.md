---
title: "Compilador aviso (nível 2) C4653 | Documentos do Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
ms.openlocfilehash: 555d2053c6793d86213608ca6f8f433e1347c166
ms.lasthandoff: 02/25/2017

---
# <a name="compiler-warning-level-2-c4653"></a>Compilador C4653 de aviso (nível 2)
opção de compilador 'option' inconsistente com o cabeçalho pré-compilado. opção de linha de comando atual ignorada  
