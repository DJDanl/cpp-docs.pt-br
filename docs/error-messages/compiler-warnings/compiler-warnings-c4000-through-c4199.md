...
|[Aviso do compilador (nível 1) C4055](compiler-warning-level-1-c4055.md)|'conversão de ': de ponteiro de dados '*type1*'para o ponteiro de função'*type2*'|
