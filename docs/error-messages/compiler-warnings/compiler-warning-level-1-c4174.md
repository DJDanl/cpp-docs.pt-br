---
title: "Compilador aviso (nível 1) C4174 | Documentos do Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="compiler-warning-level-1-c4174"></a>Compilador C4174 de aviso (nível 1)
'name': não está disponível como um componente #pragma  
