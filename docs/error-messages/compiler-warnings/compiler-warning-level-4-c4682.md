---
title: Compilador (nível 4) de aviso C4682 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
'parameter': nenhum atributo de parâmetro direcional especificado, padronizando para [in]  
 ...
 Um método em um parâmetro em uma interface atribuído não tem um dos atributos direcionais: [na](../../windows/in-cpp.md) ou [out](../../windows/out-cpp.md). O parâmetro padrão no.  
