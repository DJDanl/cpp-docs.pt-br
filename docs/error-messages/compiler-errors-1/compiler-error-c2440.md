...
O Microsoft C++ compilador não permite mais que o [operador const_cast](../../cpp/const-cast-operator.md) downcast quando código-fonte que usa **/clr** programação é compilada.
