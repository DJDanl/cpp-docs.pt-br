...
---
# <a name="compiler-error-c2241"></a>C2241 de erro do compilador
'Identificador': acesso de membro é restrito  
...
2.  Declarar o membro de uma `friend` da função de acesso.