---
title: C2380 de erro do compilador | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
tipo (s) anterior 'identifier' (construtor com o tipo de retorno ou redefinição inválida do nome de classe atual)?  
