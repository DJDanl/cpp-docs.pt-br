...
|Erro fatal C1012|Parêntese sem correspondência: ausente '*caractere*"|
|Erro fatal C1013|limite do compilador: muitos parênteses abertos|
|Erro fatal C1014|muitos arquivos de inclusão: profundidade = *número*|
...
|Erro fatal C1035|expressão muito complexa; Simplificar expressão|
...
|Erro fatal C1047|O arquivo de biblioteca ou objeto '*arquivo*' foi criado com um compilador mais antigo que outros objetos; objetos antigos de recompilação e bibliotecas|
