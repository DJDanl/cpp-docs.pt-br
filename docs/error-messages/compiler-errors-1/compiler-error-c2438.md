---
title: C2438 de erro do compilador | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
ms.openlocfilehash: da59a0b237e90b27869114e50ac36c9fa47a81c2
ms.contentlocale: pt-br
ms.lasthandoff: 02/25/2017

---
# <a name="compiler-error-c2438"></a>C2438 de erro do compilador
'identifier': não é possível inicializar dados de classe estática por meio do construtor  
