...
ms.locfileid: "87214705"
---
# <a name="compiler-error-c2253"></a>Erro do compilador C2253

' function ': especificador puro ou de substituição abstract permitido somente em função virtual

Uma função não virtual é especificada como pura **`virtual`** .
