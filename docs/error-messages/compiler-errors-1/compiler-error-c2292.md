---
title: C2292 de erro do compilador | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33171344"
---
# <a name="compiler-error-c2292"></a>C2292 de erro do compilador
'Identificador': representação de herança de melhor caso: 'representation1' declarado mas 'representation2' necessário  
