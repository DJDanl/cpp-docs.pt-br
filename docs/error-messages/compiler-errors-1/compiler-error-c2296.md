---
title: C2296 de erro do compilador | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33171891"
---
# <a name="compiler-error-c2296"></a>C2296 de erro do compilador
'operator': operando esquerdo inválido  
  
 O operando esquerdo usado com `operator` é inválido.  
  
 Por exemplo, o compilador pode ver uma declaração de onde você pretendia uma chamada de função.  
