---
title: Erro do compilador C3022 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "46065225"
---
# <a name="compiler-error-c3022"></a>Erro do compilador C3022

'cláusula': tipo de agenda inválida de 'value' na diretiva de 'diretiva' OpenMP
