---
title: C3179 de erro do compilador | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
gerenciado sem um nome ou tipo WinRT não é permitido  
  
CLR e do WinRT todas as classes e estruturas devem ter nomes.  
