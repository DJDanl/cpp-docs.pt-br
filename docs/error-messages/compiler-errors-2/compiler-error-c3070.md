---
title: Erro do compilador C3070
ms.date: 11/04/2016
f1_keywords:
- C3070
helpviewer_keywords:
...
ms.locfileid: "74758197"
---
# <a name="compiler-error-c3070"></a>Erro do compilador C3070

' Property ': a propriedade não tem um método ' Set '

O método de acessador set de uma propriedade não foi definido. Para obter mais informações, consulte [Propriedade](../../extensions/property-cpp-component-extensions.md).
