---
title: C3754 de erro do compilador | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Delegar o construtor: função de membro 'function' não pode ser chamada em uma instância do tipo 'type'  
