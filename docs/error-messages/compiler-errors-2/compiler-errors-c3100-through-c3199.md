...
|C3108 de erro do compilador|não é possível deduzir um tipo porque uma lista de inicializadores não é uma expressão|  
...
|C3111 de erro do compilador|Não é possível usar uma lista de inicializadores como o argumento padrão para um parâmetro de modelo|  
...
|C3119 de erro do compilador|alignas(void) não permitido|  
...
|C3123 de erro do compilador|Uma interface genérica WinRT não pode ter restrições|  
...
|[Erro do compilador C3130](compiler-error-c3130.md)|Erro Interno do Compilador: falha ao gravar bloco de código injetado em PDB|  
|[Erro do compilador C3131](compiler-error-c3131.md)|projeto deve possuir um atributo 'module' com uma propriedade 'name'|  
