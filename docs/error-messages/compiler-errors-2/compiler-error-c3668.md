---
title: C3668 de erro do compilador | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
'method': método com o especificador de substituição 'override' não substituir quaisquer métodos de classe base  
