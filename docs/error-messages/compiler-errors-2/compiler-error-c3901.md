...
ms.locfileid: "58780113"
---
# <a name="compiler-error-c3901"></a>Erro do compilador C3901

'accessor_function': deve ter o tipo de retorno 'type'

Tipo de retorno do método get pelo menos um deve corresponder ao tipo de propriedade. Para obter mais informações, consulte [propriedade](../../extensions/property-cpp-component-extensions.md).
