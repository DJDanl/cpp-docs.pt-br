...
Uma interface que dá suporte a eventos COM não pode herdar de `IDispatch`. Para obter mais informações, consulte [manipulação de eventos em com](../../cpp/event-handling-in-com.md).
