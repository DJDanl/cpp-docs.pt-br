...
|[Erro do compilador C3501](compiler-error-c3501.md)|Não há nenhum typelib registrado para ProgID '*progid*'|
...
|C3504 de erro do compilador|não é possível criar GUID de cadeia de caracteres '*cadeia de caracteres*'|
|[Erro do compilador C3505](compiler-error-c3505.md)|não é possível carregar a biblioteca de tipos '*biblioteca*'|
|[Erro do compilador C3506](compiler-error-c3506.md)|Não há nenhum typelib registrado para LIBID '*biblioteca*'|
|[Erro do compilador C3507](compiler-error-c3507.md)|um ProgID pode ter mais do que 39 caracteres*progid*'; nem conter pontuações, exceto '.'; nem começar com um dígito|
|[Erro do compilador C3508](compiler-error-c3508.md)|'*tipo*': não é um tipo válido de automação|
|[Erro do compilador C3509](compiler-error-c3509.md)|'*tipo*': inválido, tipo de retorno de automação; quando um parâmetro está marcado como 'retval', o tipo de retorno deve ser 'void', 'HRESULT' ou 'SCODE'|
|[Erro do compilador C3510](compiler-error-c3510.md)|não é possível localizar a biblioteca de tipos dependente *biblioteca*|
|C3511 de erro do compilador|'*identificador*': uma chamada para um construtor delegado deverá ser o único inicializador de membro|
|C3512 de erro do compilador|a sequência de caracteres de delimitação para um literal de cadeia bruto deverá ter não mais que 16 caracteres|
|C3513 de erro do compilador|'*cadeia de caracteres*': sem suporte caractere delimitador de literal de cadeia de caracteres raw|
|C3514 de erro do compilador|'*caracteres*' (*valor*): sem suporte caractere delimitador de literal de cadeia de caracteres raw|
|C3515 de erro do compilador|Se um argumento para uma especialização parcial de modelo de classe é uma expansão de pacote será o último argumento|
|C3516 de erro do compilador|fim de-arquivo inesperado encontrado ao processar a cadeia de caracteres bruta literal; sequência de delimitador '*cadeia de caracteres*' não foi correspondida|
|C3517 de erro do compilador|'*identificador*' uma declaração de alias não pode ter um tipo que contém 'auto'|
|C3518 de erro do compilador|'*identificador*': em um contexto direct-list-initialization o tipo para '*tipo*' só pode ser deduzido a partir de uma expressão de inicializador único|
|[Erro do compilador C3519](compiler-error-c3519.md)|'*parâmetro*': parâmetro inválido para atributo embedded_idl|
|C3520 de erro do compilador|'*identificador*': pacote de parâmetros deve ser expandido nesse contexto|
...
|C3523 de erro do compilador|'sizeof...' requer que um pacote de parâmetros não expandido como seu argumento|
...
|C3525 de erro do compilador|'*parâmetro*': se um modelo de classe tiver um pacote de parâmetros de modelo que ele deve aparecer no final da lista de parâmetros de modelo|
...
|[Erro do compilador C3530](compiler-error-c3530.md)|'*tipo*' não pode ser combinado com nenhum outro especificador de tipo|
...
|[Erro do compilador C3535](compiler-error-c3535.md)|não é possível deduzir o tipo para '*type1*'from'*type2*'|
|[Erro do compilador C3536](compiler-error-c3536.md)|'*identificador*': não pode ser usado antes de ser inicializada|
...
|C3546 de erro do compilador|'...': não há nenhum pacote de parâmetros disponível para expandir|
...
|[Erro do compilador C3550](compiler-error-c3550.md)|apenas um 'decltype (Auto)' é permitido neste contexto|
...
|C3573 de erro do compilador|O número de instâncias do Graphics:: Sampler passado para Concurrency:: parallel_for_each não pode exceder *número*|
...
|C3592 de erro do compilador|Assembly nativo embutido ( ASM') não é suportado no código de amp restringido|
|C3593 de erro do compilador|'goto' não é suportado no código de amp restringido|
|C3594 de erro do compilador|exceção tratamento (try, catch, throw etc.) não é suportada no código de amp restringido|
...
|[Erro do compilador C3610](compiler-error-c3610.md)|'*identificador*': tipo de valor deve ser 'boxed' antes de método '*método*' pode ser chamado|
...
|[C3615 de erro do compilador](compiler-error-c3615.md)|função constexpr '*função*' não pode resultar em uma expressão constante|
...
|[Erro do compilador C3622](compiler-error-c3622.md)|*tipo*': uma classe declarada como '*palavra-chave*' não pode ser instanciado|
...
|[Erro do compilador C3648](compiler-error-c3648.md)|Não há suporte para esta sintaxe de substituição explícita de tipos gerenciados|
|C3649 de erro do compilador|Esta sintaxe de substituição explícita não é permitida com /ZW|
...
|C3690 de erro do compilador|esperada uma cadeia de caracteres literal, mas encontrou uma cadeia de caracteres definida pelo usuário literal em vez disso|
...
|[Erro do compilador C3743](compiler-error-c3743.md)|pode apenas usar hook/unhook uma interface inteira quando o parâmetro ' layout_dependent ' de event_receiver é verdadeiro|
|[Erro do compilador C3744](compiler-error-c3744.md)|unhook deve ter pelo menos 3 argumentos para eventos managed|
...
|[Erro do compilador C3832](compiler-error-c3832.md)|'*typelib*': biblioteca de tipos parece como se ele foi criado para ponteiros 32-bit; altere o qualificador 'ptrsize'|
|[Erro do compilador C3833](compiler-error-c3833.md)|'*tipo*': tipo de destino inválido para *identificador*|
|[Erro do compilador C3834](compiler-error-c3834.md)|conversão explícita inválida para um ponteiro de fixação; Use uma variável local fixada em vez disso|
|C3835 de erro do compilador|Obsoleto.|
|[Erro do compilador C3836](compiler-error-c3836.md)|um construtor estático não pode ter uma lista de inicializador de membro|
...
|[Erro do compilador C3853](compiler-error-c3853.md)|'=': reinicializar uma referência ou atribuir através de uma referência à função é inválido|
...
|[Erro do compilador C3869](compiler-error-c3869.md)|restrição gcnew está faltando a lista de parâmetros vazia '()'|
...
|[Erro do compilador C3920](compiler-error-c3920.md)|'*operador*': não é possível definir um operador CLR/WinRT chamando o sufixo de incremento/decremento do sufixo CLR/WinRT operador chamará o prefixo correspondente CLR/WinRT mas do operador (op_Increment/op_Decrement), com o sufixo semântica|
...
|C3927 de erro do compilador|'->': tipo de retorno à direita não é permitido após um Declarador de não-função|
...
|C3934 de erro do compilador|uma função que é de qualquer forma de 'main' não pode ter especificadores de restrição diferentes de Restrict (CPU)|
...
|C3937 de erro do compilador|especificador de restrição vazia não é permitido|
...
|C3949 de erro do compilador|um pacote de expansão, '...', não pode aparecer em um declarador abstrato com parênteses|
...
|C3963 de erro do compilador|Não há suporte para matrizes multidimensionais|
