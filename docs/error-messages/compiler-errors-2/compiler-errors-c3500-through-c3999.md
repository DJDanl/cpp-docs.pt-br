---
title: Erros de compilador C3500 a c3999 | Microsoft Docs
ms.date: 11/17/2017
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "42543068"
---
# <a name="compiler-errors-c3500-through-c3999"></a>Erros de compilador C3500 a c3999
...
|Erro|Mensagem|
|-----------|-------------|
|[Erro do compilador C3500](compiler-error-c3500.md)|ProgID inválido '*progid*'|
|[Erro do compilador C3501](compiler-error-c3501.md)|Não há há typelib registrado para ProgID '*progid*'|
|C3502 de erro do compilador|não é possível obter LIBID para ProgID '*progid*'|
|C3503 de erro do compilador|caractere ' 0 x*valor*' não é permitido em uma cadeia de caracteres bruta literal|
|C3504 de erro do compilador|não é possível criar o GUID da cadeia de caracteres '*cadeia de caracteres*'|
|[Erro do compilador C3505](compiler-error-c3505.md)|não é possível carregar a biblioteca de tipos '*biblioteca*'|
|[Erro do compilador C3506](compiler-error-c3506.md)|Não há há typelib registrado para LIBID '*biblioteca*'|
|[Erro do compilador C3507](compiler-error-c3507.md)|um ProgID pode ter não mais de 39 caracteres*progid*'; nem conter pontuações além de '.'; nem começar com um dígito|
|[Erro do compilador C3508](compiler-error-c3508.md)|'*tipo*': não é um tipo válido de automação|
|[Erro do compilador C3509](compiler-error-c3509.md)|'*tipo*': inválido, tipo de retorno de automação; quando um parâmetro é marcado como 'retval', o tipo de retorno deve ser 'void', 'HRESULT' ou 'SCODE'|
|[Erro do compilador C3510](compiler-error-c3510.md)|não é possível localizar a biblioteca de tipos dependente *biblioteca*|
|C3511 de erro do compilador|'*identificador*': uma chamada para um construtor de delegação deverá ser o único inicializador de membro|
|C3512 de erro do compilador|a sequência de caracteres de delimitação para uma cadeia de caracteres bruta literal deve ter não mais de 16 caracteres|
|C3513 de erro do compilador|'*cadeia de caracteres*': sem suporte caractere delimitador de literal de cadeia de caracteres bruta|
|C3514 de erro do compilador|'*caractere*' (*valor*): sem suporte caractere delimitador de literal de cadeia de caracteres bruta|
|C3515 de erro do compilador|Se um argumento para uma especialização parcial de modelo de classe é uma expansão de pacote, ele deverá ser o último argumento|
|C3516 de erro do compilador|fim-de-arquivo inesperado encontrado durante o processamento de cadeia de caracteres bruta literal; sequência de delimitador '*cadeia de caracteres*' não foi correspondida|
|C3517 de erro do compilador|'*identificador*' uma declaração de alias não pode ter um tipo que contenha 'auto'|
|C3518 de erro do compilador|'*identificador*': em um contexto direct-list-initialization o tipo para '*tipo*' só pode ser deduzido de uma expressão de inicializador único|
|[Erro do compilador C3519](compiler-error-c3519.md)|'*parâmetro*': parâmetro inválido para atributo embedded_idl|
|C3520 de erro do compilador|'*identificador*': o pacote de parâmetro deve ser expandido nesse contexto|
|C3521 de erro do compilador|'*identificador*' não é um pacote de parâmetros|
|C3522 de erro do compilador|'*tipo*': pacote de parâmetros não pode ser expandido nesse contexto|
|C3523 de erro do compilador|'sizeof...' requer, como seu argumento, um pacote de parâmetro não expandido|
|C3524 de erro do compilador|'*identificador*': 'sizeof' não pode ser aplicado a um pacote de parâmetros. Você pretendia usar 'sizeof...'?|
|C3525 de erro do compilador|'*parâmetro*': se um modelo de classe tem um pacote de parâmetros de modelo que ele deve aparecer no final da lista de parâmetros de modelo|
|C3526 de erro do compilador|'...' não pode ser aplicado a 'this'|
|C3527 de erro do compilador|'*identificador*' não é um operando válido para 'sizeof...'. Você pretendia usar 'sizeof'?|
|C3528 de erro do compilador|'*identifier1*': o número de elementos nessa expansão de pacote não coincide com o número de elementos em '*identifier2*'|
|C3529 de erro do compilador|'*parâmetro*': um pacote de parâmetros de modelo não pode ter um argumento padrão|
...
|C3534 de erro do compilador|Obsoleto.|
...
|C3546 de erro do compilador|'...': não há nenhum pacote de parâmetro disponível para expandir|
...
|C3559 de erro do compilador|chamada recursiva para '*função*': recursão é detectada ao compilar o grafo de chamada para o Concurrency:: parallel_for_each em: '*função*'|
|C3560 de erro do compilador|'*função*': IL não está disponível quando compilar o grafo de chamada para o Concurrency:: parallel_for_each em: '*função*'|
|C3561 de erro do compilador|bloco de operação de barreira encontrada no fluxo de controle que não é uniforme de bloco ao compilar o grafo de chamada para o Concurrency:: parallel_for_each em: '*função*'|
|C3562 de erro do compilador|função intrínseca '*função*' é limitado a não têm mais de *número* parâmetros|
|C3563 de erro do compilador|Loop infinito detectado ao compilar o grafo de chamada para o Concurrency:: parallel_for_each em: '*função*'|
|C3564 de erro do compilador|ler o valor não inicializado ao compilar o grafo de chamada para o Concurrency:: parallel_for_each em: '*função*'|
|C3565 de erro do compilador|A quantidade total de memória tile_static (*número* bytes) excede o limite de *número* bytes ao compilar o grafo de chamada para o Concurrency:: parallel_for_each|
...
|C3567 de erro do compilador|divisão ou mod por zero detectado ao compilar o grafo de chamada para o Concurrency:: parallel_for_each em: '*função*'|
|C3568 de erro do compilador|a soma de registradores excede o limite de *número* ao compilar o grafo de chamada para o Concurrency:: parallel_for_each. Simplifique seu programa|
|C3569 de erro do compilador|detectada ao compilar o grafo de chamada para o Concurrency:: parallel_for_each em condição de corrida: '*função*'|
|C3570 de erro do compilador|uso ilegal de amp restrito escopo ao compilar com /clr|
...
|C3573 de erro do compilador|O número de instâncias de concurrency::graphics::sampler passado para Concurrency:: parallel_for_each não pode exceder *número*|
|C3574 de erro do compilador|'*tipo*': extensões ladrilho ilegais: deve ser positivo e (1) Z < = *número*; (2) Z*Y*X < = *número*|
...
|C3579 de erro do compilador|O número de instâncias de somente leitura de Concurrency:: array e concurrency::graphics::texture passado para Concurrency:: parallel_for_each não pode exceder *número*|
|C3580 de erro do compilador|O número de instâncias graváveis de Concurrency:: array e concurrency::graphics::texture passado para Concurrency:: parallel_for_each não pode exceder *número*|
...
|C3584 de erro do compilador|sem suporte para uso de tile_static em '*identificador*'|
|C3585 de erro do compilador|'*identificador*' tem classe de armazenamento sem suporte no amp código restrito|
|C3586 de erro do compilador|'*identificador*': não usar variáveis globais ou estáticas é suportado no código de amp restringido|
|C3587 de erro do compilador|dynamic_cast não é suportado no código de amp restringido|
|C3588 de erro do compilador|conversão de '*type1*'para'*type2*' não é suportado no código de amp restringido|
|C3589 de erro do compilador|'*cadeia de caracteres*': código de uso sem suporte de literais de cadeia de caracteres no amp restrito|
|C3590 de erro do compilador|'*token*': captura por referência específica ou 'this' não é suportado se a lambda tiver amp restringido|
|C3591 de erro do compilador|operador TypeId não é suportado no código de amp restringido|
|C3592 de erro do compilador|Assembly nativo do embutido ( ASM') não é suportado no código de amp restringido|
|C3593 de erro do compilador|'goto' não é suportado no código de amp restringido|
|C3594 de erro do compilador|(try, catch, throw etc.) de manipulação de exceção não é suportada no código de amp restringido|
|C3595 de erro do compilador|valor constante está fora do intervalo suportado no código de amp restringido|
...
|C3597 de erro do compilador|'*parâmetro*': '*identificador*' não pode ser capturado por valor, se a lambda tiver amp restringido|
|C3598 de erro do compilador|declaração de rótulo não é suportada no código de amp restringido|
|C3599 de erro do compilador|'*operador*': não é possível executar a aritmética de ponteiro em ponteiro para bool em código de amp restringido|
|C3600 de erro do compilador|'*função*': uso de lado a lado\_memória estática detectada ao compilar o grafo de chamada para o concurrency::parallel não lado a lado\_for_each em: '*função*'|
|C3601 de erro do compilador|'*tipo*': é o tipo de argumento inválido para diagnóstico amp da função '*função*'|
|C3602 de erro do compilador|Sem suporte a fluxo de controle detectado ao compilar o grafo de chamada para o Concurrency:: parallel_for_each em: '*função*'|
...
|C3605 de erro do compilador|O número total de amostras (*número* capturados e *número* predefinido) exceder *número* ao compilar o grafo de chamada para o Concurrency:: parallel_for_each em: ' *função*'|
...
|C3647 de erro do compilador|Obsoleto.|
...
|C3649 de erro do compilador|Essa sintaxe de substituição explícita não é permitida com /ZW|
...
|C3660 de erro do compilador|'*member1*': oculta o membro herdado '*membro2*'|
...
|C3674 de erro do compilador|não foi possível encontrar o módulo de biblioteca padrão '*módulo*'|
...
|C3677 de erro do compilador|literal de cadeia após 'operator' não pode ter um prefixo de codificação|
...
|C3680 de erro do compilador|não é possível concatenar literais de cadeia de caracteres definida pelo usuário com identificadores de sufixos literais incompatíveis|
|C3681 de erro do compilador|'fallthrough': atributo só pode aparecer em uma instrução switch da delimitação|
|C3682 de erro do compilador|' operador *identificador*': modelo de operador de operador literal/literal não pode ser declarado para ter "C linkage"|
...
|C3684 de erro do compilador|' operador *identificador*': declaração do operador literal tem uma lista de parâmetro inválido|
|C3685 de erro do compilador|' operador *identificador*': modelo de operador literal não pode ter parâmetros de função|
|C3686 de erro do compilador|' operador *identificador*': modelo de operador literal deve ter exatamente um parâmetro de modelo que é um pacote de parâmetros|
|C3687 de erro do compilador|' operador *identificador*': modelo de operador literal deve ter um parâmetro de modelo sem tipo do tipo 'char'|
|C3688 de erro do compilador|sufixo literal inválido '*sufixo*'; literal operador ou o modelo de operador literal ' operador *identificador*' não encontrado|
...
|C3690 de erro do compilador|esperada uma cadeia de caracteres literal, mas encontrada uma cadeia de caracteres definida pelo usuário literal em vez disso|
...
|[Erro do compilador C3712](compiler-error-c3712.md)|'*event_handler*': um método de manipulador de eventos deve retornar o mesmo tipo como a origem '*evento*'|
...
|C3758 de erro do compilador|'*membro*': função virtual não pode ser declarada 'constexpr'|
|C3759 de erro do compilador|'*membro*': função de membro de tipo não literal não pode ser declarada 'constexpr'|
|C3760 de erro do compilador|. use a palavra-chave de Property para declarar propriedade em/WinRT gerenciados '*classe*'|
...
|C3776 de erro do compilador|não é possível retornar uma expressão do tipo void em uma corrotina com tipo de retorno eventual non-void|
...
|C3781 de erro do compilador|'*palavra-chave*': não pode ser usado em uma corrotina do tipo '*tipo*'. Qualquer um dos *palavra-chave* ou *palavra-chave* devem estar presentes no promise_type associado|
|C3782 de erro do compilador|*tipo de*: uma promessa de corrotina não pode conter ambos *palavra-chave* e *palavra-chave*|
...
|C3795 de erro do compilador|Obsoleto.|
...
|C3827 de erro do compilador|atributo padrão 'deprecated' pode ter nenhum argumento ou uma cadeia de caracteres literal que descreve o motivo|
...
|C3843 de erro do compilador|'*identificador*': não há suporte para qualificadores de referência em funções de membro de tipos gerenciados/WinRT|
...
|[Erro do compilador C3860](compiler-error-c3860.md)|lista de argumentos de modelo/genérico após o nome da classe de modelo/genérico deve listar parâmetros na ordem usada na lista de parâmetros de modelo/genérico|
...
|C3875 de erro do compilador|chamada de função de membro não estático faltando lista de argumentos|
...
|C3881 de erro do compilador|só pode herdar o construtor de base direta|
...
|C3905 de erro do compilador|acessos não alinhados não têm suporte para tipo intrínseco '*tipo*'|
|C3906 de erro do compilador|tipo intrínseco '*tipo*' não é um tipo de argumento ou retorno com suporte para funções vararg ou unprototyped|
...
|C3924 de erro do compilador|Erro em argumento #*número* de chamada do construtor delegate '*construtor*':|
|C3925 de erro do compilador|esperado um loop (para, enquanto ou faça) seguir '*diretiva*' diretiva|
|C3926 de erro do compilador|constante inválida na diretiva 'parallel'|
|C3927 de erro do compilador|'->': tipo de retorno à direita não é permitido após um Declarador de função não|
|C3928 de erro do compilador|'->': tipo de retorno à direita não é permitido após um declarador entre parênteses|
|C3929 de erro do compilador|Obsoleto.|
|C3930 de erro do compilador|'*função*': nenhuma função sobrecarregada tem especificadores de restrição que são compatíveis com o contexto do ambiente '*contexto*'|
...
|C3933 de erro do compilador|'*classe*': especificadores de restrição do destruidor devem cobrir a união das restrições de todos os construtores|
...
|C3940 de erro do compilador|'*identificador*': identificador não encontrado - possível incompatibilidade entre versões de biblioteca e compilador. Verifique se a correspondência vccorlib.h/.lib, vccorlib120.dll e c1xx.dll|
|C3941 de erro do compilador|'*condição*': requer ' / clr' opção de linha de comando|
|C3942 de erro do compilador|Obsoleto.|
|C3943 de erro do compilador|Obsoleto.|
...
|C3947 de erro do compilador|'*typeid*': typeid não pode ser aplicado a uma expansão de pacote|
|C3948 de erro do compilador|'*palavra-chave*': uma expansão de pacote não pode aparecer neste contexto|
|C3949 de erro do compilador|uma expansão de pacote, '...', não pode aparecer em um declarador abstrato de entre parênteses|
|C3950 de erro do compilador|Obsoleto.|
|C3951 de erro do compilador|Não é possível usar o ponteiro para membro no tipo de WinRT projetado '*tipo*'. Use um delegado em vez disso.|
|C3952 de erro do compilador|'*tipo*': WinRT não oferece suporte a matrizes ' in/out'. Use ' const Array<T>^' para 'in' e ' WriteOnlyArray<T>' ou ' matriz<T>^ *' para 'out' nas APIs públicas|
...
|C3957 de erro do compilador|'*tipo*': não é possível usar o tipo 'new' em um WinRT; use 'ref new' em vez disso|
...
|C3961 de erro do compilador|Não há suporte para o construtor estático|
|C3962 de erro do compilador|Não há suporte para a classe genérica|
|C3963 de erro do compilador|Não há suporte para a matriz multidimensional|
|C3964 de erro do compilador|Não há suporte para a matriz denteada|
|C3965 de erro do compilador|Não há suporte para a matriz de parâmetros|
...
|C3968 de erro do compilador|o token '*token*' não é válido como o separador de nome de módulo; use ponto ('. ') em vez disso|
...
|C3980 de erro do compilador|'*tipo*' não pode ser emitido nos metadados|
|C3981 de erro do compilador|'*tipo*': um tipo de valor não pode ter quaisquer membros de dados estáticos*identificador*'|
|C3982 de erro do compilador|'*tipo*': um tipo de valor não pode ter quaisquer dos membros de dados não públicos*identificador*'|
|C3983 de erro do compilador|'*tipo*': um tipo de valor não pode ter quaisquer membros sem dados públicos*identificador*'|
|C3984 de erro do compilador|'*tipo*': um tipo sem valor não pode ter quaisquer membros de dados públicos*identificador*'|
...
|C3994 de erro do compilador|'*tipo*': um tipo de valor não é possível implementar interfaces ou ter funções virtuais|
...
|C3998 de erro do compilador|' c + +*versão*': não há suporte para C++ versão; Padronizando para ' c + +*versão*'|
|C3999 de erro do compilador|Erro desconhecido, escolha o comando de suporte técnico no menu Ajuda do Visual C++, ou abra o arquivo de Ajuda do suporte técnico para obter mais informações|
