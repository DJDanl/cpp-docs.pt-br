...
|C3512 de erro do compilador|a sequência de caracteres de delimitação para um literal de cadeia de caracteres bruto deverá ter até 16 caracteres|  
...
|C3515 de erro do compilador|se um argumento para uma especialização parcial de template de classe for uma expansão de pacote, ele deverá ser o último argumento|  
...
|[Erro do compilador C3869](compiler-error-c3869.md)|faltando lista de parâmetros vazia '()' na restrição gcnew|  
