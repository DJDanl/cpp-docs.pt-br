---
title: Erro do compilador C3833
ms.date: 11/04/2016
f1_keywords:
- C3833
helpviewer_keywords:
...
ms.locfileid: "62390497"
---
# <a name="compiler-error-c3833"></a>Erro do compilador C3833

'type': tipo de destino inválido para pointer_type

Uma [interior_ptr](../../extensions/interior-ptr-cpp-cli.md) ou [pin_ptr](../../extensions/pin-ptr-cpp-cli.md) foi declarada incorretamente.
