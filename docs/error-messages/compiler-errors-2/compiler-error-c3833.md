...
ms.locfileid: "46103250"
---
# <a name="compiler-error-c3833"></a>Erro do compilador C3833

'type': tipo de destino inválido para pointer_type

Uma [interior_ptr](../../windows/interior-ptr-cpp-cli.md) ou [pin_ptr](../../windows/pin-ptr-cpp-cli.md) foi declarada incorretamente.
