---
title: Erros de compilador C3400 a C3499
ms.date: 11/17/2017
f1_keywords:
- C3401
- C3402
...
ms.locfileid: "50576716"
---
# <a name="compiler-errors-c3400-through-c3499"></a>Erros de compilador C3400 a C3499
...
|C3410 de erro do compilador|'*identificador*': o tipo de instanciação explícito '*tipo*'não coincide com o tipo de modelo de variável'*tipo*'|
|C3411 de erro do compilador|'*tipo*' não é válido como o tamanho de uma matriz como não é um tipo de inteiro|
...
|C3424 de erro do compilador|'*tipo*': não é permitido um estilo de função convertido para um tipo de matriz|
...
|C3442 de erro do compilador|Inicializando vários membros de união: '*member1*'e'*membro2*'|
|C3443 de erro do compilador|O inicializador de membro padrão para '*classe*' é recursivo|
...
|C3471 de erro do compilador|novo nome do módulo *nome* (definido na linha de comando) está em conflito com o nome anterior *nome*|
...
|C3473 de erro do compilador|Nenhum nome de módulo ou nome de caminho de saída especificado.|
...
|C3476 de erro do compilador|não foi possível abrir o arquivo '*filename*' para a entrada|
...
|C3497 de erro do compilador|não é possível construir uma instância de uma lambda|
