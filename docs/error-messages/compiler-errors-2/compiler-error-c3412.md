---
title: C3412 de erro do compilador | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
ms.openlocfilehash: 52ec139061991382bb96e92f9ef0cd2aafdb7f94
ms.lasthandoff: 02/25/2017

---
# <a name="compiler-error-c3412"></a>C3412 de erro do compilador
'template': não é possível specialize modelo no escopo atual  
