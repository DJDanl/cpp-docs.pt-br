...
manager: "ghogen"
---
# Erro do Compilador C3834
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

conversão explícita ilegal a um ponteiro fixando\-se; use uma variável local fixado em vez de  
  
 As conversões explícitas a um ponteiro fixada não são permitidas.  
  
## Exemplo  
 O exemplo a seguir produz C3834.  
