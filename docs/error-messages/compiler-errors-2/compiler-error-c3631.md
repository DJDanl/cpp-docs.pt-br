...
manager: "ghogen"
---
# Erro do Compilador C3631
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

'function': não é possível sobrecarga gerenciado ou eventos do WinRT  
  
 Um gerenciado ou WinRT eventos não podem ser sobrecarregados.  
  
## Exemplo  
 C3631 só está acessível com **\/clr:oldSyntax**.  
  
 O exemplo a seguir gera C3631.  
