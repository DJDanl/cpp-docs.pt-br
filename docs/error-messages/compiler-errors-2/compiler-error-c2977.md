...
ms.locfileid: "74751671"
---
# <a name="compiler-error-c2977"></a>Erro do compilador C2977

' identifier ': muitos argumentos de tipo

Um Generic ou template tem muitos argumentos reais. Verifique a declaração genérica ou de modelo para localizar o número correto de parâmetros.
