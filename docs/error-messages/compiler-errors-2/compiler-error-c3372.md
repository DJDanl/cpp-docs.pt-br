---
title: Erro do compilador C3372 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "46062625"
---
# <a name="compiler-error-c3372"></a>Erro do compilador C3372

deve especificar pelo menos 1 interface para atributo 'source' em uma coclass
