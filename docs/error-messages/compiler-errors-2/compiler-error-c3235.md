...
ms.locfileid: "33252239"
---
# <a name="compiler-error-c3235"></a>C3235 de erro do compilador
'especialização': especialização explícita ou parcial de uma classe genérica não é permitida  
