...
ms.locfileid: "74750098"
---
# <a name="compiler-error-c2932"></a>Erro do compilador C2932

' class ': tipo-classe-ID redefinido como um membro de dados de ' identifier '

Você não pode usar uma classe genérica ou de modelo como um membro de dados.
