---
title: Erro do compilador C3396 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "46047441"
---
# <a name="compiler-error-c3396"></a>Erro do compilador C3396

'attribute': atributo personalizado não encontrado em 'namespace'

C3396 indica que você não estiver usando um runtime de linguagem comum atualizado.  Reinstale o CLR para resolver.