---
title: C3743 de erro do compilador | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
só é possível usar hook/unhook em uma interface inteira quando o parâmetro 'layout_dependent' de event_receiver é definido como true  
