---
title: C2827 de erro do compilador | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="compiler-error-c2827"></a>C2827 de erro do compilador
'operador' não pode ser substituída com formulário unário globalmente  
