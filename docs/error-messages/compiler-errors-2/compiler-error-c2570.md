...
ms.locfileid: "74755506"
---
# <a name="compiler-error-c2570"></a>Erro do compilador C2570

' identifier ': Union não pode possuir classes base

Uma União deriva de uma classe, estrutura ou União. Isso não é permitido. Declare o tipo derivado como uma classe ou estrutura em vez disso.
