---
title: C3140 de erro do compilador | Microsoft Docs
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="compiler-error-c3140"></a>C3140 de erro do compilador
não é possível ter vários atributos de 'module' na mesma unidade de compilação  
