---
title: C2902 de erro do compilador | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33245421"
---
# <a name="compiler-error-c2902"></a>C2902 de erro do compilador
'token': seguir token inesperado 'template', identificador esperado  
