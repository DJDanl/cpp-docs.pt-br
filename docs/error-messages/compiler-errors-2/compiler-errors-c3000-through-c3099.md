...
---
# <a name="compiler-errors-c3000-through-c3099"></a>C3000 de erros do compilador por meio de C3099
...
|[Erro do compilador C3015](compiler-error-c3015.md)|inicialização em instrução de OpenMP 'for' possui forma inadequada|  
...
|[Erro do compilador C3017](compiler-error-c3017.md)|teste de encerramento em instrução de OpenMP 'for' possui forma inadequada|  
...
|[Erro do compilador C3019](compiler-error-c3019.md)|incremento em instrução de OpenMP 'for' possui forma inadequada|  
...
|[Erro do compilador C3024](compiler-error-c3024.md)|'schedule(runtime)': expressão de chunk_size não é permitida|  
...
|[Erro do compilador C3035](compiler-error-c3035.md)|diretiva de OpenMP 'ordered' deve ligar-se diretamente a uma diretiva 'for' ou 'parallel for' com a cláusula 'ordered'|  
...
|[Erro do compilador C3043](compiler-error-c3043.md)|diretiva de OpenMP 'critical' não pode ser aninhada em diretiva 'critical' com mesmo nome|  
...
|[Erro do compilador C3047](compiler-error-c3047.md)|Bloco estruturado em uma região de OpenMP 'sections' deve ser precedido por '#pragma omp section'|  
...
|[Erro do compilador C3054](compiler-error-c3054.md)|'#pragma omp parallel' não é suportado atualmente em uma classe ou função de generic|  
...
|C3061 de erro do compilador|operador '*operador*': não é permitido em enumeração '*tipo*'com o tipo subjacente'*tipo*'|  
...
|[Erro do compilador C3066](compiler-error-c3066.md)|há várias maneiras de um objeto deste tipo pode ser chamado com estes argumentos|  
...
|C3074 de erro do compilador|não é possível inicializar uma matriz com um inicializador entre parênteses|  
...
|C3079 de erro do compilador|não é possível usar uma lista de inicializadores como operando direito deste operador de atribuição|  
