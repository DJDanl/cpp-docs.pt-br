...
ms.locfileid: "33253873"
---
# <a name="compiler-error-c3360"></a>C3360 de erro do compilador
'string': não é possível criar nome  
  
 O valor passado para o [uuid](../../windows/uuid-cpp-attributes.md) atributo não era válido.  
