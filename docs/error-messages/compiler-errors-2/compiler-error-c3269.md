---
title: C3269 de erro do compilador | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Gerenciado e funções de membro de classe do WinRT não podem declarar listas de parâmetros de comprimento variável.  
