---
title: Erro do compilador C3025 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "46115054"
---
# <a name="compiler-error-c3025"></a>Erro do compilador C3025

'cláusula': expressão integral esperada

Uma cláusula requer uma expressão de inteiro, mas recebeu uma expressão de não inteiro.
