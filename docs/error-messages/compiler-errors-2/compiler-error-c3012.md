---
title: C3012 de erro do compilador | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
'intrínseco': função intrínseca, não é permitida dentro de uma região paralela  
 ...
 A [intrínsecos do compilador](../../intrinsics/compiler-intrinsics.md) função não é permitida em um `omp``parallel` região.  
