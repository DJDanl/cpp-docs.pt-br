---
title: C2603 de erro do compilador | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
'function': objetos estáticos do muitos escopo de bloco com construtor/destruidores na função  
  
 Há um limite de 31 para o número de objetos estáticos, que você pode ter em uma função embutida visível externamente.  
  
 O código a seguir gera C2603:  
