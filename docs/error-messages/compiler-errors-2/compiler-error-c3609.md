...
ms.locfileid: "74755948"
---
# <a name="compiler-error-c3609"></a>Erro do compilador C3609

' member ': uma função sealed ou final deve ser virtual

As palavras-chave [sealed](../../extensions/sealed-cpp-component-extensions.md) e [final](../../cpp/final-specifier.md) são permitidas somente em uma classe, struct ou função de membro marcada `virtual`.
