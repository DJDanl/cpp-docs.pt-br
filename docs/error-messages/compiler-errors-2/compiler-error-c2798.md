...
ms.locfileid: "74739189"
---
# <a name="compiler-error-c2798"></a>Erro do compilador C2798

' super:: member ' é ambíguo

Várias estruturas herdadas contêm o membro que você referenciou com [super](../../cpp/super.md). Você pode corrigir o erro de uma das opções:
