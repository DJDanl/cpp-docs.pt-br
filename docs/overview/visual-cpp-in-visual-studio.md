...
> [!NOTE]
> Esta documentação para desenvolvedores aplica-se ao Visual Studio 2015 e versões posteriores. Para ver a documentação da sua versão preferida do Visual Studio, use o controle seletor de **versão** . Ele é encontrado na parte superior do Sumário nesta página.
>
> Se você estiver procurando um pacote redistribuível do Visual C++ para executar um programa, acesse o [Centro de Download da Microsoft](https://www.microsoft.com/download/) e insira **Visual C++** na caixa de pesquisa.
...
[O que há de novo para C++ no Visual Studio](what-s-new-for-visual-cpp-in-visual-studio.md)<br/>
...
[Tabela de conformidade da linguagem Microsoft C++](visual-cpp-language-conformance.md)<br/>
...
Baixe o Visual Studio 2017 ou o Visual Studio 2019 e instale o conjunto de ferramentas do Visual C++.
...
[Amostras do Visual Studio C++](visual-cpp-samples.md)<br/>
...
[Projetos e sistemas de compilação](../build/projects-and-build-systems-cpp.md)<br/>
...
[Aplicativos universais do Windows (C++)](../cppcx/universal-windows-apps-cpp.md)<br/>
...
[Programação para Linux](../linux/index.yml)<br/>
...
[Como relatar um problema com o conjunto de ferramentas Visual C++](how-to-report-a-problem-with-the-visual-cpp-toolset.md)<br/>
