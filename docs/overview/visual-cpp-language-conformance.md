...
| &nbsp;&nbsp;[`P0811R3 midpoint(), lerp()`](https://wg21.link/P0811R3) | Parcial no VS 2019 16,3, concluído em 16,8 <sup> [20](#note_20)</sup> |
...
| &nbsp;&nbsp;[`P0784R7 Library support for more constexpr containers`](https://wg21.link/P0784R7) | Parcial no VS 2019 16,7 <sup> [20](#note_20)</sup> |
| &nbsp;&nbsp;[`P0896R4 <ranges>`](https://wg21.link/P0896R4) | Parcial no VS 2019 16,8 <sup> [20](#note_20)</sup> |
...
| &nbsp;&nbsp;[`P1614R2 Adding Spaceship <=> To The Library`](https://wg21.link/P1614R2) | Parcial no VS 2019 16,7 <sup> [20](#note_20)</sup> |
...
__VS 2019 16,8__ indica recursos com suporte no Visual Studio 2019 versão 16,8.
