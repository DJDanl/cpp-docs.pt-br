...
description: Tabela de atualizações de conformidade do Microsoft C++ pela versão do Visual Studio.
ms.date: 08/05/2020
...
ms.locfileid: "87807804"
---
# <a name="microsoft-c-language-conformance-table"></a>Tabela de conformidade com a linguagem Microsoft C++

Conformidade com padrões para o compilador do Microsoft C++ no Visual Studio (MSVC) é um trabalho em andamento. Aqui está um resumo de nossa linguagem ISO padrão do C++ e a conformidade da biblioteca pela versão do Visual Studio. Cada compilador e nome de recurso de biblioteca padrão são links para o documento de proposta de C++ padrão ISO que descreve o recurso, se houver um disponível no momento da publicação. A coluna **com suporte** lista a versão do Visual Studio na qual o suporte para o recurso apareceu pela primeira vez.

Para obter detalhes sobre os aprimoramentos de conformidade do Visual Studio 2017 ou do Visual Studio 2019 MSVC, consulte [melhorias de conformidade do C++ no Visual Studio](cpp-conformance-improvements.md). Para obter uma lista de outras alterações, consulte [What ' s New for Visual C++ in Visual Studio](what-s-new-for-visual-cpp-in-visual-studio.md). Para alterações de compatibilidade em versões anteriores, consulte [Histórico de alterações do Visual C++](../porting/visual-cpp-change-history-2003-2015.md) e [Novidades do Visual C++ de 2003 a 2015](../porting/visual-cpp-what-s-new-2003-through-2015.md). Para saber mais sobre as últimas notícias da equipe do C++, visite o [blog da equipe do C++](https://devblogs.microsoft.com/cppblog/).

> [!NOTE]
> Não há alterações da falha do binário entre o Visual Studio 2015, Visual Studio 2017 e Visual Studio 2019. Para obter mais informações, consulte [compatibilidade binária de C++ entre o Visual Studio 2015, 2017 e 2019](../porting/binary-compat-2015-2017.md)

## <a name="compiler-features"></a>Recursos do compilador

| Recurso | Suporte |
|--|--|
| __Recursos de linguagem principal do c++ 03/11__ | __Com suporte__ |
...
| &nbsp;&nbsp;[`N1653 C99 preprocessor`](https://wg21.link/N1653) | Parcial <sup> [C](#note_C)</sup> |
| __Recursos de linguagem principal do c++ 14__ | __Com suporte__ |
...
| __Recursos de linguagem principal do c++ 17__ | __Com suporte__ |
...
| __Recursos de linguagem principal do c++ 17 (relatórios de defeito)__ | __Com suporte__ |
...
| &nbsp;&nbsp;[`P0929R2 Checking for abstract class types`](https://wg21.link/P0929R2) | Não |
| &nbsp;&nbsp;[`P0962R2 Relaxing the range-for loop customization point finding rules`](https://wg21.link/p0962r1) | Não |
| &nbsp;&nbsp;[`P0859R0 CWG 1581: When are constexpr member functions defined`](https://wg21.link/p0859r0) | Não |
| &nbsp;&nbsp;[`P1009R2 Array size deduction in new-expressions`](https://wg21.link/P1009R2) | Não |
| &nbsp;&nbsp;[`P1286R2 Contra CWG DR1778`](https://wg21.link/P1286R2) | Não |
| __Recursos de linguagem principal do c++ 20__ | __Com suporte__ |
...
| &nbsp;&nbsp;[`P0641R2 const mismatch with defaulted copy constructor`](https://wg21.link/P0641R2) | Parcial |
| &nbsp;&nbsp;[`P0912R5 Coroutines`](https://wg21.link/P0912R5) | Parcial |
| &nbsp;&nbsp;[`P1103R3 Modules`](https://wg21.link/P1103R3) | Parcial |
| &nbsp;&nbsp;[`P1141R2 Yet another approach for constrained declarations`](https://wg21.link/P1141R2) | Parcial |
| &nbsp;&nbsp;[`P0315R4 Allowing lambdas in unevaluated contexts`](https://wg21.link/P0315R4) | Não |
| &nbsp;&nbsp;[`P0388R4 Permit conversions to arrays of unknown bound`](https://wg21.link/P0388R4) | Não |
| &nbsp;&nbsp;[`P0466R5 Layout-compatibility and Pointer-interconvertibility Traits`](https://wg21.link/P0466R5) | Não |
| &nbsp;&nbsp;[`P0634R3 Down with typename!`](https://wg21.link/P0634R3) | Não |
| &nbsp;&nbsp;[`P0722R3 Efficient sized delete for variable sized classes`](https://wg21.link/P0722R3) | Não |
| &nbsp;&nbsp;[`P0735R1 Interaction of memory_order_consume with release sequences`](https://wg21.link/P0735R1) | Não |
| &nbsp;&nbsp;[`P0784R7 More constexpr containers`](https://wg21.link/P0784R7) | Não |
| &nbsp;&nbsp;[`P0840R2 [[no_unique_address]] attribute`](https://wg21.link/P0840R2) | Não |
| &nbsp;&nbsp;[`P0848R3 Conditionally trivial special member functions`](https://wg21.link/P0848R3) | Não |
| &nbsp;&nbsp;[`P0960R3 Allow initializing aggregates from a parenthesized list of values`](https://wg21.link/P0960R3) | Não |
| &nbsp;&nbsp;[`P1064R0 Allowing virtual function calls in constant expressions`](https://wg21.link/P1064R0) | Não |
| &nbsp;&nbsp;[`P1073R3 Immediate functions`](https://wg21.link/P1073R3) | Não |
| &nbsp;&nbsp;[`P1094R2 Nested inline namespaces`](https://wg21.link/P1094R2) | Não |
| &nbsp;&nbsp;[`P1143R2 constinit`](https://wg21.link/P1143R2) | Não |
| &nbsp;&nbsp;[`P1152R4 Deprecating volatile`](https://wg21.link/P1152R4) | Não |
| &nbsp;&nbsp;[`P1236R1 Signed integers are two's complement`](https://wg21.link/P1236R1) | Não |
| &nbsp;&nbsp;[`P1327R1 Allowing dynamic_cast, polymorphic typeid in constant expressions`](https://wg21.link/P1327R1) | Não |
| &nbsp;&nbsp;[`P1331R2 Permitting trivial default initialization in constexpr contexts`](https://wg21.link/P1331R2) | Não |
| &nbsp;&nbsp;[`P1353R0 Missing feature-test macros`](https://wg21.link/P1353R0) | Não |
| &nbsp;&nbsp;[`P1358R0 2310: Type completeness and derived-to-base pointer conversions`](https://wg21.link/P1358R0) | Não |
| &nbsp;&nbsp;[`P1381R1 Reference capture of structured bindings`](https://wg21.link/P1381R1) | Não |
| &nbsp;&nbsp;[`P1452R2 On the non-uniform semantics of return-type-requirements`](https://wg21.link/P1452R2) | Não |
| &nbsp;&nbsp;[`P1616R1 Using unconstrained TTPs with constrained templates`](https://wg21.link/P1616R1) | Não |
| &nbsp;&nbsp;[`P1668R1 Permitting unevaluated inline assembly in constexpr functions`](https://wg21.link/P1668R1) | Não |
| &nbsp;&nbsp;[`P1766R1 Mitigating minor modules maladies`](https://wg21.link/P1766R1) | Não |
| &nbsp;&nbsp;[`P1811R0 Relaxing redefinition restrictions for re-exportation robustness`](https://wg21.link/P1811R0) | Não |
| &nbsp;&nbsp;[`P1814R0 CTAD for alias templates`](https://wg21.link/P1814R0) | Não |
| &nbsp;&nbsp;[`P1816R0 CTAD for aggregates`](https://wg21.link/P1816R0) | Não |
| &nbsp;&nbsp;[`P1874R1 Dynamic Initialization Order of Non-Local Variables in Modules`](https://wg21.link/P1874R1) | Não |
| &nbsp;&nbsp;[`P1971R0 Core Changes for NB Comments at the Nov 2019 (Belfast) meeting`](https://wg21.link/P1971R0) | Não |
| &nbsp;&nbsp;[`P1971R0 US052: Non-executed return statements in coroutines`](https://wg21.link/P1971R0) | Não |
| &nbsp;&nbsp;[`P1972R0 US105 Check satisfaction of constraints for non-templates when forming pointer to function`](https://wg21.link/P1972R0) | Não |
| &nbsp;&nbsp;[`P1975R0 Fixing the wording of parenthesized aggregate-initialization`](https://wg21.link/P1975R0) | Não |
| &nbsp;&nbsp;[`P1979R0 Resolution to US086`](https://wg21.link/P1979R0) | Não |
| &nbsp;&nbsp;[`P1980R0 CA096: Declaration matching for non-dependent requires-clauses`](https://wg21.link/P1980R0) | Não |
| &nbsp;&nbsp;[`P2085R0 Consistent defaulted comparisons`](https://wg21.link/P2085R0) | Não |
| &nbsp;&nbsp;[`P2103R0 US033: Allow "import" inside linkage-specifications`](https://wg21.link/P2103R0) | Não |
| &nbsp;&nbsp;[`P2107R0 US064: Copy semantics of coroutine parameters`](https://wg21.link/P2107R0) | Não |

## <a name="standard-library-features"></a>Recursos da biblioteca padrão

Uma lista mais detalhada de recursos de biblioteca padrão e correções de bugs por versão do produto está disponível na página de [changelog do Microsoft STL wiki do GitHub](https://github.com/microsoft/STL/wiki/Changelog) .

| Recurso | Suporte |
|--|--|
| __Recursos de biblioteca padrão do c++ 20__ | __Com suporte__ |
...
| &nbsp;&nbsp;[`P0053R7 <syncstream>`](https://wg21.link/p0053r7)<br/>&nbsp;&nbsp;[`P0753R2 osyncstream Manipulators`](https://wg21.link/p0753r2) | Não |
| &nbsp;&nbsp;[`P0339R6 polymorphic_allocator<>`](https://wg21.link/P0339R6) | Não |
| &nbsp;&nbsp;[`P0355R7 <chrono> Calendars And Time Zones`](https://wg21.link/p0355r7) | Não |
| &nbsp;&nbsp;[`P0475R1 Guaranteed Copy Elision For Piecewise Construction`](https://wg21.link/P0475R1) | Não |
| &nbsp;&nbsp;[`P0528R3 Atomic Compare-And-Exchange With Padding Bits`](https://wg21.link/P0528R3) | Não |
| &nbsp;&nbsp;[`P0591R4 Utility Functions For Uses-Allocator Construction`](https://wg21.link/P0591R4) | Não |
| &nbsp;&nbsp;[`P0608R3 Improving variant's Converting Constructor/Assignment`](https://wg21.link/P0608R3) | Não |
| &nbsp;&nbsp;[`P0653R2 to_address()`](https://wg21.link/p0653r2) | Não |
| &nbsp;&nbsp;[`P0655R1 visit<R>()`](https://wg21.link/P0655R1) | Não |
| &nbsp;&nbsp;[`P0768R1 Library Support For The Spaceship Comparison Operator <=>`](https://wg21.link/p0768r1) | Não |
| &nbsp;&nbsp;[`P0811R3 midpoint(), lerp()`](https://wg21.link/P0811R3) | Não |
| &nbsp;&nbsp;[`P0896R4 <ranges\>`](https://wg21.link/P0896R4) | Não |
| &nbsp;&nbsp;[`P0912R5 Library Support For Coroutines`](https://wg21.link/P0912R5) | Não |
| &nbsp;&nbsp;[`P0920R2 Precalculated Hash Value Lookup`](https://wg21.link/P0920R2) | Não |
| &nbsp;&nbsp;[`P1001R2 execution::unseq`](https://wg21.link/P1001R2) | Não |
| &nbsp;&nbsp;[`P1007R3 assume_aligned()`](https://wg21.link/P1007R3) | Não |
| &nbsp;&nbsp;[`P1020R1 Smart Pointer Creation With Default Initialization`](https://wg21.link/P1020R1) | Não |
| &nbsp;&nbsp;[`P1032R1 Miscellaneous constexpr`](https://wg21.link/P1032R1) | Não |
| &nbsp;&nbsp;[`P1285R0 Improving Completeness Requirements For Type Traits`](https://wg21.link/P1285R0) | Não |
| __Recursos de biblioteca padrão do c++ 17__ | __Com suporte__ |
...
| __Recursos de biblioteca padrão do c++ 14__ | __Com suporte__ |
...
__VS 2019 16,6__ indica recursos com suporte no Visual Studio 2019 versão 16,6. \
__VS 2019 16,7__ indica recursos com suporte no Visual Studio 2019 versão 16,7.
...
<a name="note_14"></a>__14__ esses recursos do c++ 17/20 estão sempre habilitados, mesmo quando [`/std:c++14`](../build/reference/std-specify-language-standard-version.md) (o padrão) é especificado. O motivo é porque o recurso foi implementado antes da introdução das opções de **/std** ou porque a implementação condicional era indesejávelmente complexa.

<a name="note_17"></a>__17__ esses recursos são habilitados pela [`/std:c++17`](../build/reference/std-specify-language-standard-version.md) opção de [`/std:c++latest`](../build/reference/std-specify-language-standard-version.md) compilador (ou).

<a name="note_20"></a>__20__ esses recursos são habilitados pela [`/std:c++latest`](../build/reference/std-specify-language-standard-version.md) opção do compilador. Quando a implementação do C++ 20 for concluída, uma nova **`/std:c++20`** opção de compilador será adicionada, sob a qual esses recursos também estarão disponíveis.
...
- VS 2019 16,0: `to_chars()` sobrecargas de ponto flutuante para hexadecimal hexadecimal e precisão mais curto.
...
<a name ="note_parallel"></a>__paralelo__ A biblioteca de algoritmos paralelos do c++ 17 está concluída. Concluir não significa que todos os algoritmos são paralelizados em todos os casos. Os algoritmos mais importantes foram paralelizados e as assinaturas de política de execução são fornecidas até mesmo onde os algoritmos não são paralelizados. O cabeçalho interno central de nossa implementação, yvals_core. h, contém as seguintes "notas de algoritmos paralelos": o C++ permite uma implementação para implementar algoritmos paralelos como chamadas para os algoritmos de série. Essa implementação paraleliza várias chamadas de algoritmo comum, mas não todas.
...
[O que há de novo para Visual C++ no Visual Studio](what-s-new-for-visual-cpp-in-visual-studio.md)\
[Visual C++ histórico de alteração 2003 a 2015](../porting/visual-cpp-change-history-2003-2015.md)\
[Visual C++ as novidades de 2003 a 2015](../porting/visual-cpp-what-s-new-2003-through-2015.md)\
