...
[Como: converter a cadeia de caracteres padrão em System:: String](../dotnet/how-to-convert-standard-string-to-system-string.md)<br/>
[Como: converter System:: String para a cadeia de caracteres padrão](../dotnet/how-to-convert-system-string-to-standard-string.md)<br/>
[Como: converter System:: String para wchar_t * ou Char\*](../dotnet/how-to-convert-system-string-to-wchar-t-star-or-char-star.md)<br/>
