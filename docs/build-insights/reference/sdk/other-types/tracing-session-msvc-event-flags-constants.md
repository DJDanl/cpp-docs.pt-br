...
description: A C++ referência de constantes do SDK do insights do Build TRACING_SESSION_MSVC_EVENT_FLAGS.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
As constantes `TRACING_SESSION_MSVC_EVENT_FLAGS` são usadas para descrever quais eventos MSVC coletar durante um rastreamento. Use-os para inicializar o campo `MsvcEventFlags` da estrutura de [TRACING_SESSION_OPTIONS](tracing-session-options-struct.md) .
