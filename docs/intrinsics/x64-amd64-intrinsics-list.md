...
ms.locfileid: "65448582"
---
# <a name="x64-amd64-intrinsics-list"></a>x64 (amd64) lista de intrínsecos

Este documento lista os intrínsecos que o Microsoft C++ oferece suporte a compilador quando x64 (também chamado de amd64) é afetado.
...
|[_addcarry_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u32)||intrin.h|unsigned char _addcarry_u32 (unsigned char, unsigned int, int sem sinal, int sem sinal \*)|
|[_addcarry_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u64)||intrin.h|unsigned char _addcarry_u64 (unsigned char, não assinado \__int64, não assinado \__int64, não assinado \__int64 \*)|
|_addcarry_u8||intrin.h|unsigned char _addcarry_u8(unsigned char, unsigned char, unsigned char, unsigned char \*)|
|[_addcarryx_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u32)|ADX [2]|immintrin.h|unsigned char _addcarryx_u32 (unsigned char, unsigned int, int sem sinal, int sem sinal \*)|
|[_addcarryx_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u64)|ADX [2]|immintrin.h|unsigned char _addcarryx_u64 (unsigned char, não assinado \__int64, não assinado \__int64, não assinado \__int64 \*)|
...
|[_bittestandcomplement](bittestandcomplement-bittestandcomplement64.md)||intrin.h|unsigned char _bittestandcomplement (longa \*, long)|
|[_bittestandcomplement64](bittestandcomplement-bittestandcomplement64.md)||intrin.h|_bittestandcomplement64 unsigned char (\__int64 \*, \__int64)|
...
|[_bittestandset](bittestandset-bittestandset64.md)||intrin.h|unsigned char _bittestandset (longa \*, long)|
...
|[__emulu](emul-emulu.md)||intrin.h|unsigned __int64 [pascal/cdecl]\__emulu (unsigned int, int sem sinal)|
...
|[__indword](indword.md)||intrin.h|__indword(unsigned short) longo sem sinal|
...
|[_InterlockedAnd](interlockedand-intrinsic-functions.md)||intrin.h|interlockedand longo (long volátil \*, long)|
|[_InterlockedAnd_HLEAcquire](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|interlockedand_hleacquire longo (long volátil \*, long)|
|[_InterlockedAnd_HLERelease](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|interlockedand_hlerelease longo (long volátil \*, long)|
|[_InterlockedAnd_np](interlockedand-intrinsic-functions.md)||intrin.h|long _InterlockedAnd_np(long \*, long)|
|[_InterlockedAnd16](interlockedand-intrinsic-functions.md)||intrin.h|_InterlockedAnd16 curto (curto volátil \*, short)|
...
|[_InterlockedAnd64_HLERelease](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedAnd64_HLERelease __int64 (\__int64 volátil \*, \__int64)|
...
|[_interlockedbittestandreset_HLEAcquire](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandreset_HLEAcquire (longa \*, long)|
|[_interlockedbittestandreset_HLERelease](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandreset_HLERelease (longa \*, long)|
...
|[_interlockedbittestandset](interlockedbittestandset-intrinsic-functions.md)||intrin.h|não assinado interlockedbittestandset de char (longa \*, long)|
|[_interlockedbittestandset_HLEAcquire](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandset_HLEAcquire (longa \*, long)|
|[_interlockedbittestandset_HLERelease](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandset_HLERelease (longa \*, long)|
...
|[_InterlockedCompareExchange](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|interlockedcompareexchange longo (long volátil \*, long, long)|
|[_InterlockedCompareExchange_HLEAcquire](interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedCompareExchange_HLEAcquire longo (long volátil \*, long, long)|
|[_InterlockedCompareExchange_HLERelease](interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedCompareExchange_HLERelease longo (long volátil \*, long, long)|
|[_InterlockedCompareExchange_np](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|_InterlockedCompareExchange_np longo (longo \*, long, long)|
...
|[_InterlockedCompareExchange16](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|_InterlockedCompareExchange16 curto (curto volátil \*, short, short)|
|[_InterlockedCompareExchange16_np](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|_InterlockedCompareExchange16_np curto (curto volátil \*, short, short)|
...
|[_InterlockedDecrement16](interlockeddecrement-intrinsic-functions.md)||intrin.h|_InterlockedDecrement16 curto (abreviada volátil \*)|
|[_InterlockedDecrement64](interlockeddecrement-intrinsic-functions.md)||intrin.h|_InterlockedDecrement64 __int64 (\__int64 volátil \*)|
|[_InterlockedExchange](interlockedexchange-intrinsic-functions.md)||intrin.h|long _InterlockedExchange(long volatile \*, long)|
|[_InterlockedExchange_HLEAcquire](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedExchange_HLEAcquire longo (long volátil \*, long)|
|[_InterlockedExchange_HLERelease](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedExchange_HLERelease longo (long volátil \*, long)|
|[_InterlockedExchange16](interlockedexchange-intrinsic-functions.md)||intrin.h|_InterlockedExchange16 curto (curto volátil \*, short)|
...
|[_InterlockedExchangeAdd_HLEAcquire](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|interlockedexchangeadd_hleacquire longo (long volátil \*, long)|
|[_InterlockedExchangeAdd_HLERelease](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|interlockedexchangeadd_hlerelease longo (long volátil \*, long)|
|[_InterlockedExchangeAdd16](interlockedexchangeadd-intrinsic-functions.md)||intrin.h|_InterlockedExchangeAdd16 curto (curto volátil \*, short)|
...
|[_InterlockedExchangePointer_HLEAcquire](interlockedexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|void \* interlockedexchangepointer_hleacquire (void \*volátil \*, void \*)|
|[_InterlockedExchangePointer_HLERelease](interlockedexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|void * interlockedexchangepointer_hlerelease (void \*volátil \*, void \*)|
|[_InterlockedIncrement](interlockedincrement-intrinsic-functions.md)||intrin.h|long _InterlockedIncrement(long volatile \*)|
|[_InterlockedIncrement16](interlockedincrement-intrinsic-functions.md)||intrin.h|_InterlockedIncrement16 curto (abreviada volátil \*)|
...
|[_InterlockedOr](interlockedor-intrinsic-functions.md)||intrin.h|interlockedor longo (long volátil \*, long)|
|[_InterlockedOr_HLEAcquire](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|interlockedor_hleacquire longo (long volátil \*, long)|
|[_InterlockedOr_HLERelease](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|interlockedor_hlerelease longo (long volátil \*, long)|
|[_InterlockedOr_np](interlockedor-intrinsic-functions.md)||intrin.h|long _InterlockedOr_np(long \*, long)|
|[_InterlockedOr16](interlockedor-intrinsic-functions.md)||intrin.h|_InterlockedOr16 curto (curto volátil \*, short)|
...
|[_InterlockedXor](interlockedxor-intrinsic-functions.md)||intrin.h|interlockedxor longo (long volátil \*, long)|
|[_InterlockedXor_HLEAcquire](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedXor_HLEAcquire longo (long volátil \*, long)|
|[_InterlockedXor_HLERelease](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedXor_HLERelease longo (long volátil \*, long)|
|[_InterlockedXor_np](interlockedxor-intrinsic-functions.md)||intrin.h|long _InterlockedXor_np(long \*, long)|
|[_InterlockedXor16](interlockedxor-intrinsic-functions.md)||intrin.h|_InterlockedXor16 curto (curto volátil \*, short)|
|[_InterlockedXor16_np](interlockedxor-intrinsic-functions.md)||intrin.h|_InterlockedXor16_np curto (curto \*, short)|
...
|__lwpval32|LWP [1]|ammintrin.h|void __lwpval32 (unsigned int, int sem sinal, int sem sinal)|
...
|[__movsd](movsd.md)||intrin.h|VOID __movsd (unsigned long \*sem sinal longa const \*, size_t)|
|[__movsq](movsq.md)||intrin.h|VOID __movsq (unsigned \__int64 \*sem sinal \__int64 const \*, size_t)|
|[__movsw](movsw.md)||intrin.h|VOID __movsw (unsigned short \*, const curto sem sinal \*, size_t)|
...
|[__readgsdword](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|__readgsdword(unsigned long) longo sem sinal|
...
|[__shiftleft128](shiftleft128.md)||intrin.h|unsigned __int64 \__shiftleft128 (unsigned \__int64, não assinado \__int64, unsigned char)|
|[__shiftright128](shiftright128.md)||intrin.h|unsigned __int64 \__shiftright128 (unsigned \__int64, não assinado \__int64, unsigned char)|
...
|[_udiv64](udiv64.md)||intrin.h|int sem sinal \_udiv64 (unsigned \__int64, int sem sinal, unsigned int *)|
|[__ull_rshift](ull-rshift.md)||intrin.h|unsigned __int64 [pascal/cdecl] \__ull_rshift (unsigned \__int64, int)|
|[_umul128](umul128.md)||intrin.h|unsigned __int64 _umul128 (unsigned \__int64, não assinado \__int64, não assinado \__int64 \*)|
...
[Intrínsecos do compilador](compiler-intrinsics.md)<br/>
[Intrínsecos do ARM](arm-intrinsics.md)<br/>
