...
Grave a memória em um local especificado por um deslocamento relativo ao início do segmento GS.
...
*Desvio*\
no O deslocamento do início de GS no qual gravar.
