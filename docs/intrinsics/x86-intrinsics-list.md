---
title: "x86 lista de intrínsecos | Microsoft Docs"
ms.custom: 
ms.date: 1/02/2018
ms.reviewer: 
ms.suite: 
...
Este documento lista os intrínsecos que o compilador do Visual C++ aceita quando o alvo é x86.
...
- [Extensões de referência de programação do conjunto de instruções de arquitetura da Intel](http://go.microsoft.com/fwlink/p/?LinkId=506627)
...
|[_InterlockedAddLargeStatistic](../intrinsics/interlockedaddlargestatistic.md)||intrin.h|_InterlockedAddLargeStatistic longo (\__int64 volátil *, long)|
...
|_m_to_float|3DNOW|intrin.h|Flutuar _m_to_float (\_m64)|
...
|[_mm_cvt_pi2ps](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE|intrin.h|m128 _mm_cvt_pi2ps (\__m128,\_m64)|
|[_mm_cvt_ps2pi](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE|intrin.h|m64 _mm_cvt_ps2pi (\__m128)|
...
|[_mm_cvtt_ps2pi](http://go.microsoft.com/fwlink/p/?LinkId=512130)|SSE|intrin.h|m64 _mm_cvtt_ps2pi (\__m128)|
