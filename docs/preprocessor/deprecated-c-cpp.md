...
> [!NOTE]
> Para obter informações sobre o C++ 14 `[[deprecated]]` atributo e orientações sobre quando usar esse atributo vs o pragma ou declspec da Microsoft, consulte [atributos padrão do C++](../cpp/attributes2.md) atributo.
