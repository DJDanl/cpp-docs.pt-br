...
`#define` *identificador* *token de cadeia de caracteres*otimizado  
  
`#define` *identificador* `(` *identificador*aceitar`,`*...*  `,` *identificador*aceitar`)`*cadeia de caracteres de token*otimizado  
