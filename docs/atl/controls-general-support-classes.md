---
title: 'Controles da ATL: Classes de suporte geral | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
-   [IQuickActivateImpl](../atl/reference/iquickactivateimpl-class.md) combina inicialização em uma única chamada para ajudar a evitar atrasos ao carregar os controles de contêineres.  
  
-   [IPointerInactiveImpl](../atl/reference/ipointerinactiveimpl-class.md) fornece interação de mouse mínima para um controle contrário inativo.  
