...
ms.locfileid: "57263462"
---
# <a name="dual-interfaces-and-atl"></a>Interfaces duplas e ATL

Uma interface dupla permite que seus métodos ser acessada como métodos dispinterface ou como métodos vtable. Esta seção aborda alguns dos recursos de interfaces duplas de uma perspectiva ATL.
