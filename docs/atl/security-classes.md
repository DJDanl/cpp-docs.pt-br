...
-   [CPrivateObjectSecurityDesc](../atl/reference/cprivateobjectsecuritydesc-class.md) essa classe representa um objeto de descritor de segurança do objeto particular.  
...
-   [CSecurityAttributes](../atl/reference/csecurityattributes-class.md) esta classe é um wrapper fino para o **SECURITY_ATTRIBUTES** estrutura.  
