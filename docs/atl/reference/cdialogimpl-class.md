...
|Caixas de diálogo|[Caixas de diálogo](/windows/desktop/dlgbox/dialog-boxes) e tópicos subsequentes no SDK do Windows|
...
**RECT &** *rect* [in] um [RECT](/previous-versions/dd162897\(v=vs.85\)) estrutura que especifica o tamanho e a posição da caixa de diálogo.
...
*hWndParent*<br/>
[in] O identificador para a janela do proprietário. O valor padrão é o valor de retorno de [GetActiveWindow](/windows/desktop/api/winuser/nf-winuser-getactivewindow) função do Win32.
...
*lpRect*<br/>
Aponta para um `CRect` objeto ou [RECT](/windows/desktop/api/windef/ns-windef-tagrect) estrutura que receberá as coordenadas do cliente da atualização que inclui a região de atualização.
