---
title: Criando um projeto ATL | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
ms.openlocfilehash: 05e18e9a9effaadfa65c150946a0714dce3e452f
ms.contentlocale: pt-br
ms.lasthandoff: 02/25/2017

---
# <a name="creating-an-atl-project"></a>Criando um projeto do ATL
A maneira mais fácil de criar um projeto ATL é usar a ATL Project Wizard, localizado na pasta de projetos Win32 a **caixa de diálogo Novo projeto**.  
...
2.  Selecione o **projeto ATL** ícone no painel de modelos para abrir o Assistente de projeto ATL.  
