...
|[ATLTRACE](#alttrace)|Relata avisos para um dispositivo de saída, como a janela do depurador, acordo com os sinalizadores indicados e níveis. Incluído para compatibilidade com versões anteriores.|
