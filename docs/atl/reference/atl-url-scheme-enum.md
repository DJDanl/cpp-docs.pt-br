---
title: "Enumeração ATL_URL_SCHEME | Documentos do Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Os membros da enumeração fornecem constantes para os esquemas entendidos pelo [CUrl](curl-class.md).  
