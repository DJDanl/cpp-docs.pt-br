...
### <a name="remarks"></a>Comentários  
 ...
 Ver [IGlobalInterfaceTable](http://msdn.microsoft.com/library/windows/desktop/ms678517) para obter informações sobre a tabela de Interface Global.  
