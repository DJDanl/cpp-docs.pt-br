...
##  <a name="a-nameclosea--close"></a><a name="close"></a>Fechar  
...
##  <a name="a-namecommita--commit"></a><a name="commit"></a>Confirmação  
...
##  <a name="a-namerollbacka--rollback"></a><a name="rollback"></a>Reversão  
