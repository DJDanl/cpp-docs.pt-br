---
title: "Funções de codificação de texto ATL | Documentos do Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Essas funções aceitam texto codificação e decodificação.
...
|[BEncodeGetRequiredLength](#beencodegetrequiredlength)|Chame essa função para obter o tamanho em caracteres de um buffer que pode conter de uma cadeia de caracteres codificada dos dados do tamanho especificado.|
...
### <a name="return-value"></a>Valor de retorno  
 Retorna um `DWORD` valor inteiro da versão da biblioteca ATL que você está compilando ou em execução.  
...
### <a name="parameters"></a>Parâmetros  
 ...
 `pnDestLen`  
 Ponteiro para uma variável que contém o comprimento em bytes do `pbDest`. Se a função obtiver êxito, a variável recebe o número de bytes gravados no buffer. Se a função falhar, a variável recebe o comprimento necessário em bytes do buffer.  
...
### <a name="parameters"></a>Parâmetros  
 ...
 `nSrcLen`  
 O comprimento em bytes de dados a ser codificado.  
  
 `szDest`  
 Buffer alocado pelo chamador para receber os dados codificados.  
  
 `pnDestLen`  
 Ponteiro para uma variável que contém o comprimento em caracteres do `szDest`. Se a função obtiver êxito, a variável recebe o número de caracteres gravados no buffer. Se a função falhar, a variável recebe o comprimento necessário em caracteres do buffer.  
...
### <a name="remarks"></a>Comentários  
 Para determinar o tamanho do buffer necessário para a cadeia de caracteres convertida, chame essa função passar 0 `szDest` e `nDest`.  
...
### <a name="parameters"></a>Parâmetros  
 `szIn`  
 A cadeia de caracteres a ser convertido.  
 ...
 *nDestLen*  
 ...
 `dwFlags`  
 Sinalizadores que descrevem como a conversão deve ser executada. Consulte [ATL_ESC sinalizadores](http://msdn.microsoft.com/library/daf3aa3c-7498-4d63-9fb6-e05b4815c2b8).  
  
### <a name="return-value"></a>Valor de retorno  
 O comprimento em caracteres de cadeia de caracteres convertida.  
...
### <a name="parameters"></a>Parâmetros  
 ...
 [out] `pnDestLen`  
 Ponteiro para uma variável que contém o comprimento em bytes do `szDest`. Se a função obtiver êxito, a variável recebe o número de bytes gravados no buffer. Se a função falhar, a variável recebe o comprimento necessário em bytes do buffer.  
  
 [in] `dwFlags`  
 Sinalizadores que descrevem como a conversão deve ser executada. Consulte [ATLSMTP_QPENCODE sinalizadores](http://msdn.microsoft.com/library/6b15a3ab-8e57-49e4-8104-09b26ebb96c4).  
 ...
 *lpszFile*  
 ...
 `dwFlags`  
 Sinalizadores de controlar o comportamento dessa função. Consulte [ATLSMTP_UUENCODE sinalizadores](http://msdn.microsoft.com/library/ecb79b81-b764-4a48-a05c-a9dee6e7bbce).  
