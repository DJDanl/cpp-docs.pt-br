...
### <a name="parameters"></a>Parâmetros  
 *pszDir*  
 O caminho para o arquivo temporário. Se isso for NULL, [GetTempPath](http://msdn.microsoft.com/library/windows/desktop/aa364992) será chamado para atribuir um caminho.  
