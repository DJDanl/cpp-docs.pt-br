...
> [!NOTE]
>  A segunda forma de `AddAllowedAce` só está disponível no Windows 2000 e posterior.  
...
> [!NOTE]
>  A segunda forma de `AddDeniedAce` só está disponível no Windows 2000 e posterior.  
