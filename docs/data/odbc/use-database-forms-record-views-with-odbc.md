---
title: Usar formulários de banco de dados (exibições de registro) com ODBC | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "46109340"
---
# <a name="use-database-forms-record-views-with-odbc"></a>Usar formulários de banco de dados (exibições de registro) com ODBC

Alguns aplicativos, como a entrada de dados ou exibição de dados, exigem um formulário, uma exibição com controles de estilo de caixa de diálogo.  
  
## <a name="in-this-section"></a>Nesta seção  
  
- [Exibir dados do banco de dados em um formulário](../../data/record-views-mfc-data-access.md)  
