...
ms.locfileid: "33089214"
---
# <a name="further-reading-about-the-mfc-odbc-classes"></a>Leitura adicional sobre as classes ODBC MFC
Ainda mais os tópicos a seguir explicam os conceitos e técnicas apresentadas neste tópico:  
...
-   [Transação (ODBC)](../../data/odbc/transaction-odbc.md)  
 ...
 No *referência MFC*, consulte [CDatabase](../../mfc/reference/cdatabase-class.md), [CRecordset](../../mfc/reference/crecordset-class.md), [CRecordView](../../mfc/reference/crecordview-class.md), [CFieldExchange](../../mfc/reference/cfieldexchange-class.md), e [CDBException](../../mfc/reference/cdbexception-class.md).  
