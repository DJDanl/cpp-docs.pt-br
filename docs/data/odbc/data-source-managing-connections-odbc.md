...
2.  Sobre o **DSN de arquivo** , clique em **Add**.  
  
3.  No **criar nova fonte de dados** caixa de diálogo, selecione um driver do Excel e, em seguida, clique em **próxima**.  
...
2.  No **instalação ODBC do Microsoft Excel** caixa de diálogo, selecione a versão do banco de dados e a pasta de trabalho.  
...
2.  Chamar sua `OpenEx` ou `Open` função de membro.  
...
2.  Destrua o objeto a menos que você deseje reutilizá-lo.  
...
2.  Em vez de destruir o objeto, chame seu `OpenEx` ou `Open` novamente a função de membro.  
