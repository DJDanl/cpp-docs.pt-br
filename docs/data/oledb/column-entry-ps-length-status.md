...
## <a name="remarks"></a>Comentários  
 Permite que você especifique a precisão e escala da coluna que você deseja vincular. Use esta macro quando você deseja dar suporte a variáveis de comprimento e status. Ela é usada nos seguintes locais:  
