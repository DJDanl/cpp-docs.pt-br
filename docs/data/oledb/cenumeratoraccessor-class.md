...
### <a name="remarks"></a>Comentários  
 Ver [ISourcesRowset:: Getsourcesrowset](https://msdn.microsoft.com/library/ms711200.aspx) na *referência do programador DB OLE* para obter mais informações. 
