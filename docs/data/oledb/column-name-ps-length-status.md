...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "Macro COLUMN_NAME_PS_LENGTH_STATUS"
...
Representa uma associação no conjunto de linhas para a coluna específica no conjunto de linhas.  Semelhante a, exceto que a [COLUMN\_NAME](../Topic/COLUMN_NAME.md)esta macro também usa precisão, escala, comprimento da coluna, e o status da coluna.  
