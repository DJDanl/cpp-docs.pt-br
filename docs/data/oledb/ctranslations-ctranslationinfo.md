...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "Classe de parâmetro CTranslationInfo"
  - "Classe typedef CTranslations"
  - "m_szCatalog"
  - "m_szName"
  - "m_szSchema"
  - "m_szSourceCatalog"
...
Chame a classe **CTranslations** do typedef para implementar a sua classe **CTranslationInfo**do parâmetro.  
...
## Comentários  
 ...
 Essa classe identifica as traduções de caracteres definidas no catálogo que são acessíveis para um determinado usuário.  
  
 A tabela a seguir lista os membros de dados da classe e suas colunas correspondentes OLE DB.  Consulte [Conjunto de linhas de TRADUÇÕES](https://msdn.microsoft.com/en-us/library/ms725365.aspx)*na referência do programador de OLE DB* para obter mais informações sobre o esquema e de colunas.  
