...
Define as propriedades para o objeto de comando.  
...
#### <a name="parameters"></a>Parâmetros  
 Consulte [icommandproperties:: SetProperties](https://msdn.microsoft.com/en-us/library/ms711497.aspx) no *referência do programador de OLE DB*.  
