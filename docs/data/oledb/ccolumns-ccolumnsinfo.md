...
ms.locfileid: "33090777"
---
# <a name="ccolumns-ccolumnsinfo"></a>CColumns, CColumnsInfo
Chamar a classe typedef **CColumns** para implementar sua classe de parâmetro **CColumnsInfo**.  
...
## <a name="remarks"></a>Comentários  
 ...
 Essa classe identifica as colunas de tabelas definidas no catálogo e acessíveis para um determinado usuário.  
  
 A tabela a seguir lista os membros de dados de classe e o OLE DB colunas correspondentes. Consulte [conjunto de linhas COLUMNS](https://msdn.microsoft.com/en-us/library/ms723052.aspx) no *referência do programador de DB OLE* para obter mais informações sobre o esquema e as colunas.  
