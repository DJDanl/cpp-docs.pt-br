...
Desvincula todas as colunas, libera a memória alocada e libera o [IAccessor](https://msdn.microsoft.com/en-us/library/ms719672.aspx) ponteiro de interface na classe.  
