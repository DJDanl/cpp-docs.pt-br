...
## Comentários  
 Permite especificar a precisão e a escala da coluna que você quer associar.  Esta macro da suporte à variável *de comprimento* .  É usado nos seguintes locais:  
