...
Representa uma associação no conjunto de linhas para a coluna específica no conjunto de linhas.  Semelhante a, exceto que a [COLUMN\_NAME](../Topic/COLUMN_NAME.md)esta macro também usa o tipo de dados, a precisão, a escala e.  
