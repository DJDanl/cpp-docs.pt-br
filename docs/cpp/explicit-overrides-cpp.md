...
Para obter informações sobre substituições explícitas no código gerenciado usando C++/CLI, consulte [substituições explícitas](../extensions/explicit-overrides-cpp-component-extensions.md).
