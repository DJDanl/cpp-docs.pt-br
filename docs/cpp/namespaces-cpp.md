...
```  
 ...
 As implementações de função em contosodata.cpp devem usar o nome totalmente qualificado, mesmo se você colocar um `using` diretiva na parte superior do arquivo:  
