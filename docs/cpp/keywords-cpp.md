...
:::row:::
    :::column:::
        ...
        [`asm`](../assembler/inline/asm.md)<sup>um</sup><br/>
    ...
    :::column:::
        ...
        [`using`](using-declaration.md)mesma<br/>
        [`using`](namespaces-cpp.md#using_directives)Register<br/>
...
:::row:::
    ...
    :::column:::
        ...
        [`__ptr64`](ptr32-ptr64.md)<sup>Oriental</sup><br/>
        [`__raise`](raise.md)<br/>
        [`__restrict`](extension-restrict.md)<sup>e</sup><br/>
        [`__single_inheritance`](inheritance-keywords.md)<sup>Oriental</sup><br/>
        [`__sptr`](sptr-uptr.md)<sup>Oriental</sup><br/>
