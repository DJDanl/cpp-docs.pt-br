...
#### [Instrução for baseada intervalo (C++)](range-based-for-statement-cpp.md)
### [Instruções de hiperlink (C++)](jump-statements-cpp.md)
#### [Instrução break (C++)](break-statement-cpp.md)
#### [Instrução continue (C++)](continue-statement-cpp.md)
#### [Instrução return (C++)](return-statement-cpp.md)
