...
#### [main: inicialização de programa](main-program-startup.md)
...
### [Lvalues e Rvalues](lvalues-and-rvalues-visual-cpp.md)
...
## [Tratamento de exceções em C++](exception-handling-in-visual-cpp.md)
...
##### [Tratar exceções estruturadas no C++](exception-handling-differences.md)
