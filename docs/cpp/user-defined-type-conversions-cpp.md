---
title: "Convers&#245;es | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
helpviewer_keywords: 
  - "coerção"
  - "construtores [C++], e constantes"
  - "construtores [C++], conversão"
  - "construtores [C++], desvantagens"
  - "construtores de conversão"
  - "funções de conversão"
  - "funções de conversão, regras para declaração"
  - "conversões [C++], por construtores"
  - "conversões [C++], explicit"
  - "convertendo objetos"
  - "conversão de tipo de dados [C++], explicit"
  - "declarando funções, funções de conversão"
  - "palavra-chave explicit"
  - "funções [C++], conversão"
  - "objetos [C++], convertendo"
  - "conversão de tipo"
  - "conversão de tipo [C++], conversão explícita"
...
Uma *conversão* produz um novo valor de algum tipo a partir de um valor de tipo diferente.  As *conversões padrão* são compiladas na linguagem C\+\+, são compatíveis com os seus tipos internos e você pode criar *conversões definidas pelo usuário* para realizar conversões para, de ou entre tipos definidos pelo usuário.  
...
-   Herança múltipla.  A conversão é definida em mais de uma classe base.  Para obter mais informações, consulte [\(NOTINBUILD\) Ambiguity](http://msdn.microsoft.com/pt-br/0b399cab-40a7-4e79-9278-05f40139a0e1).  
