...
O operador de diminuição de prefixo ( **--** ) é análogo ao operador de incremento de prefixo, exceto pelo fato de que o operando é decrementado por um e o resultado é esse valor diminuído.
