...
description: Usar a inicialização de chaves com qualquer classe C++, struct ou Union
ms.date: 11/19/2019
...
> [!IMPORTANT]
> Para usar essa classe, você deve incluir o [\<initializer_list>](../standard-library/initializer-list.md) cabeçalho.
