---
title: operadores bstr_t | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
ms.locfileid: "32407975"
---
# <a name="bstrt-operators"></a>Operadores (_bstr_t)
Para obter informações sobre o `_bstr_t` operadores, consulte [bstr_t classe](../cpp/bstr-t-class.md).  
