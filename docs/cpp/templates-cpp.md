...
```  
 ...
 No entanto, como esse é um modelo de função e o compilador podem deduzir o tipo de `T` argumentech `a` e `b`, você pode chamá-lo como uma função comum:  
