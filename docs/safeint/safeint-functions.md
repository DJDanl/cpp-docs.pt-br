...
[Modulus seguro](#safemodulus)   | Realiza a operação de módulo em dois números.
...
## <a name="safeequals"></a><a name="safeequals"></a>Segurançaigual
...
## <a name="safemodulus"></a><a name="safemodulus"></a>Modulus seguro
