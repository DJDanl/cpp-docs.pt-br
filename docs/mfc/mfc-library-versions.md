...
Os projetos MFC usam o símbolo de pré-processador \_ Unicode para indicar o suporte a Unicode de caracteres de largura UTF-16 e \_ MBCS para indicar o suporte a MBCS. Essas opções são mutuamente exclusivas em um projeto.
...
|*&*|Versão com controles MFC em caixas de diálogo (CW) ou sem (NMCD)|
