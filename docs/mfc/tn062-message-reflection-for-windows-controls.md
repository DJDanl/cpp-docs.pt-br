---
title: 'TN062: Reflexão de mensagem para controles do Windows'
ms.date: 06/28/2018
f1_keywords:
...
## <a name="handling-reflected-messages-an-example-of-a-reusable-control"></a>Manipulando mensagens refletidas: Um exemplo de um controle reutilizável
