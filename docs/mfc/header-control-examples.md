...
Para obter exemplos de controles de cabeçalho, consulte o [controles de cabeçalho](http://msdn.microsoft.com/library/windows/desktop/bb775238) no SDK do Windows.  
