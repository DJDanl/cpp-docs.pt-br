...
1. Substituir [IsInvokeAllowed](../mfc/reference/colecontrol-class.md#isinvokeallowed). Para obter mais informações, consulte o artigo da Base de dados de Conhecimento Q146120.
