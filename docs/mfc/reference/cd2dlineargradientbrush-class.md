...
|Nome|Descrição|  
|----------|-----------------|  
|[CD2DLinearGradientBrush::Attach](#attach)|Conexões existentes de interface de recurso para o objeto|  
...
|[CD2DLinearGradientBrush::GetEndPoint](#getendpoint)|Recupera as coordenadas de finais do gradiente linear|  
|[CD2DLinearGradientBrush::GetStartPoint](#getstartpoint)|Recupera as coordenadas iniciais do gradiente linear|  
|[CD2DLinearGradientBrush::SetEndPoint](#setendpoint)|Define as coordenadas de finais do gradiente linear no espaço de coordenadas do pincel|  
...
##  <a name="getendpoint"></a>  CD2DLinearGradientBrush::GetEndPoint  
 Recupera as coordenadas de finais do gradiente linear  
...
##  <a name="setendpoint"></a>  CD2DLinearGradientBrush::SetEndPoint  
 Define as coordenadas de finais do gradiente linear no espaço de coordenadas do pincel  
