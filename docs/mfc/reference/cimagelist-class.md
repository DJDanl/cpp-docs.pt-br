...
Essa função de membro implementa o comportamento da função [ImageList_Copy](/windows/win32/api/commctrl/nf-commctrl-imagelist_copy)do Win32, conforme descrito no SDK do Windows.
