...
*pInfo*<br/>
Endereço de uma [DOCHOSTUIINFO](/previous-versions/aa770044\(v=vs.85\)) estrutura que recebe os recursos de interface do usuário do host.
