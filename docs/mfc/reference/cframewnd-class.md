...
### <a name="parameters"></a>Parâmetros  
 ...
 `dwStyle`  
 Especifica a janela [estilo](../../mfc/reference/window-styles.md) atributos. Incluir o **FWS_ADDTOTITLE** se desejar que a barra de título para exibir automaticamente o nome do documento representado na janela de estilo.  
 ...
 *lpszMenuName*  
 ...
 `dwExStyle`  
 Especifica a janela estendida [estilo](../../mfc/reference/extended-window-styles.md) atributos.  
 ...
 *dwDefaultStyle*  
 O quadro [estilo](../../mfc/reference/window-styles.md). Incluir o **FWS_ADDTOTITLE** se desejar que a barra de título para exibir automaticamente o nome do documento representado na janela de estilo.  
