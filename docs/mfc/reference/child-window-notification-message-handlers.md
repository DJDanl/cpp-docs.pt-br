---
title: "Manipuladores de mensagens de notificação de janela filho | Documentos do Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|[Manipuladores da caixa de listagem](../../mfc/reference/list-box-handlers.md)|Manipuladores para códigos de notificação de caixa de lista.|  
