...
[in] [out] *pWndOwner* Especifica o proprietário da janela de alerta. O proprietário receberá todas as notificações para a janela de alerta da área de trabalho. Esse valor não pode ser NULL.
