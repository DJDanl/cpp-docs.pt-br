...
O exemplo a seguir demonstra como construir um objeto do `CMFCKeyMapDialog` classe. Este exemplo faz parte do [amostra de demonstração do Visual Studio](../../overview/visual-cpp-samples.md).
