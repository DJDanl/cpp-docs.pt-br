...
|[CMFCVisualManagerOffice2003::OnDrawBarGripper](#ondrawbargripper)|Chamado pela estrutura quando ele desenha a alça para uma barra de controle. (Substitui `CMFCVisualManagerOfficeXP::OnDrawBarGripper`.)|  
...
|[CMFCVisualManagerOffice2003::OnDrawRibbonProgressBar](#ondrawribbonprogressbar)|O framework chama esse método quando ele desenha um [CMFCRibbonProgressBar classe](../../mfc/reference/cmfcribbonprogressbar-class.md). (Substitui [CMFCVisualManager::OnDrawRibbonProgressBar](../../mfc/reference/cmfcvisualmanager-class.md#ondrawribbonprogressbar).)|  
...
|[CMFCVisualManagerOffice2003::OnEraseTabsFrame](#onerasetabsframe)|O framework chama esse método quando ele apaga um quadro em uma [CMFCBaseTabCtrl classe](../../mfc/reference/cmfcbasetabctrl-class.md). (Substitui [CMFCVisualManager::OnEraseTabsFrame](../../mfc/reference/cmfcvisualmanager-class.md#onerasetabsframe).)|  
...
### <a name="parameters"></a>Parâmetros  
 ...
 [in] `pTabWnd`  
 Um ponteiro para uma janela de guia. O framework apaga um quadro para isso [CMFCBaseTabCtrl classe](../../mfc/reference/cmfcbasetabctrl-class.md).  
...
### <a name="parameters"></a>Parâmetros  
 ...
 [in] `pButton`  
 Um ponteiro para um [CMFCAutoHideButton classe](../../mfc/reference/cmfcautohidebutton-class.md) objeto. O framework preenche o plano de fundo desse botão Ocultar automaticamente.  
...
##  <a name="onfillbarbackground"></a>CMFCVisualManagerOffice2003::OnFillBarBackground  
 O framework chama esse método quando ele preenche o plano de fundo de um [CBasePane classe](../../mfc/reference/cbasepane-class.md) objeto.  
...
### <a name="parameters"></a>Parâmetros  
 ...
 [in] `pBar`  
 Um ponteiro para um [CBasePane classe](../../mfc/reference/cbasepane-class.md) objeto. O framework preenche o plano de fundo deste painel.  
...
### <a name="remarks"></a>Comentários  
 A implementação padrão desse método preenche o plano de fundo da barra de com a cor de plano de fundo 3d da variável global `afxGlobalData`.  
...
### <a name="parameters"></a>Parâmetros  
 ...
 [in] `state`  
 O estado do botão da barra de ferramentas (os possíveis estados de um botão da barra de ferramentas são `ButtonsIsRegular`, `ButtonsIsPressed`, ou `ButtonsIsHighlighted`).  
...
### <a name="parameters"></a>Parâmetros  
 [in] `pCtrl`  
 Um ponteiro para um [CMFCHeaderCtrl classe](../../mfc/reference/cmfcheaderctrl-class.md) objeto. O framework preenche o plano de fundo para este controle de cabeçalho.  
...
##  <a name="onfillhighlightedarea"></a>CMFCVisualManagerOffice2003::OnFillHighlightedArea  
 O framework chama esse método quando ele preenche a área realçada de um botão da barra de ferramentas.  
...
### <a name="parameters"></a>Parâmetros  
 ...
 [in] `pButton`  
 Ponteiro para o [CMFCToolBarButton classe](../../mfc/reference/cmfctoolbarbutton-class.md) objeto para o qual a preencher a área realçada.  
...
### <a name="parameters"></a>Parâmetros  
 ...
 [out] `clrText`  
 Uma referência a um `COLORREF` objeto onde este método armazena a cor do texto do botão de página do outlook.  
...
### <a name="parameters"></a>Parâmetros  
 ...
 [in] `pbrFill`  
 Um ponteiro para o pincel que está usando o framework para preencher a janela de guia.  
...
##  <a name="onfilltasksgroupinterior"></a>CMFCVisualManagerOffice2003::OnFillTasksGroupInterior  
 O framework chama esse método quando ele preenche o interior de um [CMFCTasksPaneTaskGroup classe](../../mfc/reference/cmfctaskspanetaskgroup-class.md) objeto.  
...
##  <a name="onfilltaskspanebackground"></a>CMFCVisualManagerOffice2003::OnFillTasksPaneBackground  
 O framework chama esse método quando ele preenche o plano de fundo de um [CMFCTasksPane classe](../../mfc/reference/cmfctaskspane-class.md) controle.  
...
### <a name="remarks"></a>Comentários  
 Substitua esse método em um Gerenciador visual derivado para personalizar a aparência de um [CMFCTasksPane classe](../../mfc/reference/cmfctaskspane-class.md) objeto.  
  
##  <a name="onhighlightquickcustomizemenubutton"></a>CMFCVisualManagerOffice2003::OnHighlightQuickCustomizeMenuButton  
 As chamadas de framework esse método quando ele desenha um destaque rápida-personalizar o botão de menu.  
...
### <a name="remarks"></a>Comentários  
 O framework chama esse método como parte do processamento de `WM_SYSCOLORCHANGE` mensagem. Substitua esse método em um Gerenciador visual derivado se você quiser executar código personalizado ao alterar as cores em seu aplicativo.  
...
### <a name="parameters"></a>Parâmetros  
 ...
 Especifica se o Gerenciador visual irá usar cores nativas do Windows XP.  
  
### <a name="remarks"></a>Comentários  
 Se `bDefaultWinXPColors` é `TRUE`, o Gerenciador visual usará cores nativas do Windows XP como azul, verde-oliva ou prata. Caso contrário, o Gerenciador visual usará as cores obtidas `GetSysColor`. O Gerenciador visual usa elementos visuais como `COLOR_3DFACE`, `COLOR_3DSHADOW`, `COLOR_3DHIGHLIGHT`, `COLOR_3DDKSHADOW`, e `COLOR_3DLIGHT`.  
...
### <a name="parameters"></a>Parâmetros  
 [in] `bUseGlobalTheme`  
 `TRUE`Se você quiser que o Gerenciador visual para usar um tema global; `FALSE` caso contrário.  
