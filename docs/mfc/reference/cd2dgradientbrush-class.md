...
|[CD2DGradientBrush:: ~ CD2DGradientBrush](#_dtorcd2dgradientbrush)|O destruidor. Chamado quando um objeto de pincel de gradiente D2D está sendo destruído.|
