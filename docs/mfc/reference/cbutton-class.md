...
## <a name="remarks"></a>Comentários  
 ...
 Botões típicos são a caixa de seleção, um botão de opção e um botão de ação. Um `CButton` objeto pode tornar-se qualquer uma dessas opções, de acordo com o [estilo do botão](../../mfc/reference/button-styles.md) especificado na sua inicialização pelo [criar](#create) função de membro.  
...
### <a name="parameters"></a>Parâmetros  
 ...
 `dwStyle`  
 Especifica o estilo do controle de botão. Aplique qualquer combinação de [estilos de botão](../../mfc/reference/button-styles.md) ao botão.  
...
### <a name="remarks"></a>Comentários  
 ...
 Aplicar o seguinte [estilos de janela](../../mfc/reference/window-styles.md) a um controle de botão:  
...
### <a name="return-value"></a>Valor de retorno  
 Retorna os estilos de botão para este `CButton` objeto. Essa função retorna apenas o [BS_](../../mfc/reference/button-styles.md) valores de estilo, não os outros estilos de janela.  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro emula a funcionalidade do **BCM_GETIDEALSIZE** mensagem, conforme descrito no [botões](http://msdn.microsoft.com/library/windows/desktop/bb775943) seção o [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro emula a funcionalidade do **BCM_GETIMAGELIST** mensagem, conforme descrito no [botões](http://msdn.microsoft.com/library/windows/desktop/bb775943) seção o [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método envia o [BCM_GETNOTE](http://msdn.microsoft.com/library/windows/desktop/bb775965) mensagem, que é descrita a [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método envia o [BCM_GETNOTELENGTH](http://msdn.microsoft.com/library/windows/desktop/bb775967) mensagem, que é descrita a [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método inicializa o `mask` membro de um [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) estrutura com a `BCSIF_GLYPH` sinalizador e, em seguida, envia a estrutura no [mensagens BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) mensagem que é descrita no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]. Quando a função de mensagens retorna, esse método recupera o glifo do `himlGlyph` membro da estrutura.  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método inicializa o `mask` membro de um [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) estrutura com a `BCSIF_IMAGE` sinalizador e, em seguida, envia a estrutura no [mensagens BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) mensagem que é descrita no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]. Quando a função de mensagens retorna, esse método recupera a lista de imagens do `himlGlyph` membro da estrutura.  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método envia o [mensagens BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) mensagem, que é descrita a [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método inicializa o `mask` membro de um [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) estrutura com a `BCSIF_SIZE` sinalizador e, em seguida, envia a estrutura no [mensagens BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) mensagem que é descrita no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]. Quando a função de mensagens retorna, esse método recupera o retângulo delimitador do `size` membro da estrutura.  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método inicializa o `mask` membro de um [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) estrutura com a `BCSIF_STYLE` sinalizador e, em seguida, envia a estrutura no [mensagens BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) mensagem que é descrita no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]. Quando a função de mensagens retorna, esse método recupera os estilos de botão de divisão do `uSplitStyle` membro da estrutura.  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro emula a funcionalidade do **BCM_GETTEXTMARGIN** mensagem, conforme descrito no [botões](http://msdn.microsoft.com/library/windows/desktop/bb775943) seção o [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método envia o [BCM_SETDROPDOWNSTATE](http://msdn.microsoft.com/library/windows/desktop/bb775973) mensagem, que é descrita a [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método envia o [BCM_SETSHIELD](http://msdn.microsoft.com/library/windows/desktop/bb775979) mensagem, que é descrita a [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro emula a funcionalidade do **BCM_SETIMAGELIST** mensagem, conforme descrito no [botões](http://msdn.microsoft.com/library/windows/desktop/bb775943) seção o [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método envia o [BCM_SETNOTE](http://msdn.microsoft.com/library/windows/desktop/bb775977) mensagem, que é descrita a [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método inicializa o `mask` membro de um [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) estrutura com o `BCSIF_GLYPH` sinalizador e o `himlGlyph` membro com o `chGlyph` parâmetro e, em seguida, envia a estrutura no [mensagens BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) mensagem que é descrita no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método inicializa o `mask` membro de um [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) estrutura com o `BCSIF_IMAGE` sinalizador e o `himlGlyph` membro com o `pSplitImageList` parâmetro e, em seguida, envia a estrutura no [mensagens BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) mensagem que é descrita no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método envia o [BCM_SETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775981) mensagem, que é descrita a [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método inicializa o `mask` membro de um [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) estrutura com o `BCSIF_SIZE` sinalizador e o `size` membro com o `pSize` parâmetro e, em seguida, envia a estrutura no [mensagens BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) mensagem que é descrita no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método inicializa o `mask` membro de um [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) estrutura com o `BCSIF_STYLE` sinalizador e o `uSplitStyle` membro com o `uSplitStyle` parâmetro e, em seguida, envia a estrutura no [mensagens BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) mensagem que é descrita no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro emula a funcionalidade do **BCM_SETTEXTMARGIN** mensagem, conforme descrito no [botões](http://msdn.microsoft.com/library/windows/desktop/bb775943) seção o [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
