...
O INT_PTR valor retornado é, na verdade, um HRESULT. Consulte a seção valores de retorno [PrintDlgEx](/previous-versions/windows/desktop/legacy/ms646942\(v=vs.85\)) no SDK do Windows.
