...
### <a name="remarks"></a>Comentários  
 ...
 Barras de ferramentas bloqueadas usam listas de imagem separados. Para obter mais informações sobre essas listas de imagens, consulte [CMFCToolBar::LoadBitmapEx](#loadbitmapex).  
