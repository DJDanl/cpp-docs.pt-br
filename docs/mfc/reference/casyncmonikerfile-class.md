...
### <a name="return-value"></a>Valor de retorno  
 Recupera a configurações de **IBindStatusCallBack**. Para obter uma descrição de `IBindStatusCallback` de interface, consulte o SDK do Windows.  
