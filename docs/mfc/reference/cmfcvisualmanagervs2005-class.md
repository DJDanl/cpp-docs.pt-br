...
O exemplo a seguir demonstra como usar o Gerenciador visual VS 2005. Este trecho de código faz parte do [amostra de demonstração de alerta da área de trabalho](../../overview/visual-cpp-samples.md).
