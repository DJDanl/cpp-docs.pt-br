...
|[CHtmlEditCtrlBase::SelectAll](#selectall)|Seleciona todo o documento.|  
...
### <a name="remarks"></a>Comentários  
 Para obter mais informações sobre os parâmetros, consulte "Glifo de tabela de cadeia de caracteres de formato" em [usando edição glifos](https://msdn.microsoft.com/library/aa969614.aspx).  
  
 Esse método envia o [ID do comando IDM_ADDTOGLYPHTABLE](https://msdn.microsoft.com/library/aa769891.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_BOLD](https://msdn.microsoft.com/library/aa769861.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_BUTTON](https://msdn.microsoft.com/library/aa769966.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_CHECKBOX](https://msdn.microsoft.com/library/aa769972.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_CLEARSELECTION](https://msdn.microsoft.com/library/aa770038.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_COPY](https://msdn.microsoft.com/library/aa769872.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_CUT](https://msdn.microsoft.com/library/aa769875.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_DELETE](https://msdn.microsoft.com/library/aa769876.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_DROPDOWNBOX](https://msdn.microsoft.com/library/aa769984.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_EMPTYGLYPHTABLE](https://msdn.microsoft.com/library/aa769907.aspx) para o controle WebBrowser.  
...
### <a name="parameters"></a>Parâmetros  
 *cmdID*  
 A ID de comando a ser executado. Para obter uma lista, consulte [identificadores de comando MSHTML](https://msdn.microsoft.com/library/aa741315.aspx).  
  
 *cmdExecOpt*  
 Valores extraídos do [OLECMDEXECOPT](http://msdn.microsoft.com/library/windows/desktop/ms683930) enumeração, que descrevem como o objeto deve executar o comando.  
...
### <a name="remarks"></a>Comentários  
 Para obter mais informações, consulte [ID do comando IDM_ABSOLUTE_POSITION](https://msdn.microsoft.com/library/aa769889.aspx).  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_BACKCOLOR](https://msdn.microsoft.com/library/aa769858.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_BLOCKFMT](https://msdn.microsoft.com/library/aa769883.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_GETBLOCKFMTS](https://msdn.microsoft.com/library/aa769884.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Para obter mais informações, consulte [ID do comando IDM_BOOKMARK](https://msdn.microsoft.com/library/aa769873.aspx).  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método envia o [ID do comando IDM_FONTNAME](https://msdn.microsoft.com/library/aa769880.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_FONTSIZE](https://msdn.microsoft.com/library/aa769881.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_FORECOLOR](https://msdn.microsoft.com/library/aa769882.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_GETFRAMEZONE](https://msdn.microsoft.com/library/aa769916.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Para obter mais informações, consulte [ID do comando IDM_SHOWALIGNEDSITETAGS](https://msdn.microsoft.com/library/aa769947.aspx).  
...
### <a name="remarks"></a>Comentários  
 Para obter mais informações, consulte [ID do comando IDM_SHOWALLTAGS](https://msdn.microsoft.com/library/aa769948.aspx).  
...
### <a name="remarks"></a>Comentários  
 Para obter mais informações, consulte [ID do comando IDM_SHOWAREATAGS](https://msdn.microsoft.com/library/aa769949.aspx).  
...
### <a name="remarks"></a>Comentários  
 Para obter mais informações, consulte [ID do comando IDM_SHOWWBRTAGS](https://msdn.microsoft.com/library/aa769956.aspx).  
...
### <a name="remarks"></a>Comentários  
 Para obter mais informações, consulte [ID do comando IDM_SHOWCOMMENTTAGS](https://msdn.microsoft.com/library/aa769950.aspx).  
...
### <a name="remarks"></a>Comentários  
 Para obter mais informações, consulte [ID do comando IDM_SHOWMISCTAGS](https://msdn.microsoft.com/library/aa769952.aspx).  
...
### <a name="remarks"></a>Comentários  
 Para obter mais informações, consulte [ID do comando IDM_SHOWSCRIPTTAGS](https://msdn.microsoft.com/library/aa769953.aspx).  
...
### <a name="remarks"></a>Comentários  
 Para obter mais informações, consulte [ID do comando IDM_SHOWSTYLETAGS](https://msdn.microsoft.com/library/aa769954.aspx).  
...
### <a name="remarks"></a>Comentários  
 Para obter mais informações, consulte [ID do comando IDM_SHOWUNKNOWNTAGS](https://msdn.microsoft.com/library/aa769955.aspx).  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_HORIZONTALLINE](https://msdn.microsoft.com/library/aa769968.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_HYPERLINK](https://msdn.microsoft.com/library/aa769874.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_IE50_PASTE](https://msdn.microsoft.com/library/aa769922.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_IFRAME](https://msdn.microsoft.com/library/aa769969.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_IMAGE](https://msdn.microsoft.com/library/aa769970.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_INDENT](https://msdn.microsoft.com/library/aa769963.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_INSFIELDSET](https://msdn.microsoft.com/library/aa769967.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_INSINPUTBUTTON](https://msdn.microsoft.com/library/aa769971.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_INSINPUTHIDDEN](https://msdn.microsoft.com/library/aa769974.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_INSINPUTIMAGE](https://msdn.microsoft.com/library/aa769975.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_INSINPUTPASSWORD](https://msdn.microsoft.com/library/aa769976.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_INSINPUTRESET](https://msdn.microsoft.com/library/aa769978.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_INSINPUTSUBMIT](https://msdn.microsoft.com/library/aa769979.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_INSINPUTUPLOAD](https://msdn.microsoft.com/library/aa769973.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_1D_ELEMENT](https://msdn.microsoft.com/library/aa769885.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_2D_ELEMENT](https://msdn.microsoft.com/library/aa769886.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_ITALIC](https://msdn.microsoft.com/library/aa769988.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_JUSTIFYCENTER](https://msdn.microsoft.com/library/aa769989.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_JUSTIFYLEFT](https://msdn.microsoft.com/library/aa770011.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_JUSTIFYRIGHT](https://msdn.microsoft.com/library/aa770013.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_LISTBOX](https://msdn.microsoft.com/library/aa769985.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_MARQUEE](https://msdn.microsoft.com/library/aa769981.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_ORDERLIST](https://msdn.microsoft.com/library/aa769982.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_OUTDENT](https://msdn.microsoft.com/library/aa770015.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_PARAGRAPH](https://msdn.microsoft.com/library/aa769983.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_PASTE](https://msdn.microsoft.com/library/aa770017.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_PRINT](https://msdn.microsoft.com/library/aa769937.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_PRINTPREVIEW](https://msdn.microsoft.com/library/aa769938.aspx) para o controle WebBrowser.  
...
##  <a name="radiobutton"></a>  CHtmlEditCtrlBase::RadioButton  
 Substitui um controle de opção na seleção atual.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_RADIOBUTTON](https://msdn.microsoft.com/library/aa769977.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_REFRESH](https://msdn.microsoft.com/library/aa770020.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_REMOVEFORMAT](https://msdn.microsoft.com/library/aa770021.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_SAVEAS](https://msdn.microsoft.com/library/aa770024.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_SELECTALL](https://msdn.microsoft.com/library/aa770025.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_2D_POSITION](https://msdn.microsoft.com/library/aa769887.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_ABSOLUTE_POSITION](https://msdn.microsoft.com/library/aa769889.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_ATOMICSELECTION](https://msdn.microsoft.com/library/aa769892.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_AUTOURLDETECT_MODE](https://msdn.microsoft.com/library/aa769893.aspx) para o controle WebBrowser.  
...
### <a name="parameters"></a>Parâmetros  
 *nColor*  
 A cor. Ver *pvaIn* na [ID de comando IDM_BACKCOLOR](https://msdn.microsoft.com/library/aa769858.aspx).  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_BACKCOLOR_](https://msdn.microsoft.com/library/aa769858.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_BOOKMARK](https://msdn.microsoft.com/library/aa769873.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_CSSEDITING_LEVEL](https://msdn.microsoft.com/library/aa769903.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_COMPOSESETTINGS](https://msdn.microsoft.com/library/aa769901.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID do comando IDM_DISABLE_EDITFOCUS_UI](https://msdn.microsoft.com/library/aa769905.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID de comando do IDM FONTNAME](https://msdn.microsoft.com/library/aa769880.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [IDM substituir a ID de comando](https://msdn.microsoft.com/library/aa770016.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [ID de comando IDM UNBOOKMARK](https://msdn.microsoft.com/library/aa770034.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [IDM SUBLINHAR o ID de comando](https://msdn.microsoft.com/library/aa770035.aspx) para o controle WebBrowser.  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [IDM DESVINCULAR a ID de comando](https://msdn.microsoft.com/library/aa770037.aspx) para o controle WebBrowser.  
