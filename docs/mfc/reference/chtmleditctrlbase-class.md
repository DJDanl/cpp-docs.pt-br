...
|[CHtmlEditCtrlBase::Copy](#copy)|Copia a seleção atual para a área de transferência.|
|[CHtmlEditCtrlBase::Cut](#cut)|Copia a seleção atual para a área de transferência e, em seguida, a exclui.|
|[CHtmlEditCtrlBase::Delete](#delete)|Exclui a seleção atual.|
|[CHtmlEditCtrlBase::DropDownBox](#dropdownbox)|Substitui um controle de seleção suspensa na seleção atual.|
...
|[CHtmlEditCtrlBase::GetShowAlignedSiteTags](#getshowalignedsitetags)|Retorna se um glifo é exibido para todos os elementos que têm `styleFloat` uma propriedade.|
...
|[CHtmlEditCtrlBase::GetShowScriptTags](#getshowscripttags)|Recupera se o WebBrowser exibe um glifo para todas as marcas de script.|
...
|[CHtmlEditCtrlBase::Indent](#indent)|Aumenta o recuo do texto selecionado por um incremento de recuo.|
...
|[CHtmlEditCtrlBase::Italic](#italic)|Alterna a seleção atual entre itálico e não itálico.|
...
|[CHtmlEditCtrlBase::SetShowAlignedSiteTags](#setshowalignedsitetags)|Exibe um glifo para todos os elementos que têm `styleFloat` uma propriedade.|
...
*nAlignment*<br/>
Alinhamento (somente elementos retangulares): Esse parâmetro indica que a imagem é para um elemento com um atributo de alinhamento. Left = 0, Center = 1, Right = 2 e undefined = 3. Os atributos esquerdo, direito ou central devem ser definidos explicitamente no elemento.
...
##  <a name="copy"></a>CHtmlEditCtrlBase:: copiar
...
Para obter mais informações, consulte [ID de comando IDM_ABSOLUTE_POSITION](/previous-versions/aa769889\(v=vs.85\)).
...
Para obter mais informações, consulte [ID de comando IDM_BOOKMARK](/previous-versions/aa769873\(v=vs.85\)).
...
Retorna se um glifo é exibido para todos os elementos que têm `styleFloat` uma propriedade.
...
*bCurValue*<br/>
TRUE se um glifo for exibido para todos os elementos que têm `styleFloat` uma propriedade; FALSE se nenhum glifo for exibido.
...
Para obter mais informações, consulte [ID de comando IDM_SHOWALIGNEDSITETAGS](/previous-versions/aa769947\(v=vs.85\)).
...
Para obter mais informações, consulte [ID de comando IDM_SHOWALLTAGS](/previous-versions/aa769948\(v=vs.85\)).
...
Para obter mais informações, consulte [ID de comando IDM_SHOWAREATAGS](/previous-versions/aa769949\(v=vs.85\)).
...
Para obter mais informações, consulte [ID de comando IDM_SHOWWBRTAGS](/previous-versions/aa769956\(v=vs.85\)).
...
Para obter mais informações, consulte [ID de comando IDM_SHOWCOMMENTTAGS](/previous-versions/aa769950\(v=vs.85\)).
...
Para obter mais informações, consulte [ID de comando IDM_SHOWMISCTAGS](/previous-versions/aa769952\(v=vs.85\)).
...
Para obter mais informações, consulte [ID de comando IDM_SHOWSCRIPTTAGS](/previous-versions/aa769953\(v=vs.85\)).

##  <a name="getshowstyletags"></a>  CHtmlEditCtrlBase::GetShowStyleTags

Recupera se o WebBrowser exibe um glifo para todas as marcas de estilo.
...
Para obter mais informações, consulte [ID de comando IDM_SHOWSTYLETAGS](/previous-versions/aa769954\(v=vs.85\)).
...
Para obter mais informações, consulte [ID de comando IDM_SHOWUNKNOWNTAGS](/previous-versions/aa769955\(v=vs.85\)).
...
Esse método envia a [ID de comando IDM_IE50_PASTE](/previous-versions/aa769922\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando IDM_INSINPUTBUTTON](/previous-versions/aa769971\(v=vs.85\)) para o controle WebBrowser.
...
##  <a name="outdent"></a>CHtmlEditCtrlBase:: recuo à esquerda
...
##  <a name="paste"></a>CHtmlEditCtrlBase::P lar
...
*cmdID*<br/>
A ID do comando. Os identificadores de comando são extraídos do grupo de comandos CGID_MSHTML. Esses comandos são definidos em Mshtmcid. h. Você também pode encontrar a lista online em [identificadores de comando mshtml](https://go.microsoft.com/fwlink/p/?linkid=149220).
...
Esse método envia a [ID de comando IDM_RADIOBUTTON](/previous-versions/aa769977\(v=vs.85\)) para o controle WebBrowser.
...
*nColor*<br/>
A cor. Consulte *pvaIn* na [ID de comando do IDM_BACKCOLOR](/previous-versions/aa769858\(v=vs.85\)).
...
Esse método envia a [ID IDM_BLOCKFMT_command](/previous-versions/aa769883\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando da IDM NomeDaFonte](/previous-versions/aa769880\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando do IDM FontSize](/previous-versions/aa769881\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID do comando ForeColor do IDM](/previous-versions/aa769882\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando do IDM IE50_PASTE_MODE](/previous-versions/aa769923\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando do IDM LIVERESIZE](/previous-versions/aa769928\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando do IDM MULTIPLESELECTION](/previous-versions/aa769929\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando do IDM OVERRIDE_CURSOR](/previous-versions/aa769932\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando de substituição da IDM](/previous-versions/aa770016\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando do IDM RESPECTVISIBILITY_INDESIGN](/previous-versions/aa770023\(v=vs.85\)) para o controle WebBrowser.

##  <a name="setshowalignedsitetags"></a>  CHtmlEditCtrlBase::SetShowAlignedSiteTags

Exibe um glifo para todos os elementos que têm `styleFloat` uma propriedade.
...
*bNewValue*<br/>
Se for true, exibe um glifo para todos os elementos que `styleFloat` têm uma propriedade.
...
Esse método envia a [ID de comando do IDM SHOWALIGNEDSITETAGS](/previous-versions/aa769947\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando do IDM SHOWALLTAGS](/previous-versions/aa769948\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando do IDM SHOWAREATAGS](/previous-versions/aa769949\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando do IDM SHOWWBRTAGS](/previous-versions/aa769956\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando do IDM SHOWCOMMENTTAGS](/previous-versions/aa769950\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando do IDM SHOWMISCTAGS](/previous-versions/aa769952\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando do IDM SHOWSCRIPTTAGS](/previous-versions/aa769953\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando do IDM SHOWSTYLETAGS](/previous-versions/aa769954\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando do IDM SHOWUNKNOWNTAGS](/previous-versions/aa769955\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando da TextArea da IDM](/previous-versions/aa769986\(v=vs.85\)) para o controle WebBrowser.
...
Esse método envia a [ID de comando da caixa de texto da IDM](/previous-versions/aa769980\(v=vs.85\)) para o controle WebBrowser.

##  <a name="unbookmark"></a>CHtmlEditCtrlBase:: desmarcar marcador
...
Esse método envia a [ID de comando](/previous-versions/aa770034\(v=vs.85\)) de desmarcação do IDM para o controle WebBrowser.
...
Esse método envia a [ID de comando do IDM](/previous-versions/aa770035\(v=vs.85\)) sublinhado para o controle WebBrowser.
...
Esse método envia a [ID de comando](/previous-versions/aa770037\(v=vs.85\)) de desvinculação do IDM para o controle WebBrowser.

##  <a name="unorderlist"></a>CHtmlEditCtrlBase:: não ordenalist
...
Esse método envia a [ID do comando](/previous-versions/aa769987\(v=vs.85\)) de desordenação da IDM para o controle WebBrowser.
