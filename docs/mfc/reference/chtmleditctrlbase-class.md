...
*cmdID*<br/>
A ID de comando. Identificadores de comando são obtidos a partir do grupo de comando CGID_MSHTML. Esses comandos são definidos em Mshtmcid.h. Você também pode encontrar a lista online na [identificadores de comando MSHTML](https://go.microsoft.com/fwlink/p/?linkid=149220).
