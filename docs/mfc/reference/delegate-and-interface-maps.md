...
## <a name="commandhandler-delegate"></a><a name="commandhandler"></a> CommandHandler delegado
...
## <a name="commanduihandler"></a><a name="commanduihandler"></a> Comandomanipuladoriu
...
*DELEGÁ*<br/>
O tipo do delegado manipulador de eventos gerenciados, como [EventHandler](/dotnet/api/system.eventhandler).
...
O exemplo de código a seguir mostra como chamar `MAKE_DELEGATE` para anexar um `OnClick` manipulador de eventos a um controle MFC `MyControl` . Para obter uma explicação mais ampla de como essa macro funciona em um aplicativo MFC, consulte [como coletar eventos de Windows Forms de classes C++ nativas](../../dotnet/how-to-sink-windows-forms-events-from-native-cpp-classes.md).
...
[Como: coletar eventos de Windows Forms de classes C++ nativas](../../dotnet/how-to-sink-windows-forms-events-from-native-cpp-classes.md)<br/>
[Como: Adicionar roteamento de comando ao controle de Windows Forms](../../dotnet/how-to-add-command-routing-to-the-windows-forms-control.md)<br/>
