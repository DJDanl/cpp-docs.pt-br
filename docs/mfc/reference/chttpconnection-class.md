 ...
 *dwFlags*  
 Qualquer combinação da **Internet _ Flag\***  sinalizadores. Consulte a tabela a **comentários** seção [CHttpConnection::OpenRequest](#openrequest) para obter uma descrição *dwFlags* valores.  
