...
*rect*<br/>
Uma referência a um [RECT](/previous-versions/dd162897\(v=vs.85\)) estrutura, que é a posição e o tamanho do controle de seletor de data e hora.
