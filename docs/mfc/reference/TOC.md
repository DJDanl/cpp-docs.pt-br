...
### [Estrutura COMPAREITEMSTRUCT](compareitemstruct-structure.md)
...
### [Estrutura LINGER](linger-structure.md)
### [Estrutura LOGBRUSH](logbrush-structure.md)
...
### [Estrutura SOCKADDR](sockaddr-structure.md)
### [Estrutura SOCKADDR_IN](sockaddr-in-structure.md)
### [SYSTEMTIME Structure1](systemtime-structure1.md)
### [Estrutura WINDOWPLACEMENT](windowplacement-structure.md)
...
### [Estilos de edição](edit-styles.md)
...
### [Estilos de janela estendidos](extended-window-styles.md)
...
### [Manipulador de mensagens WM_COMMAND](wm-command-message-handler.md)
