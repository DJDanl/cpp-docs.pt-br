...
### <a name="parameters"></a>Parâmetros  
 *nKey*  
 O código de tecla virtual da chave que o usuário pressionou. Para uma lista de códigos de tecla virtuais padrão, consulte WinUser. h  
