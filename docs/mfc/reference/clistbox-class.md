...
Se a caixa de listagem tiver sido criada com um estilo de desenho proprietário, mas sem o estilo de [LBS_HASSTRINGS](../../mfc/reference/styles-used-by-mfc.md#list-box-styles) , a função de membro `FindStringExact` tentará corresponder o valor de doubleword em relação ao valor de *lpszFind*.
...
##  <a name="setcursel"></a>CListBox:: setcurseal
