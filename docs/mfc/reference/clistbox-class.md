...
### <a name="remarks"></a>Comentários  
 ...
 Aplicar o seguinte [estilos de janela](../../mfc/reference/window-styles.md) a um controle de caixa de listagem.  
...
### <a name="remarks"></a>Comentários  
 Se a caixa de listagem foi criada com um estilo de desenho do proprietário, mas sem o [LBS_HASSTRINGS](../../mfc/reference/list-box-styles.md) estilo, o `FindStringExact` função membro tenta corresponder o valor doubleword em relação ao valor de `lpszFind`.  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro emula a funcionalidade do [LB_GETLISTBOXINFO](http://msdn.microsoft.com/library/windows/desktop/bb775208) mensagem, conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="example"></a>Exemplo  
 [!code-cpp[NVC_MFC_CListBox n º 20](../../mfc/codesnippet/cpp/clistbox-class_20.cpp)]  
...
### <a name="remarks"></a>Comentários  
 Ao contrário de [AddString](#addstring) função de membro, `InsertString` não faz com que uma lista com o [LBS_SORT](../../mfc/reference/list-box-styles.md) estilo a ser classificada.  
...
### <a name="parameters"></a>Parâmetros  
 ...
 `bOutside`  
 Referência a um `BOOL` variável que será definido como `TRUE` se `pt` fora da área cliente de item de caixa de listagem mais próximo, `FALSE` se `pt` está dentro da área cliente do item da caixa de lista mais próximo.  
...
### <a name="remarks"></a>Comentários  
 Por padrão, essa função de membro não faz nada. Substituir essa função de membro e preencha o `MEASUREITEMSTRUCT` estrutura para informar ao Windows as dimensões da caixa de listagem. Se a caixa de listagem é criada com o [LBS_OWNERDRAWVARIABLE](../../mfc/reference/list-box-styles.md) estilo, o framework chama esta função de membro para cada item na caixa de listagem. Caso contrário, esse membro é chamado apenas uma vez.  
  
 Para obter mais informações sobre como usar o [LBS_OWNERDRAWFIXED](../../mfc/reference/list-box-styles.md) estilo em uma caixa de listagem do desenho proprietário criado com o `SubclassDlgItem` função membro de `CWnd`, consulte a discussão na [14 de observação técnica](../../mfc/tn014-custom-controls.md).  
...
### <a name="example"></a>Exemplo  
 [!code-cpp[NVC_MFC_CListBox n º 28](../../mfc/codesnippet/cpp/clistbox-class_28.cpp)]  
...
### <a name="parameters"></a>Parâmetros  
 *cxExtent*  
 Especifica o número de pixels por que a caixa de lista pode ser rolada horizontalmente.  
...
### <a name="remarks"></a>Comentários  
 ...
 Para responder a uma chamada para `SetHorizontalExtent`, a caixa de listagem deve ter sido definida com o [WS_HSCROLL](../../mfc/reference/window-styles.md) estilo.  
...
### <a name="example"></a>Exemplo  
 [!code-cpp[NVC_MFC_CListBox n º 35](../../mfc/codesnippet/cpp/clistbox-class_35.cpp)]  
...
### <a name="example"></a>Exemplo  
 [!code-cpp[36 NVC_MFC_CListBox](../../mfc/codesnippet/cpp/clistbox-class_36.cpp)]  
...
### <a name="example"></a>Exemplo  
 [!code-cpp[NVC_MFC_CListBox º 37](../../mfc/codesnippet/cpp/clistbox-class_37.cpp)]  
