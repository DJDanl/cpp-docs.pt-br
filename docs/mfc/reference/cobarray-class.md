---
title: Classe CObArray | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="remarks"></a>Comentários  
 Essas matrizes de objetos são semelhantes às matrizes de C, mas pode reduzir dinamicamente e cresça conforme necessário.  
  
 Índices de matriz iniciam sempre na posição 0. Você pode optar por corrigir o limite superior ou permitir que a matriz de expandir quando você adiciona elementos após o limite atual. Memória é alocada continuamente ao limite superior, mesmo que alguns elementos são nulos.  
 ...
 A `CObArray` incorpora a macro `IMPLEMENT_SERIAL` para suportar serialização e despejo de seus elementos. Se uma matriz de `CObject` ponteiros é armazenada em um arquivo, com o operador de inserção sobrecarregado ou com o `Serialize` função do membro, cada `CObject` elemento é, por sua vez, serializado junto com o índice de matriz.  
  
 Se for necessário um despejo de individuais `CObject` elementos em uma matriz, você deve definir a profundidade do `CDumpContext` objeto para 1 ou maior.  
...
>  Antes de usar uma matriz, utilize `SetSize` para estabelecer seu tamanho e alocar memória para ela. Se `SetSize` não for utilizado, incluir elementos à matriz fará com que ela seja frequentemente realocada e copiada. Realocações e cópias frequentes são ineficientes e podem fragmentar a memória.  
 ...
 Derivação de classe de matriz é semelhante à derivação de lista. Para obter detalhes sobre a derivação de uma classe especial de lista, consulte o artigo [coleções](../../mfc/collections.md).  
...
|-----------|---------------------|  
|[CByteArray](../../mfc/reference/cbytearray-class.md)|**Adicionar INT_PTR (BYTE** `newElement` **);**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CDWordArray](../../mfc/reference/cdwordarray-class.md)|**Adicionar INT_PTR (DWORD** `newElement` **);**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CPtrArray](../../mfc/reference/cptrarray-class.md)|**INT_PTR Add( void\*** `newElement` **);**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CStringArray](../../mfc/reference/cstringarray-class.md)|**Adicionar INT_PTR (LPCTSTR** `newElement` **); lançar (CMemoryException\* );**<br /><br /> **INT_PTR Add(const CString&** `newElement` **);**|  
|[CUIntArray](../../mfc/reference/cuintarray-class.md)|**Adicionar INT_PTR (UINT** `newElement` **);**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CWordArray](../../mfc/reference/cwordarray-class.md)|**Adicionar INT_PTR (WORD** `newElement` **);**<br /><br /> **Lançar (CMemoryException\* );**|  
...
##  <a name="a-nameappenda--cobarrayappend"></a><a name="append"></a>CObArray::Append  
 Chame essa função de membro para adicionar o conteúdo de outro conjunto no final da matriz especificada.  
...
|Classe|Função membro|  
|-----------|---------------------|  
|[CByteArray](../../mfc/reference/cbytearray-class.md)|**Acrescente INT_PTR (const CByteArray < /** *src* **);**|  
|[CDWordArray](../../mfc/reference/cdwordarray-class.md)|**Acrescente INT_PTR (const CDWordArray < /** *src* **);**|  
|[CPtrArray](../../mfc/reference/cptrarray-class.md)|**Acrescente INT_PTR (const CPtrArray < /** *src* **);**|  
|[CStringArray](../../mfc/reference/cstringarray-class.md)|**Acrescente INT_PTR (const CStringArray < /** *src* **);**|  
|[CUIntArray](../../mfc/reference/cuintarray-class.md)|**Acrescente INT_PTR (const CUIntArray < /** *src* **);**|  
|[CWordArray](../../mfc/reference/cwordarray-class.md)|**Acrescente INT_PTR (const CWordArray < /** *src* **);**|  
...
##  <a name="a-namecopya--cobarraycopy"></a><a name="copy"></a>CObArray::Copy  
 Chame essa função de membro para substituir os elementos da matriz especificada com os elementos de matriz outro do mesmo tipo.  
...
### <a name="remarks"></a>Comentários  
 ...
 A tabela a seguir mostra outros construtores são semelhantes às `CObArray::CObArray`.  
...
### <a name="remarks"></a>Comentários  
 Ele é usado para implementar o operador de atribuição da esquerda para matrizes. Observe que essa é uma função avançada que deve ser usada somente para implementar os operadores especiais de matriz.  
...
|[CWordArray](../../mfc/reference/cwordarray-class.md)|**GetAt WORD (INT_PTR** `nIndex` **) const;**|  
...
### <a name="remarks"></a>Comentários  
 Chame esse método para recuperar o número de elementos na matriz. Como índices são baseados em zero, o tamanho é maior que o maior índice 1.  
...
### <a name="remarks"></a>Comentários  
 Como os índices com base em zero, o tamanho é maior que o maior índice 1.  
...
### <a name="parameters"></a>Parâmetros  
 ...
 `newElement`  
 O `CObject` ponteiro sejam colocados nessa matriz. A `newElement` do valor **nulo** é permitido.  
...
### <a name="remarks"></a>Comentários  
 A primeira versão do `InsertAt` insere um elemento (ou várias cópias de um elemento) em um índice especificado em uma matriz. No processo, ele desloca para cima (incrementando o índice) o elemento existente nesse índice, e desloca todos os elementos acima dela.  
  
 A segunda versão insere todos os elementos de outra `CObArray` coleta, começando no `nStartIndex` posição.  
...
|Classe|Função membro|  
|-----------|---------------------|  
|[CByteArray](../../mfc/reference/cbytearray-class.md)|**void InsertAt( INT_PTR** `nIndex` **, BYTE** `newElement` **, int** `nCount` **= 1 );**<br /><br /> **Lançar (CMemoryException\* );**<br /><br /> **void InsertAt( INT_PTR** `nStartIndex` **, CByteArray\*** `pNewArray` **);**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CDWordArray](../../mfc/reference/cdwordarray-class.md)|**void InsertAt( INT_PTR** `nIndex` **, DWORD** `newElement` **, int** `nCount` **= 1 );**<br /><br /> **Lançar (CMemoryException\* );**<br /><br /> **void InsertAt( INT_PTR** `nStartIndex` **, CDWordArray\*** `pNewArray` **);**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CPtrArray](../../mfc/reference/cptrarray-class.md)|**void InsertAt( INT_PTR** `nIndex` **, void\*** `newElement` **, int** `nCount` **= 1 );**<br /><br /> **Lançar (CMemoryException\* );**<br /><br /> **void InsertAt( INT_PTR** `nStartIndex` **, CPtrArray\*** `pNewArray` **);**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CStringArray](../../mfc/reference/cstringarray-class.md)|**void InsertAt( INT_PTR** `nIndex` **, LPCTSTR** `newElement` **, int** `nCount` **= 1 );**<br /><br /> **Lançar (CMemoryException\* );**<br /><br /> **void InsertAt (INT_PTR** `nStartIndex` **, CStringArray\* ** `pNewArray` **);**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CUIntArray](../../mfc/reference/cuintarray-class.md)|**void InsertAt( INT_PTR** `nIndex` **, UINT** `newElement` **, int** `nCount` **= 1 );**<br /><br /> **Lançar (CMemoryException\* );**<br /><br /> **void InsertAt( INT_PTR** `nStartIndex` **, CUIntArray\*** `pNewArray` **);**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CWordArray](../../mfc/reference/cwordarray-class.md)|**void InsertAt( INT_PTR** `nIndex` **, WORD** `newElement` **, int** `nCount` **= 1 );**<br /><br /> **Lançar (CMemoryException\* );**<br /><br /> **void InsertAt( INT_PTR** `nStartIndex` **, CWordArray\*** `pNewArray` **);**<br /><br /> **Lançar (CMemoryException\* );**|  
...
##  <a name="a-nameoperatorata--cobarrayoperator--"></a><a name="operator_at"></a>[CObArray::operator]  
 Esses operadores subscript são conveniente substituir o `SetAt` e `GetAt` funções.  
...
### <a name="remarks"></a>Comentários  
 ...
 A tabela a seguir mostra outros operadores são semelhantes às **[CObArray::operator]**.  
  
|Classe|Operador|  
|-----------|--------------|  
|[CByteArray](../../mfc/reference/cbytearray-class.md)|**[] < / Operador BYTE (int_ptr** `nindex` ** \);**<br /><br /> **Operador BYTE [] (int_ptr** `nindex` ** \) const;**|  
|[CDWordArray](../../mfc/reference/cdwordarray-class.md)|**[] < / Operador DWORD (int_ptr** `nindex` ** \);**<br /><br /> **DWORD operador [] (int_ptr** `nindex` ** \) const;**|  
|[CPtrArray](../../mfc/reference/cptrarray-class.md)|**void\*& operator [](int_ptr** `nindex` **\);**<br /><br /> **void\* operador [] (int_ptr** `nindex` ** \) const;**|  
...
|[CUIntArray](../../mfc/reference/cuintarray-class.md)|**[] UINT < operador / (int_ptr** `nindex` ** \);**<br /><br /> **UINT operador [] (int_ptr** `nindex` ** \) const;**|  
|[CWordArray](../../mfc/reference/cwordarray-class.md)|**[] < / Operador de palavra (int_ptr** `nindex` ** \);**<br /><br /> **WORD operador [] (int_ptr** `nindex` ** \) const;**|  
  
### <a name="example"></a>Exemplo  
 Consulte [CObList::CObList](../../mfc/reference/coblist-class.md#coblist) para obter uma lista da `CAge` classe usada em todos os exemplos de coleção.  
  
 [!code-cpp[88 NVC_MFCCollections](../../mfc/codesnippet/cpp/cobarray-class_11.cpp)]  
...
### <a name="parameters"></a>Parâmetros  
 ...
 `newElement`  
 O ponteiro de objeto a ser inserido nessa matriz. A **nulo** valor permitido.  
...
|Classe|Função membro|  
|-----------|---------------------|  
|[CByteArray](../../mfc/reference/cbytearray-class.md)|**void SetAtGrow( INT_PTR** `nIndex` **, BYTE** `newElement` **);**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CDWordArray](../../mfc/reference/cdwordarray-class.md)|**void SetAtGrow( INT_PTR** `nIndex` **, DWORD** `newElement` **);**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CPtrArray](../../mfc/reference/cptrarray-class.md)|**void SetAtGrow( INT_PTR** `nIndex` **, void\*** `newElement` **);**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CStringArray](../../mfc/reference/cstringarray-class.md)|**void SetAtGrow (INT_PTR** `nIndex` **, LPCTSTR** `newElement` **);**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CUIntArray](../../mfc/reference/cuintarray-class.md)|**void SetAtGrow( INT_PTR** `nIndex` **, UINT** `newElement` **);**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CWordArray](../../mfc/reference/cwordarray-class.md)|**void SetAtGrow( INT_PTR** `nIndex` **, WORD** `newElement` **);**<br /><br /> **Lançar (CMemoryException\* );**|  
...
### <a name="remarks"></a>Comentários  
 Se o novo tamanho for menor que o tamanho anterior, a matriz será truncada e toda a memória não usada é liberada. Para eficiência, chame `SetSize` para definir o tamanho da matriz antes de usá-lo. Isso evita a necessidade de realocar e copiar a matriz sempre que um item é adicionado.  
  
 O `nGrowBy` parâmetro afeta a alocação de memória interna enquanto a matriz está crescendo. Seu uso não afeta o tamanho da matriz conforme relatado pelo `GetSize` e `GetUpperBound`.  
...
|Classe|Função membro|  
|-----------|---------------------|  
|[CByteArray](../../mfc/reference/cbytearray-class.md)|**void SetSize( INT_PTR** `nNewSize` **, int** `nGrowBy` **= -1 );**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CDWordArray](../../mfc/reference/cdwordarray-class.md)|**void SetSize( INT_PTR** `nNewSize` **, int** `nGrowBy` **= -1 );**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CPtrArray](../../mfc/reference/cptrarray-class.md)|**void SetSize( INT_PTR** `nNewSize` **, int** `nGrowBy` **= -1 );**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CStringArray](../../mfc/reference/cstringarray-class.md)|**void SetSize( INT_PTR** `nNewSize` **, int** `nGrowBy` **= -1 );**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CUIntArray](../../mfc/reference/cuintarray-class.md)|**void SetSize( INT_PTR** `nNewSize` **, int** `nGrowBy` **= -1 );**<br /><br /> **Lançar (CMemoryException\* );**|  
|[CWordArray](../../mfc/reference/cwordarray-class.md)|**void SetSize( INT_PTR** `nNewSize` **, int** `nGrowBy` **= -1 );**<br /><br /> **Lançar (CMemoryException\* );**|  
