...
3.  Substituir funções virtuais e implementar o `Read` e `Write` funções na sua classe personalizada. Implemente qualquer outra funcionalidade para ler e gravar dados em seu local desejado.  
  
4.  Em seu aplicativo, chame `CSettingsStoreSP::SetRuntimeClass` e passe um ponteiro para o [estrutura CRuntimeClass](../../mfc/reference/cruntimeclass-structure.md) obtidas da sua classe.  
