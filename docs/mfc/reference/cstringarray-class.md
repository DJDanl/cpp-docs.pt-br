...
ms.locfileid: "53657351"
---
# <a name="cstringarray-class"></a>Classe CStringArray

Dá suporte a matrizes de [CString](../../atl-mfc-shared/using-cstring.md) objetos.
