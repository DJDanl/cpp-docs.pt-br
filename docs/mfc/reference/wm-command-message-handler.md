---
title: Manipulador de mensagens WM_COMMAND | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="wmcommand-message-handler"></a>WM_COMMAND Manipulador de mensagens
A seguinte entrada de mapa corresponde ao protótipo da função.  
  
|Entrada de mapa|Protótipo da função|  
|---------------|------------------------|  
|ON_COMMAND (\<id >, \<memberFxn >)|() de void memberFxn afx_msg;|  
