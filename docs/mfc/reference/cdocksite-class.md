...
### <a name="parameters"></a>Parâmetros  
 [in] *nID*  
 A ID de comando do painel a ser localizada.  
...
### <a name="parameters"></a>Parâmetros  
 ...
 [in] *bMostrar*  
 TRUE para especificar que o painel deve ser exibido; FALSO para especificar que o painel deve ser ocultada.  
