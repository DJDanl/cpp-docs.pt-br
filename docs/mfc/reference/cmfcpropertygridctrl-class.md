...
|Nome|Descrição|
|----------|-----------------|
|`CMFCPropertyGridCtrl::accHitTest`|Chamado pela estrutura para recuperar o elemento filho ou objeto criança em um dado ponto na tela. (Substitui [cwnd::accHitTest](../../mfc/reference/cwnd-class.md#acchittest).)|
|`CMFCPropertyGridCtrl::accLocation`|Chamado pela estrutura para recuperar a localização atual da tela do objeto especificado. (Substitui [cwnd::accLocation](../../mfc/reference/cwnd-class.md#acclocation).)|
...
|[CMFCPropertyGridCtrl::AddProperty](#addproperty)|Adiciona uma nova propriedade ao controle da rede de propriedades.|
|[CMFCPropertyGridCtrl::AlwaysShowUserToolTip](#alwaysshowusertooltip)||
|[CMFCPropertyGridCtrl::CloseColorPopup](#closecolorpopup)|Fecha a caixa de diálogo de seleção de cores.|
|[CMFCPropertyGridCtrl::Criar](#create)|Cria um controle de grade de propriedade e anexa-o ao objeto de controle da grade da propriedade.|
|[CMFCPropertyGridCtrl::DeleteProperty](#deleteproperty)|Exclui a propriedade especificada do controle da grade de propriedade.|
|[CMFCPropertyGridCtrl::DrawControlBarColors](#drawcontrolbarcolors)||
|[CMFCPropertyGridCtrl::AtivarÁrea de descriçãoDescrição](#enabledescriptionarea)|Ativa ou desativa a área de descrição exibida abaixo da lista de propriedades.|
|[CMFCPropertyGridCtrl::EnableHeaderCtrl](#enableheaderctrl)|Habilita ou desativa o controle de cabeçalho na parte superior do controle da grade da propriedade.|
|[CMFCPropertyGridCtrl::EnsureVisible](#ensurevisible)|Rola um controle de grade de propriedade e expande os itens de propriedade até que a propriedade especificada seja visível.|
|[CMFCPropertyGridCtrl::ExpandAll](#expandall)|Expande ou colapsa todos os nós de controle da rede de propriedade.|
...
|`CMFCPropertyGridCtrl::get_accChild`|Chamado pela estrutura para recuperar `IDispatch` o endereço de uma interface para a criança especificada. [(Substituicina CWnd::get_accChild](../../mfc/reference/cwnd-class.md#get_accchild).)|
|[CMFCPropertyGridCtrl::get_accChildCount](#get_accchildcount)|Chamado pela estrutura para recuperar o número de crianças pertencentes a este objeto. (Substitui [cwnd::get_accChildCount](../../mfc/reference/cwnd-class.md#get_accchildcount).)|
|`CMFCPropertyGridCtrl::get_accDefaultAction`|Chamado pela estrutura para recuperar uma string que descreve a ação padrão do objeto. [(Substituicina CWnd::get_accDefaultAction](../../mfc/reference/cwnd-class.md#get_accdefaultaction).)|
|`CMFCPropertyGridCtrl::get_accDescription`|Chamado por framework para recuperar uma seqüência que descreve a aparência visual do objeto especificado. [(Substituicina CWnd::get_accDescription](../../mfc/reference/cwnd-class.md#get_accdescription).)|
|[CMFCPropertyGridCtrl::get_accFocus](#get_accfocus)|Chamado pela estrutura para recuperar o objeto que tem o foco do teclado. [(Substituicina CWnd::get_accFocus](../../mfc/reference/cwnd-class.md#get_accfocus).)|
|[CMFCPropertyGridCtrl::get_accHelp](#get_acchelp)|Chamado pela estrutura para recuperar `Help` a seqüência de propriedade de um objeto. [(Substituicina CWnd::get_accHelp](../../mfc/reference/cwnd-class.md#get_acchelp).)|
|[CMFCPropertyGridCtrl::get_accHelpTopic](#get_acchelptopic)|Chamado pela estrutura para recuperar o caminho completo do arquivo **WinHelp** associado ao objeto especificado e ao identificador do tópico apropriado dentro desse arquivo. [(Substituicina CWnd::get_accHelpTopic](../../mfc/reference/cwnd-class.md#get_acchelptopic).)|
|[CMFCPropertyGridCtrl::get_accKeyboardShortcut](#get_acckeyboardshortcut)|Chamado pela estrutura para recuperar a chave de atalho do objeto especificado ou a chave de acesso. [(Substituicina CWnd::get_accKeyboardShortcut](../../mfc/reference/cwnd-class.md#get_acckeyboardshortcut).)|
...
|`CMFCPropertyGridCtrl::get_accRole`|Chamado pela estrutura para recuperar informações que descrevem o papel do objeto especificado. [(Substituicina CWnd::get_accRole](../../mfc/reference/cwnd-class.md#get_accrole).)|
|[CMFCPropertyGridCtrl::get_accSelection](#get_accselection)|Chamado pela estrutura para recuperar as crianças selecionadas deste objeto. [(Substituicina CWnd::get_accSelection](../../mfc/reference/cwnd-class.md#get_accselection).)|
|`CMFCPropertyGridCtrl::get_accState`|Chamado pelo framework para recuperar o estado atual do objeto especificado. [(Substituicina CWnd::get_accState](../../mfc/reference/cwnd-class.md#get_accstate).)|
|`CMFCPropertyGridCtrl::get_accValue`|Chamado pela estrutura para recuperar o valor do objeto especificado. [(Substituicina CWnd::get_accValue](../../mfc/reference/cwnd-class.md#get_accvalue).)|
|[CMFCPropertyGridCtrl::GetBkColor](#getbkcolor)|Recupera a cor de fundo do controle atual da grade da propriedade.|
|[CMFCPropertyGridCtrl::GetBoldFont](#getboldfont)|Recupera a fonte do Windows do texto no controle atual da grade de propriedade em negrito.|
|[CMFCPropertyGridCtrl::GetCurSel](#getcursel)|Recupera a propriedade selecionada no momento.|
|[CMFCPropertyGridCtrl::GetCustomColors](#getcustomcolors)|Recupera as cores personalizadas definidas atualmente para elementos de controle da grade de propriedade.|
...
|[CMFCPropertyGridCtrl::SetShowDragContext](#setshowdragcontext)|Especifica se a estrutura redesenha as colunas de nome e valor do controle da grade de propriedade atual quando um usuário redimensiona as colunas.|
...
Recupera o objeto [INTERNO CMFCHeaderCtrl](../../mfc/reference/cmfcheaderctrl-class.md) que a estrutura usa para exibir o controle atual da grade de propriedade.
...
Recupera a cor usada para desenhar o texto dos itens de propriedade no controle atual da grade de propriedade.
...
VERDADE se os nomes de grupo forem exibidos em toda a largura do controle da grade de propriedade; FALSO se os nomes de grupo forem truncados pela coluna direita (valor) do controle.
