...
### <a name="return-value"></a>Valor de retorno  
 Um `DWORD` valor que contém o anterior [estendidos estilos de controle guia](http://msdn.microsoft.com/library/windows/desktop/bb760546), conforme descrito no SDK do Windows.  
