...
*ppd*<br/>
Ponteiro para um [PRINTDLG](/windows/desktop/ms646940) estrutura de dados, que contém informações sobre o novo dispositivo de destino de impressão. Pode ser NULL.
