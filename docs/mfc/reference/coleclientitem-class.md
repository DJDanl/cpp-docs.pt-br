...
*ppd*<br/>
Ponteiro para um [PRINTDLG](/windows/desktop/api/commdlg/ns-commdlg-tagpda) estrutura de dados, que contém informações sobre o novo dispositivo de destino de impressão. Pode ser NULL.
