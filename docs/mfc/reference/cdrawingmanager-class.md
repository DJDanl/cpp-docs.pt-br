...
### <a name="parameters"></a>Parâmetros  
 ...
 A porcentagem do retângulo que `FillGradient` preenche com *colorFinish* depois de terminar de gradiente.  
...
### <a name="remarks"></a>Comentários  
 ...
 Se *bIsRight* é definido como `TRUE`, cor do pixel é medido *x* pixels da borda direita do *rect*. Se for `FALSE`, cor do pixel é medido *x* pixels da borda esquerda da *rect*.  
