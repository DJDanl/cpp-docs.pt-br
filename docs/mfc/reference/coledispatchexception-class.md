...
## <a name="remarks"></a>Comentários  
 Como as outras classes de exceção derivado a `CException` classe base `COleDispatchException` pode ser usado com o **gerar**, `THROW_LAST`, **tente**, **CATCH**, `AND_CATCH`, e `END_CATCH` macros.  
