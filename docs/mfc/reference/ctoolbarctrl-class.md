...
|[CToolBarCtrl::MapAccelerator](#mapaccelerator)|Um caractere de aceleração é mapeado para um botão de barra de ferramentas.|  
...
5.  Se você quiser dicas de ferramenta para um botão de barra de ferramentas em uma janela do proprietário não é um `CFrameWnd`, você precisa tratar o **TTN_NEEDTEXT** mensagens na janela do proprietário da barra de ferramentas, conforme descrito em [tratamento notificações da dica de ferramenta](../../mfc/handling-tool-tip-notifications.md). Se a janela pai da barra de ferramentas é derivada do `CFrameWnd`, dicas de ferramenta são exibidas sem qualquer esforço extra de você porque `CFrameWnd` fornece um manipulador padrão.  
...
### <a name="remarks"></a>Comentários  
 Cadeias de caracteres no buffer devem ser separadas por um caractere nulo. Certifique-se de que a cadeia de caracteres último tem dois terminadores nulos. Para formatar corretamente uma cadeia de caracteres constante, você pode escrever desta forma:  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método envia o [TB_CHANGEBITMAP](http://msdn.microsoft.com/library/windows/desktop/bb787301) mensagem, que é descrita a [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
- **WS_DISABLED** raramente  
 ...
 Opcionalmente, aplique uma combinação de [estilos de controle comuns](http://msdn.microsoft.com/library/windows/desktop/bb775498), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
 Aplica uma combinação de estilos de barra de ferramentas para o controle ou os botões de si mesmos. Os estilos são descritos no tópico [controle de barra de ferramentas e os estilos de botão](http://msdn.microsoft.com/library/windows/desktop/bb760439) no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_GETANCHORHIGHLIGHT](http://msdn.microsoft.com/library/windows/desktop/bb787313), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_GETBUTTONINFO](http://msdn.microsoft.com/library/windows/desktop/bb787321), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [TB_GETCOLORSCHEME](http://msdn.microsoft.com/library/windows/desktop/bb787327) mensagem, que é descrita a [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_GETOBJECT](http://msdn.microsoft.com/library/windows/desktop/bb787343), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="return-value"></a>Valor de retorno  
 Um `DWORD` que representa os estilos estendidos atualmente em uso para o controle de barra de ferramentas. Para obter uma lista de estilos, consulte [estilos de barra de ferramentas estendido](http://msdn.microsoft.com/library/windows/desktop/bb760430), além de [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_GETEXTENDEDSTYLE](http://msdn.microsoft.com/library/windows/desktop/bb787331), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_GETHOTIMAGELIST](http://msdn.microsoft.com/library/windows/desktop/bb787334), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]. Um botão de acesso aparece realçado quando o ponteiro do mouse está acima dele.  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_GETHOTITEM](http://msdn.microsoft.com/library/windows/desktop/bb787336), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_GETIMAGELIST](http://msdn.microsoft.com/library/windows/desktop/bb787337), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_GETINSERTMARK](http://msdn.microsoft.com/library/windows/desktop/bb787338), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_GETINSERTMARKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb787339), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_GETMAXSIZE](http://msdn.microsoft.com/library/windows/desktop/bb787341), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro emula a funcionalidade do [TB_GETMETRICS](http://msdn.microsoft.com/library/windows/desktop/bb787342) mensagem, conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [TB_GETPADDING](http://msdn.microsoft.com/library/windows/desktop/bb787344) mensagem, que é descrita a [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [TB_GETPRESSEDIMAGELIST](http://msdn.microsoft.com/library/windows/desktop/bb787345) mensagem, que é descrita a [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_GETRECT](http://msdn.microsoft.com/library/windows/desktop/bb787346), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_GETSTRING](http://msdn.microsoft.com/library/windows/desktop/bb787349), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="return-value"></a>Valor de retorno  
 Um `DWORD` que contém uma combinação de [estilos de controle de barra de ferramentas](http://msdn.microsoft.com/library/windows/desktop/bb760439), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_HITTEST](http://msdn.microsoft.com/library/windows/desktop/bb787360), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_INSERTMARKHITTEST](http://msdn.microsoft.com/library/windows/desktop/bb787367), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_LOADIMAGES](http://msdn.microsoft.com/library/windows/desktop/bb787381), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_MAPACCELERATOR](http://msdn.microsoft.com/library/windows/desktop/bb787383), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_MARKBUTTON](http://msdn.microsoft.com/library/windows/desktop/bb787385), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_MOVEBUTTON](http://msdn.microsoft.com/library/windows/desktop/bb787387), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método envia o [TB_PRESSBUTTON](http://msdn.microsoft.com/library/windows/desktop/bb787389) mensagem, que é descrita a [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Esse método envia o [TB_REPLACEBITMAP](http://msdn.microsoft.com/library/windows/desktop/bb787391) mensagem, que é descrita a [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Esse método implementa o comportamento da mensagem de Win32 [TB_SETANCHORHIGHLIGHT](http://msdn.microsoft.com/library/windows/desktop/bb787396), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 A função de membro implementa o comportamento da mensagem de Win32 [TB_SETBUTTONINFO](http://msdn.microsoft.com/library/windows/desktop/bb787413), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_SETBUTTONWIDTH](http://msdn.microsoft.com/library/windows/desktop/bb787417), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 ...
 Esse método envia o [TB_SETCOLORSCHEME](http://msdn.microsoft.com/library/windows/desktop/bb787421) mensagem, que é descrita a [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_SETDRAWTEXTFLAGS](http://msdn.microsoft.com/library/windows/desktop/bb787425), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]. Essa função de membro define os sinalizadores na função Win32 `DrawText`, que desenha o texto no retângulo especificado, formatado de acordo com como os sinalizadores são definidos.  
...
### <a name="return-value"></a>Valor de retorno  
 Um `DWORD` que representa o anterior estendidos estilos. Para obter uma lista de estilos, consulte [estilos de barra de ferramentas estendido](http://msdn.microsoft.com/library/windows/desktop/bb760430), além de [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_SETEXTENDEDSTYLE](http://msdn.microsoft.com/library/windows/desktop/bb787427), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_SETHOTIMAGELIST](http://msdn.microsoft.com/library/windows/desktop/bb787429), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_SETHOTITEM](http://msdn.microsoft.com/library/windows/desktop/bb787431), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_SETIMAGELIST](http://msdn.microsoft.com/library/windows/desktop/bb787433), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
 A implementação do MFC de `SetImageList` usa um `CImageList` imagens do objeto que contém o botão do controle de barra de ferramentas, em vez de um identificador para uma lista de imagens.  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_SETINSERTMARK](http://msdn.microsoft.com/library/windows/desktop/bb787437), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro implementa o comportamento da mensagem de Win32 [TB_SETINSERTMARKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb787439), conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
##  <a name="setmaxtextrows"></a>CToolBarCtrl::SetMaxTextRows  
 Define o número máximo de linhas do texto exibido em um botão de barra de ferramentas.  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro emula a funcionalidade do [TB_SETMETRICS](http://msdn.microsoft.com/library/windows/desktop/bb787446) mensagem, conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="parameters"></a>Parâmetros  
 `pWnd`  
 Ponteiro para o `CWnd` ou `CWnd`-derivados do objeto que será a nova janela do proprietário para o controle de barra de ferramentas.  
  
### <a name="remarks"></a>Comentários  
 A janela do proprietário é a janela que recebe as notificações na barra de ferramentas.  
...
### <a name="return-value"></a>Valor de retorno  
 Um `DWORD` cuja palavra baixa contém o valor anterior de preenchimento horizontal e cuja palavra alta contém o valor de preenchimento vertical anterior. Os valores de preenchimento são medidos em pixels.  
  
### <a name="remarks"></a>Comentários  
 Esse método envia o [TB_SETPADDING](http://msdn.microsoft.com/library/windows/desktop/bb787448) mensagem, que é descrita a [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="setpressedimagelist"></a>CToolBarCtrl::SetPressedImageList  
 Define a lista de imagens que usa o controle de barra de ferramentas atual para representar os botões no estado pressionado.  
...
### <a name="return-value"></a>Valor de retorno  
 Ponteiro para um [CImageList](../../mfc/reference/cimagelist-class.md) que contém a lista anterior de imagem para o controle atual, ou `NULL` se nenhuma dessas listas de imagem foi definida.  
  
### <a name="remarks"></a>Comentários  
 Esse método envia o [TB_SETPRESSEDIMAGELIST](http://msdn.microsoft.com/library/windows/desktop/bb787453) mensagem, que é descrita a [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="setrows"></a>CToolBarCtrl::SetRows  
 Solicita que o controle de barra de ferramentas para redimensionar automaticamente para o número de linhas solicitado.  
...
### <a name="parameters"></a>Parâmetros  
 ...
 `bLarger`  
 Indica se deve usar linhas de mais ou menos linhas se a barra de ferramentas não pode ser redimensionada para o número de linhas solicitado.  
  
 `lpRect`  
 Aponta para o [CRect](../../atl-mfc-shared/reference/crect-class.md) objeto ou [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) estrutura que receberão o novo retângulo delimitador da barra de ferramentas.  
  
### <a name="remarks"></a>Comentários  
 Se a barra de ferramentas não é possível redimensionar próprio para o número solicitado ou linhas, ele será redimensionado como o próximo maior ou próximo menor tamanho válido, dependendo do valor de `bLarger`. Se `bLarger` é **TRUE**, o novo número de linhas será maior que o número solicitado. Se `bLarger` é **FALSE**, o novo número de linhas será menor do que o número solicitado.  
  
 Um determinado número de linhas é válido para a barra de ferramentas se podem ser organizados os botões de modo que todas as linhas tenham o mesmo número de botões (exceto talvez a última linha). Por exemplo, uma barra de ferramentas contém quatro botões não foi dimensionada com três linhas porque as duas últimas linhas precisa ser menor. Se você tentou dimensioná-lo para três linhas, você receberia quatro linhas se `bLarger` foi **TRUE** e duas linhas se `bLarger` foi **FALSE**.  
  
 Se houver separadores na barra de ferramentas, as regras para quando um determinado número de linhas é válido estão mais complicadas. O layout é calculado, de modo que os grupos de botão (botões com um separador antes do primeiro) e o último botão no grupo são nunca divididos em várias linhas, a menos que o grupo não couberem em uma linha.  
  
 Se um grupo não couber em uma linha, o próximo grupo serão iniciadas na próxima linha, mesmo se-lo na linha em que o grupo grande terminou. A finalidade dessa regra é tornar a separação entre grupos grandes mais notáveis. Os separadores de verticais resultantes são contados como linhas.  
  
 Observe também que o `SetRows` função membro sempre escolher o layout que resulta em menor tamanho de barra de ferramentas. Criando uma barra de ferramentas com o `TBSTYLE_WRAPABLE` estilo e, em seguida, redimensionar o controle simplesmente aplicar o método descrito acima fornecido a largura do controle.  
...
### <a name="remarks"></a>Comentários  
 Essa função é especialmente útil se você deseja definir mais de um dos Estados de botão. Para definir apenas um estado, use uma das seguintes funções de membro: [EnableButton](#enablebutton), [CheckButton](#checkbutton), [HideButton](#hidebutton), [indeterminado](#indeterminate), ou [PressButton](#pressbutton).  
...
### <a name="remarks"></a>Comentários  
 Essa função de membro emula a funcionalidade do [TB_SETWINDOWTHEME](http://msdn.microsoft.com/library/windows/desktop/bb787465) mensagem, conforme descrito no [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
