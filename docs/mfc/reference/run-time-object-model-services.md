...
### <a name="remarks"></a>Comentários  
 ...
 Se você usar o **DECLARE**_ **dinâmico** e `IMPLEMENT_DYNAMIC` macros conforme descrito, você pode usar o `RUNTIME_CLASS` macro e `CObject::IsKindOf` função para determinar a classe dos objetos em execução tempo.  
