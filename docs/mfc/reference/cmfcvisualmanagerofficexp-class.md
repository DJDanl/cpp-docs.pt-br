...
## <a name="remarks"></a>Comentários  
 Você usa o `CMFCVisualManagerOfficeXP` classe para alterar a aparência visual do seu aplicativo para ser semelhante a do Microsoft Office XP.  
