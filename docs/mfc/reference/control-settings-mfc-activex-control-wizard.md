---
title: Configurações de controle, Assistente de controle ActiveX do MFC | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
## <a name="see-also"></a>Consulte também  
 ...
 [Configurações do aplicativo, Assistente de controle ActiveX do MFC](../../mfc/reference/application-settings-mfc-activex-control-wizard.md)   
