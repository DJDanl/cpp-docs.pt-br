...
O exemplo a seguir demonstra como usar o `SetTooltipParams` método da `CTooltipManager` classe. Este trecho de código é parte do [desenhar o cliente de exemplo](../../visual-cpp-samples.md).
