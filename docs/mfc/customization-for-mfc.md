...
## <a name="general-customizations"></a>Personalizações gerais  
 Você pode salvar e carregar o estado do seu aplicativo para o registro. Quando você habilitar essa opção, seu aplicativo carregará seu estado inicial do registro. Se você alterar o layout de encaixe inicial para o seu aplicativo, você precisará limpar os dados de registro de seu aplicativo. Caso contrário, os dados no Registro substituirá todas as alterações feitas no layout inicial.  
  
## <a name="class-specific-customizations"></a>Personalizações de classe específica  
