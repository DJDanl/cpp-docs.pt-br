...
6.  No **tipo de propriedade** caixa, selecione **curto**.  
  
7.  Para **implementação** tipo, clique em **métodos Get/Set**.  
  
8.  No **função Obtenha** e **função Set** caixas, digite nomes exclusivos para seu Get e definir funções ou aceite os nomes padrão.  
