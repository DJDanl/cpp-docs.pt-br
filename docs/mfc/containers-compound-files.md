---
title: 'Contêineres: Arquivos de composta | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
## <a name="see-also"></a>Consulte também  
 ...
 [Contêineres: Problemas da Interface do usuário](../mfc/containers-user-interface-issues.md)   
