...
-   Use o mecanismo de área de transferência OLE agora para habilitar novos recursos no futuro. Enquanto a API padrão da área de transferência será mantida, o mecanismo OLE é o futuro da transferência de dados.  
  
-   Use o mecanismo de área de transferência OLE se você estiver escrevendo um aplicativo OLE ou se você deseja que os recursos do OLE, como arrasta e soltar.  
