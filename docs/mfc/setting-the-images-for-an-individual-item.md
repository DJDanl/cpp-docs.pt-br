...
2.  Usando essa estrutura, fazer uma chamada para [CComboBoxEx::GetItem](../mfc/reference/ccomboboxex-class.md#getitem).  
  
3.  Modificar a *máscara*, *iImage*, e *iSelectedImage* membros da estrutura retornada recentemente, usando os valores apropriados.  
  
4.  Fazer uma chamada para [CComboBoxEx::SetItem](../mfc/reference/ccomboboxex-class.md#setitem), passando a estrutura alterada.  
