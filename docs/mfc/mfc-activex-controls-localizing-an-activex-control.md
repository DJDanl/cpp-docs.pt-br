...
2.  Se necessário, selecione a unidade e pasta para exibir.  
  
3.  No **arquivos do tipo** caixa, selecione **todos os arquivos (\*.\*)** .  
  
4.  Na caixa de listagem de arquivo, clique duas vezes o. Arquivo IDL que deseja inserir no projeto.  
  
5.  Clique em **abrir** quando você tiver adicionado todas as mídias necessárias. Arquivos IDL.  
