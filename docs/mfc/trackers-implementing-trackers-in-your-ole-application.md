...
- [Como implementar o acompanhamento no seu código](../mfc/how-to-implement-tracking-in-your-code.md).

- [Elásticos e controladores](../mfc/rubber-banding-and-trackers.md).

O artigo também aborda o uso de estilos com controladores. Além disso, ele faz várias referências para o exemplo OLE do MFC [OCLIENT](../overview/visual-cpp-samples.md).
