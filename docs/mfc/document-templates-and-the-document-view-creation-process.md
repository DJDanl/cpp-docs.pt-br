---
title: Modelos de documento e o processo de criação de exibição de documento | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
![Aplicativo MDI que tem dois tipos de documento](../mfc/media/vc387h1.gif "vc387h1") por um aplicativo MDI com dois tipos de documento
