...
2.  Adicionar uma variável de membro (do tipo `CCirc`) para a seção protegida do `CMyView` localizada em CMYVIEW de definição de classe. H:  
  
     [!code-cpp[NVC_MFC_AxCont#13](../mfc/codesnippet/cpp/activex-control-containers-using-controls-in-a-non-dialog-container_2.h)]  
    [!code-cpp[NVC_MFC_AxCont#14](../mfc/codesnippet/cpp/activex-control-containers-using-controls-in-a-non-dialog-container_3.h)]  
  
3.  Adicionar um `WM_CREATE` manipulador de mensagens para a classe `CMyView`.  
  
4.  Na função de manipulador, `CMyView::OnCreate`, faça uma chamada para o controle `Create` funcionam usando a **isso** ponteiro como a janela pai:  
