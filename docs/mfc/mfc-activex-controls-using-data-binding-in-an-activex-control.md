...
> ActiveX é uma tecnologia herdada que não deve ser usada para novos desenvolvimentos. Para obter mais informações sobre tecnologias modernas que substituem as ActiveX, consulte [controles ActiveX](activex-controls.md).  
 ...
 ![Diagrama conceitual de um dado&#45;controle de limite](../mfc/media/vc374v1.gif "vc374v1")  
...
2.  Clique com botão direito no nó de interface para o seu controle.  
...
5.  Selecione as seguintes caixas de seleção do **atributos de IDL** guia: **displaybind** e **defaultbind** para adicionar os atributos à definição da propriedade do projeto. Arquivo IDL. Esses atributos tornar o controle visível para o usuário e verifique a propriedade de estoque a propriedade associável padrão.  
...
2.  Sobre o **configurações de controle** , selecione uma classe de janela para o controle para a subclasse. Por exemplo, você talvez queira subclasse um controle de edição.  
  
3.  Carregar o projeto do seu controle.  
  
4.  Clique com botão direito no nó de interface para o seu controle.  
  
     Isso abre o menu de atalho.  
  
5.  No menu de atalho, clique em **Add** e, em seguida, clique em **adicionar propriedade**.  
  
6.  Digite o nome da propriedade a **nome da propriedade** caixa. Use `MyProp` para este exemplo.  
  
7.  Selecione um tipo de dados do **tipo de propriedade** caixa de listagem suspensa. Use **curto** para este exemplo.  
  
8.  Para **tipo de implementação**, clique em **métodos Get/Set**.  
