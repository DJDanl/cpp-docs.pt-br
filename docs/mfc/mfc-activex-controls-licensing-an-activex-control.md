...
##  <a name="_core_overview_of_activex_control_licensing"></a> Visão geral do controle ActiveX de licenciamento  
 ...
 ![Licenciado verificado no desenvolvimento de controle de ActiveX](../mfc/media/vc374d1.gif "vc374d1")  
Verificação de um controle ActiveX licenciado durante o desenvolvimento  
 ...
 ![Licenciado verificado na execução de controle de ActiveX](../mfc/media/vc374d2.gif "vc374d2")  
