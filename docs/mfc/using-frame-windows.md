---
title: Usando janelas com moldura | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
-   [Função da janela do quadro de impressão e visualização de impressão](../mfc/orchestrating-other-window-actions.md)  
